...
uuid: c33e9fec-8304-4e23-a4b1-101d1c11295b
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: integration
content-type: reference
discoiquuid: ef1390f1-b0d5-4f5f-b66d-cb6e1e05fb45
...
1. Use Package Manager to [Upload and install](../../administering/using/package-manager.md#main-pars-title) the cq-portlets-components.zip package.
...
1. Configure the portlet, as necessary. For example, you may need to change the URL for the author and publish instances and the URL for the start path. Default configurations are described in [Portlet Preferences](../../administering/using/aem-as-portal.md#portletpreferences).
