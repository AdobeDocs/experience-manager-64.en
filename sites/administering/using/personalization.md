...
uuid: 3a928d41-8ed4-47e4-887f-f8ed8b53a78b
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: personalization
content-type: reference
discoiquuid: ab947741-f596-4598-890f-963fc825871c
...
Community features such as blogs, forums and calendars result in the creation of community content, commonly referred to as user generated content (UGC). When UGC is entered in a publish environment consisting of multiple AEM instances (a [publish farm](/content/help/en/experience-manager/6-4/communities/using/topologies)), one major issue has been how to synchronize UGC across all instances.

With [AEM Communities 6.1](/content/help/en/experience-manager/6-4/communities/using/overview) extension, this issue is solved by using a [common store for UGC](/content/help/en/experience-manager/6-4/communities/using/working-with-srp). In regards, to personalization, Communities includes [Social Login](/content/help/en/experience-manager/6-4/communities/using/social-login) - the ability to provide the option for site visitors to sign in with Facebook and Twitter.
