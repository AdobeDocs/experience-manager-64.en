...
uuid: d58b409b-92cc-4424-9208-c9bb662bd88e
contentOwner: Silviu Raiman
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: deba0e7b-6279-4df2-bccf-96ff5c83cf44
isreadyforlocalization: false
unpublishexternaldate: 2018-04-19T07 47 12.198-0400
index: y
internal: n
snippet: y
---
...
Because of the RESTful nature of the Sling framework upon which AEM is built, most tasks can be reduced to a URL call, which can be executed with cURL. [Content manipulation tasks](../../administering/using/curl.md#main-pars-title-1149108022) such as activating pages, and starting workflows as well as [operational tasks](../../administering/using/curl.md#main-pars-title-57233023) such as package management and managing users can be automated using cURL. In addition you can [create your own cURL](../../administering/using/curl.md#main-pars-title-605414944) commands for most tasks in AEM.
...
See [Backup and Restore](../../administering/using/backup-and-restore.md#main-pars-38-15-title) for details.
...
See [Communities Scoring and Badges](/content/help/en/experience-manager/6-4/communities/using/implementing-scoring#main-pars_title_984355503) for details.

See [Scoring and Badges Essentials](/content/help/en/experience-manager/6-4/communities/using/configure-scoring#main-pars_title_274391910) for details.

#### MSRP Reindexing {#msrp-reindexing}

See [MSRP - MongoDB Storage Resource Provider](/content/help/en/experience-manager/6-4/communities/using/msrp#main-pars_title_1678071133) for details. [](/content/help/en/experience-manager/6-4/communities/using/msrp#main-pars_title_1678071133)

### Security {#security}

#### Enabling and Disabling CRX DE Lite {#enabling-and-disabling-crx-de-lite}

See [Enabling CRXDE Lite in AEM](../../administering/using/enabling-crxde-lite.md) for details.

### Data Store Garbage Collection {#data-store-garbage-collection}

See [Data Store Garbage Collection](../../administering/using/data-store-garbage-collection.md#main-pars-title-1) for details.

### Analytics and Target Integration {#analytics-and-target-integration}

See [Opting Into Adobe Analytics and Adobe Target](../../administering/using/opt-in.md#main-pars-title-1581933806) for details. [](../../administering/using/opt-in.md#main-pars-title-1581933806)

### Single Sign On {#single-sign-on}

#### Send Test Header {#send-test-header}

See [Single Sign On](../../deploying/using/single-sign-on.md#main-pars-text-7) for details.
...
See [Interacting with Workflows Programmatically](../../developing/using/workflows-program-interaction.md) for details.
...
See [Assets HTTP API](/content/help/en/experience-manager/6-4/assets/using/mac-api-assets) for details.
