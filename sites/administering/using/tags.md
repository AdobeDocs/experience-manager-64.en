...
uuid: 9e92a1b4-e997-4a88-9d04-3769479c69bf
contentOwner: Chiradeep Majumdar
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: content
content-type: reference
discoiquuid: 0f12a67f-5ba2-498b-a251-ecee0a7ab39c
...
![](assets/chlimage_1-178.png)  ![](assets/creating_tags_andnamespaces.PNG)
...
![](assets/chlimage_1-181.png)  ![](assets/chlimage_1-182.png) 
...
In general, the language chosen for the tag is taken from the page language, when available. When the [ `tag` widget](../../developing/using/building.md#taggingontheclientside) is used in other cases (for example in forms or in dialogs), the tag language depends on the context.
...
<p>By default. the <span class="code">titles </span>of tags added as page properties are displayed in the page language. When using the Classic UI, the tag dialog in the page properties has a language field that enables the display of tag <span class="code">titles </span>in a different language. For instructions, see <a href="../../administering/using/classic-console.md#displayingtagtitlesinpagepropertiesinaspecifiedlanguage">Classic UI Tagging Console.</a></p>
-->
