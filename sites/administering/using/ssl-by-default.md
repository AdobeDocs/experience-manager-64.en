...
uuid: 1457f815-4514-4a3a-b4d0-b27870e5fb20
contentOwner: User
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: Security
discoiquuid: a4c500c4-2ffc-47eb-ac82-b4ebf47c3675
...
1. Once you enter the credentials, click **Next** in the upper right corner of the page. Then, upload the associated private key and certificate for the SSL connection.
   ...
   >[!NOTE]
   >
   >For info on how to generate a private key and a certificate to use with the wizard, see [this procedure](../../administering/using/ssl-by-default.md#main-pars-title-1158836258) below.
