...
uuid: 2b5294b2-0128-4ede-af07-13030bb739dc
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: integration
content-type: reference
topic-tags: best-practices
discoiquuid: 39934174-3ad5-4b6e-980c-7c7ddba51375
...
There are currently [seven components available for use inside campaign templates](../../authoring/using/adobe-campaign-components.md). These components are all based on the Adobe markup language **HTL**.
...
These components are described in detail in [Adobe Campaign components](../../authoring/using/adobe-campaign-components.md).
