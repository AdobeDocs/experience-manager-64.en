...
uuid: a2ae4675-4a93-4357-b6b5-2d02915ce915
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: site-features
content-type: reference
discoiquuid: 9eea0aea-4fb8-4ea6-bd89-7fd07c84e6f2
disttype: dist5
gnavtheme: light
...
>[!NOTE]
>
>Use of the On Modification trigger can impact performance. See [MSM best practices](../../administering/using/msm-best-practices.md#main-pars-title-1294683499) for more information.
...
The following table lists the synchronization actions that are installed with AEM. If the installed actions do not meet your requirements, you can [Create a New Synchronization Action](../../developing/using/extending-msm.md#creatinganewsynchronizationaction).
...
You can [create a rollout configuration](../../developing/using/extending-msm.md#creatinganewrolloutconfiguration) when the installed rollout configurations do not meet your application requirements:

* [Create the rollout configuration](../../developing/using/extending-msm.md#createtherolloutconfiguration).
* [Add synchronization actions to the rollout configuration](../../developing/using/extending-msm.md#addsynchronizationactionstotherolloutconfiguration).
...
>[!NOTE]
>
>In the touch-optimized UI see also [Configuring MSM Locks on Page Properties (Touch-Optimized UI)](../../developing/using/extending-msm.md#configuringmsmlocksonpagepropertiestouchoptimizedui).
...
* ** [Live copy page properties](../../administering/using/msm-sync.md#main-pars-title-575012794):** When a live copy page is configured to use one or more rollout configurations, MSM uses those rollout configurations.
* ** [Blueprint page properties](../../administering/using/msm-sync.md#main-pars-title-1894004333):** When a live copy is based on a blueprint, and the live copy page is not configured with a rollout configuration, the rollout configuration that is associated with the blueprint source page is used.
...
* ** [System default](../../administering/using/msm-sync.md#main-pars-title-1613566049):** When the rollout configuration of the live copy's parent page cannot be determined, the system default rollout configuration is used.
...
You can also configure the rollout configurations for a live copy page when you [create the live copy](../../administering/using/msm-livecopy.md#main-pars-title-1625440185).
...
Configure the service using either the [Web Console](../../deploying/using/configuring-osgi.md#main-pars-title-104) or a [repository node](../../deploying/using/configuring-osgi.md#main-pars-par11).
