...
uuid: d9425bfd-f5e7-4d4a-9fe0-74ef856c1dc9
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: integration
content-type: reference
discoiquuid: b230a60f-97ee-43d2-b9c0-27609a7542d6
...
When you log in as an administrator this task (**Configuring Analytics & Targeting**) is available from the [Inbox](../../authoring/using/inbox.md#outoftheboxadministrativetasks). Based on the credentials you supply, it helps you configure and integrate these services.
...
* Opt out of the integration.  
  Consider this option if you prefer to [manually configure the integration](../../administering/using/marketing-cloud.md). See also [Integrating AEM with Adobe Target and Adobe Analytics using DTM](https://helpx.adobe.com/experience-manager/using/integrate-digital-marketing-solutions.html).
...
>[!NOTE]
>
>You can optionally provide Analytics and Target account information using a properties file that is read upon server startup. See [Providing Account Information Using a Properties File](../../administering/using/opt-in.md#providingaccountinformationusingapropertiesfile).
...
>[!NOTE]
>
>AT.js is the default client library. This is configured under your [target cloud services configuration](../../administering/using/target-configuring.md#creatingatargetcloudconfiguration). 
>
>Adobe recommends that you use AT.js as the client library.

To opt-in from the pre-loaded, out-of-the-box task:

1. From your [Inbox, select and **Open** the Configure Analytics & Targeting](../../authoring/using/inbox.md#takingactiononanitem) task.
...
* Prefer to configure the integrations manually.  
  For information about configuring the integrations manually, see [Integrating with Adobe Analytics](../../administering/using/adobeanalytics.md) and [Integrating with Adobe Target](../../administering/using/target.md).

To opt out you need to complete the pre-loaded task:

* From your [Inbox, select and **Complete** the Configure Analytics & Targeting](../../authoring/using/inbox.md#takingactiononanitem) task.
...
1. Open the Configure Analytics & Targeting task as described in [Configuring the Integration](../../administering/using/opt-in.md#main-pars-title). Instead of requesting your account information, the wizard uses the values from the `.properties` file.
...
You do not need to alter the cloud configurations. However, you can configure the frameworks as needed. (See [Mapping Component Data with Adobe Analytics Properties](../../administering/using/adobeanalytics-mapping.md) and [Add a Target Framework](../../administering/using/target.md#main-pars-title-14).)
