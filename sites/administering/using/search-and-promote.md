...
uuid: df15406b-3e65-4f66-8f41-d9afa94ba252
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: integration
content-type: reference
discoiquuid: bb5dee01-f404-43eb-8137-fd4022f2c231
...
1. Use the components to author the content. (See [Adding Search&Promote Features to a Web Page](../../authoring/using/search-and-promote.md).)
...
In Design mode, edit a **par** component to allow the Search&Promote components in Sidekick. (See the [Components](../../developing/using/components.md#addinganewcomponenttotheparagraphsystemdesignmode) documentation for more information.)

For information about using the components, see See [Adding Search&Promote Features to a Web Page](../../authoring/using/search-and-promote.md).)
