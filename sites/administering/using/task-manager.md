...
uuid: 4f8e4342-5873-40fa-8f81-a6f299cdcb7a
contentOwner: Chiradeep Majumdar
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: content
content-type: reference
discoiquuid: ac7a84ae-aa00-4a7a-a2e2-93e8a38eeaee
jcr-lastmodifiedby: remove-legacypath-6-1
unpublishexternaldate: 2018-04-04T01 55 21.595-0400
index: y
internal: n
snippet: y
---
...
For information about completing tasks that are assigned to you, see [Working with Tasks](../../authoring/using/task-content.md).
...
Create a task to track the work performed on a content item (page) in the repository. After creating the task, users can open the associated content from the WCM Inbox. (See [Working With Tasks](../../authoring/using/task-content.md).)
...
For more information, see [Create Task](../../developing/using/workflows-step-ref.md#main-pars-title-0).
...
>[!NOTE]
>
>When working with AEM there are several methods of managing the configuration settings for OSGi services; see [Configuring OSGi](../../deploying/using/configuring-osgi.md) for more details and the recommended practices.
...
For information about using `sling:OsgiConfig` nodes, see [Configuring OSGi](../../deploying/using/configuring-osgi.md).
