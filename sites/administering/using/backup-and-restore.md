...
uuid: 349f5a10-5c8a-4111-8d12-4987e1f9946a
...
discoiquuid: a0263581-5a5f-4295-bf4e-6cbebc9c9c4a
...
<note type="note">
<p>Instead of stopping CRX, you can also use calls to JMX MBeans to prevent CRX from writing to the disk, which reduces the time CRX is unavailable to seconds. This is described under <a href="../../administering/using/backup-and-restore.md#filesystemsnapshotbackup">Filesystem Snapshot Backup</a> below.</p>
</note>
-->
