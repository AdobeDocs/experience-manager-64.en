...
uuid: e5619ee4-5875-4273-8752-5b6f4e77fb39
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: 8ae28ee0-3c08-49f1-ae97-18d5f7a323bb
...
* Have subscribed to page events, for example modification or replication. The [Notification Inbox](../../classic-ui-authoring/using/author-env-inbox.md#subscribingtonotifications) section describes how to subscribe to such events.  

* Have subscribed to forum events.
* Have to perform a step in a workflow. The [Participant Step](../../developing/using/workflows-step-ref.md#participantstep) section describes how to trigger email notification in a workflow.
...
## Configuring AEM Assets email notifications {#configuring-aem-assets-email-notifications}
...
1. Configure the email service, as described above in [Configuring the Mail Service](../../administering/using/notification.md#configuringthemailservice).
