...
uuid: b63e176b-6c0f-457c-8f88-2fe3e2e6d7d6
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: 80665508-ee5d-4eef-af19-7eb27c721f17
...
For information about creating MBeans to manage your services using the JMX Console, see [Integrating Services with the JMX Console](../../developing/using/jmx-integration.md).
...
>[!NOTE]
>
>See the [workflow console](../../administering/using/workflows-administering.md) for additional workflow administration tools and descriptions of possible workflow instance statuses.
