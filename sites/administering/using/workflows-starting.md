...
uuid: f48264bd-f93c-4b2c-bfb7-56e32cf176cd
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: 37d794ce-e5a7-41a8-a3fb-cc6d3013cee5
...
>* [Translation Projects](../../administering/using/tc-manage.md)
>

### Workflow Models {#workflow-models}

You can start a workflow [based on one of the models](../../administering/using/workflows.md#workflowmodelsandinstances) listed on the Workflow Models console. The only mandatory information is the payload, though a title and/or comment can be added as well.
...
1. Select the workflow (according to the console view); you can also use Search (top left) if required:
   ...
   >[!NOTE]
   >
   >The ** [Transient](/developing/using/workflows#TransientWorkflows)** indicator shows workflows for which the workflow history will not be persisted.
