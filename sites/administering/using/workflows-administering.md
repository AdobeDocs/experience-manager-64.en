...
uuid: 0a258fae-b770-4219-8c06-6ef0a54d973b
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: ec457dbb-08cd-4b86-86bb-971ef7db6d0a
...
>[!NOTE]
>
>The [JMX console](../../administering/using/jmx-console.md#workflowmaintenance) provides additional workflow maintenance operations.

A range of consoles are available for administering your workflows. Use the [global navigation](../../authoring/using/basic-handling.md#globalnavigation) to open the **Tools** pane, then select **Workflow**:
...
To configure the service, you can use the [Web Console](../../deploying/using/configuring-osgi.md#main-pars-title-104) or [add an OSGi configuration to the repository](../../deploying/using/configuring-osgi.md#main-pars-par11). The following table desribes the properties that you need for either method.
...
You can set the maximum size of the inbox by configuring the **Adobe Granite Workflow Service**, using the [Web Console](../../deploying/using/configuring-osgi.md#main-pars-title-104) or [add an OSGi configuration to the repository](../../deploying/using/configuring-osgi.md#main-pars-par11). The following table describes the property that you configure for either method.
