...
uuid: 847756ff-dce4-418b-b9c7-4e4244bba525
contentOwner: sarchiz
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: Security
content-type: reference
discoiquuid: 327cf3fc-ff6a-462f-b140-051f1b41571f
index: y
internal: n
snippet: y
---
...
<ol> 
 <li> 
  ...
  </draft-comment><img imageRotate="0" src="assets/image2018-9-24_0-55-54.png" /></li> 
 <li><h4>Add the IMS Provider</h4> <p> </p> 
  <ol> 
   <li>Go to the <a href="../../deploying/using/configuring-web-console.md" target="_blank">Web Console Configuration Manager</a></li> 
