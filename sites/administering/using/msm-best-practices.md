...
uuid: 56fef20f-8973-4d1d-8293-59e909a29a44
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: site-features
content-type: reference
topic-tags: best-practices
discoiquuid: bedf3e07-ff60-4581-88c0-b65091e122a8
disttype: dist5
gnavtheme: light
...
>[!NOTE]
>
>You can also use the [Reference component](../../authoring/using/default-components-foundation.md#reference) to reuse a single page or paragraph. Keep in mind however:
>
...
Keep in mind that a live copy can be created using either [regular pages](../../administering/using/msm-livecopy.md#creatingalivecopyofapage) or a [blueprint configuration](../../administering/using/msm-livecopy.md#creatingalivecopyofasitefromablueprintconfiguration). Both are valid use cases.
...
* When [creating a **Live Copy**](../../administering/using/msm-livecopy.md#creatingalivecopyofapage)  
...
* When [creating a **Site**](../../administering/using/msm-livecopy.md#creatingalivecopyofasitefromablueprintconfiguration)   
...
* To create a new site, you need a [blueprint configuration](../../administering/using/msm-livecopy.md#managingblueprintconfigurations). 
...
For more information see [Translating Content for Multilingual Sites](../../administering/using/translation.md) and the [Translation Best Practices](../../administering/using/tc-bp.md).
...
When using the [rollout trigger](../../administering/using/msm-sync.md#rollouttriggers) `onModify` you should consider that:
...
* In addition to customizing rollout actions, MSM also allows you to customize node properties that are being rolled out. The [MSM OSGi configuration allows you to exclude node types](../../administering/using/msm-sync.md#excludingpropertiesandnodetypesfromsynchronization) from being copied from the source to the live copy.
