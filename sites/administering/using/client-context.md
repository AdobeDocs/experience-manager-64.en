...
uuid: 3eed9cb7-86e7-4633-9ed7-f9a0207367b8
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: personalization
content-type: reference
discoiquuid: 0ce2f0a5-09e9-444c-b3e6-277f9c45cd5b
...
>[!NOTE]
>
>Client Context has been superseded by ContextHub. For more details, see the related [configuration](../../administering/using/contexthub-config.md) and [developer](../../developing/using/contexthub.md) documenatation.
...
The JSONP Store is like any other store, but it loads information that comes from another domain without the need of having a proxy for that information on the current domain. See the example in [Storing Data in Client Context Via JSONP](../../administering/using/client-context.md#main-pars-title-6).
...
For additional information, see [Client Context in Detail](../../developing/using/client-context.md).
...
Editing a client context can be used to set (or reset) the values of certain properties. This allows you to test specific scenarios (particularly useful for [segmentation](../../administering/using/campaign-segmentation.md) and [campaigns](../../authoring/using/campaigns.md)).
...
This example uses the Geometrixx Outdoors sample website to access Client Context and to test the created segment. You can use a different web site as long as the page has enabled Client Context. (See [Adding Client Context To a Page](../../developing/using/client-context.md#main-pars-title-14).)
