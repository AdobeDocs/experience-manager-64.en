...
uuid: a1c6bf5c-26c8-46fe-9c5f-f4f4b973b645
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: integration
content-type: reference
discoiquuid: 7abd67ef-f83a-4115-8a2f-b037a0f1300a
disttype: dist5
gnavtheme: light
...
>To ensure that your videos play on the page, consult ** [this tutorial](../../authoring/using/default-components-foundation.md#video)** for information about how to transcode video files in AEM.
...
1. [Create an Adobe Analytics configuration and framework](../../administering/using/adobeanalytics.md).
...
1. Select a tracking method:
    ...
    * [Milestones](../../administering/using/adobeanalytics.md)
    * [Non-legacy Milestones](../../administering/using/adobeanalytics.md)
    * [Legacy Milestones](../../administering/using/adobeanalytics.md)
    * [Legacy Seconds](../../administering/using/adobeanalytics.md)
...
1. [Add the framework](../../administering/using/adobeanalytics.md) to the page.
...
*The call is similar to the Legacy Milestones call above. Please see the information on pev3 ** [provided there](../../administering/using/adobeanalytics.md)**.*
