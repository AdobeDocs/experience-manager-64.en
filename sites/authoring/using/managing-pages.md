...
uuid: 86f7a435-f255-4894-b90b-664fe7a36f02
contentOwner: Chris Bohnert
converted: true
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 95a030c5-5e03-4d6d-8867-2b55eb0ecd22
...
This section describes how to create and manage pages with Adobe Experience Manager (AEM) so that you can then [create content](../../authoring/using/editing-content.md) on those pages.

>[!NOTE]
>
>Your account needs the [appropriate access rights](../../administering/using/security.md) and [permissions](../../administering/using/security.md#permissions) to take action on pages such as create, copy, move, edit, and delete.
>
>If you encounter any problems we suggest you contact your system administrator.

>[!NOTE]
>
>There are a number of [keyboard shortcuts](../../authoring/using/keyboard-shortcuts.md) that you can use from the websites console that make organizing your pages more efficient.
...
This structure can be viewed From the **Sites** console, where you can [navigate through the pages of your website](../../authoring/using/basic-handling.md#navigating) and perform actions on the pages. You can also create new sites and [new pages](#creatinganewpage).
...
* ** [Name](#name)**:
    ...
    * User input for this field is optional. If not specified, the name is derived from the title. See the following section [Page Name Restrictions and Best Practices](../../authoring/using/managing-pages.md#main-pars-header) for details.
...
When creating a new page, AEM will [validate the page name according to the conventions](../../developing/using/naming-conventions.md) imposesd by AEM and the JCR.
...
Full details of all characters allowed can be found in [the naming conventions](../../developing/using/naming-conventions.md).

>[!NOTE]
>
>If AEM is running on a [MongoMK persistence manager deployment](../../deploying/using/recommended-deploys.md), page names are limited to 150 characters.

#### Title {#title}

If you supply only a page **Title** when creating a new page, AEM will derive the page **Name** from this string and [validate the name according to the conventions](../../developing/using/naming-conventions.md) imposed by AEM and JCR. A **Title** field containing invalid characters will be accepted, but the name derived will have the invalid characters subsituted. For example:
...
When you supply a page **Name** when creating a new page, AEM will [validate the name according to the conventions](../../developing/using/naming-conventions.md) imposed by AEM and JCR. You cannot submit invalid characters in the **Name** field. When AEM detects invalid characters the field will be highlighted with an explanatory message.
...
>[!NOTE]
>
>If configured on your instance, [template authors can create templates with the Template Editor](../../authoring/using/templates.md).

### Components {#components}

Components are the elements provided by AEM so that you can add specific types of content. AEM comes with a range of [out-of-the-box components](../../authoring/using/default-components-console.md) that provide comprehensive functionality. These include:
...
Once you have created and opened a page you can [add content using the components](../../authoring/using/editing-content.md#insertinganewparagraph), which are available from the [component browser](../../authoring/using/author-environment-tools.md#componentbrowser).

>[!NOTE]
>
>The [Components Console](../../authoring/using/default-components-console.md) give an overview of the components on your instance.
...
1. From the final stage of the wizard you can either:
    ...
    * Use the three tabs to enter the [page properties](../../authoring/using/editing-page-properties.md) you want assigned to the new page, then click/tap **Create** to actually create the page.  
...
>[!CAUTION]
>
>Once a page has been created its template cannot be changed - unless you [create a launch with a new template](../../authoring/using/launches-creating.md#createlaunchwithnewtemplate), though this will lose any content already existing.
...
1. Select your page by using either:
    ...
    * [Selection mode](../../authoring/using/basic-handling.md#navigatingandselectionmode) and the toolbar

   And then select the **Edit** icon:

   ![](assets/screen_shot_2018-03-22at105355.png)

1. The page will be opened and you can [edit the page](../../authoring/using/editing-content.md#touchoptimizedui) as required.
...
>[!NOTE]
>
>A page can only be moved to a location where the template upon which the page is based is allowed. See [Template Availability](../../developing/using/templates.md#main-pars-title-1885710792) for more information.
...
1. From the **Select Destination** stage of the wizard you can either:
    ...
    * Use the [column view](../../authoring/using/basic-handling.md#main-pars-title-1571169225) to navigate to the new location for the page:
...
1. Use [selection mode](../../authoring/using/basic-handling.md#main-pars-title-14) to select the required page, then use **Delete** from the toolbar:
...
You can [lock/unlock a page](../../authoring/using/editing-content.md#main-pars-title-13) from either a console or when editing an individual page. Information about whether a page is locked is also shown in both locations.
