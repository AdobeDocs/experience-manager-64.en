...
uuid: fecb6d47-a47e-40dd-9a7d-d622fc551ac9
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: 25e64934-7ccc-4729-8dda-ee3b15ede3e4
...
<p>In Adobe Campaign Standard, the template is <strong>Delivery with AEM Content</strong>. In Adobe Campaign 6.1, the template is <strong>Email delivery with AEM content</strong>.</p>
...
See [Adobe Campaign Components](../../authoring/using/adobe-campaign-components.md) for a full description of the Campaign components.
