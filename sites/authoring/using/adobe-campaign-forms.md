...
uuid: 476dba50-6500-478a-8592-a5e0e1788faa
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: d66ce7b8-c557-4df5-af52-49e4ce1fb47b
...
1. Create a page and select **Adobe Campaign Profile (AC 6.1) **or** Adobe Campaign Profile (ACS)** and click **Next**.

   ![](assets/chlimage_1-320.png)

   >[!NOTE]
   >
   >If the desired template is not available, see [Making a template available](../../authoring/using/adobe-campaign.md#activatingatemplate).
...
This section only details specific links to Adobe Campaign. For more information on a more general overview of how to use forms in Adobe Experience Manager, see [Editmode components](../../authoring/using/default-components-foundation.md).
...
1. Add components to the form as needed, such as a Text field, Date field, Checkbox field, Option field, and so on. See [Adobe Campaign Form Components](../../authoring/using/adobe-campaign-components.md) for more information on each component.
