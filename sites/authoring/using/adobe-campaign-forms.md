...
uuid: 8a5aa7d9-cfd8-4162-a707-54946eec4a94
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: 145c9b1c-1850-4f0f-8717-6e11b08bf013
...
First of all, check the connection between the author and publish instances and Adobe Campaign is working. See [Integrating with Adobe Campaign Standard](../../administering/using/campaignstandard.md) or [Integrating with Adobe Campaign Classic](../../administering/using/campaignonpremise.md).
