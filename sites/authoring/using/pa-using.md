...
uuid: 6ef5eb48-3754-46d5-a0a6-46116733f0c8
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: site-features
discoiquuid: 544e1478-458e-45ce-a074-ead4369bc54f
...
Page analytics data is displayed in [List View](../../authoring/using/basic-handling.md#listview) of the Sites console. When the pages are displayed in list format, the following columns are available by default:
...
>[!NOTE]
>
>To change the update period, [configure the import interval](../../administering/using/adobeanalytics-connect.md#configuringtheimportinterval).

1. Open the **Sites** console; for example [http://localhost:4502/sites.html/content](http://localhost:4502/sites.html/content)
1. In the far right of the toolbar, (upper right corner), click or tap the icon to select **List View** (the icon shown will depend on the [current view](../../authoring/using/basic-handling.md#viewingandselectingresources)).  
...
Open [Content Insight](../../authoring/using/content-insights.md) from the Sites console to further investigate page effectiveness.
...
>[!NOTE]
>
>This will be shown if the [Activity Map has been configured](../../administering/using/adobeanalytics-connect.md#configuringfortheactivitymap) for your website.

>[!NOTE]
>
>Data for the Activity Map is taken from Adobe Analytics.

When your website has been [configured for Adobe Analytics](../../administering/using/adobeanalytics-connect.md), you can use the [mode Activity Map](../../authoring/using/author-environment-tools.md#pagemodes) to view relevant data. For example:

![](assets/AA-07.png) 

### Accessing the Activity Map {#accessing-the-activity-map}

After selecting the [Activity Map](../../authoring/using/author-environment-tools.md#pagemodes) mode, you will be requested to enter your Adobe Analytics credentials.
