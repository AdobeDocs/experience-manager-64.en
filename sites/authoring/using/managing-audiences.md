...
uuid: 8c240aaa-1d3e-48be-bb75-5ccad22ee4d7
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: f8b25d38-a1ae-499d-8571-8747cafbbd1c
...
Audiences are available in Targeting mode for [authoring targeted content](../../authoring/using/content-targeting-touch.md), where you can also create audiences (but you need to create Adobe Target audiences in the Audiences console). Audiences that you create in Targeting mode appear in the Audiences console.
...
For further detail about creating segments using ContextHub, please see the [Configuring Segmentation with ContextHub](../../administering/using/segmentation.md) documentation.
...
1. Make any edits in the segment editor. See [Client Context](../../administering/using/campaign-segmentation.md) or [ContextHub](../../administering/using/contexthub-config.md) documentation.
