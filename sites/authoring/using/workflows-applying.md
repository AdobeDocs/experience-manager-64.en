...
uuid: 0f9081fe-4578-4e61-add8-889115df6706
contentOwner: Alison Heimoz
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: site-features
discoiquuid: 5eda979a-be3a-42be-9b6a-0881e2117635
...
>See also:
>
>* [How to apply workflows to DAM assets](/content/help/en/experience-manager/6-4/assets/using/assets-workflow).
...
1. [Select the resource](../../authoring/using/basic-handling.md#viewingandselectingyourresources) and open [Timeline](../../authoring/using/basic-handling.md#timeline) (or open Timeline and then select the resource).
...
1. In the **Properties** step, the basic options of the workflow are defined:
   ...
   >[!NOTE]
   >
   >The **Keep workflow package** option is available when the workflow has been configured for [Multi Resource Support](/developing/using/workflows-models#ConfiguringaWorkflowforMultiResourceSupport) and multiple resources have been selected.
...
1. In the **Scope** step you can select:
    ...
    * **Add Content** to open the [path browser](../../authoring/using/author-environment-tools.md#pathbrowser) and select additional resources; when in the browser, click/tap **Select** to add the content to the workflow instance.
