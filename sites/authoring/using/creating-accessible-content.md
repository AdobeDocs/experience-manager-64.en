...
uuid: 9ba60d44-fc3f-4a75-aad8-c3c0ec96c6d1
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: eb9f9461-27bf-4a14-9fa3-a44471a0a559
...
<p>6.1 - Review</p>
 ...
 -->
  ...
  ![Table properties dialog.](assets/chlimage_1-195.png) 

  <!-- 

Comment Type: draft

<img alt="Table properties dialog; setting the first row as a header row." imageRotate="0" src="assets/chlimage_1-196.png" />
...
<img alt="Call properties dialog; setting a row (usually the first one) as a header row." imageRotate="0" src="assets/chlimage_1-198.png" />
...
![Title and Text tab (edit dialog); the title ‘Description’ has been added.](assets/chlimage_1-199.png) 
...
![Image button with the Alt Text set in the Title field (edit dialog).](assets/chlimage_1-200.png) 
...
![Adding items to the radio group. The group title is 'Contact me by' - defined in the Title field.](assets/chlimage_1-201.png) 
...
![Adding additional information (the word required) for screen reader users in the ‘Title’ field.](assets/chlimage_1-202.png)
