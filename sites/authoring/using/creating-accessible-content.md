...
uuid: b34fcda8-7516-4303-a53d-d2a23f0396e0
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 878acfbe-2b7f-440b-91ee-24e856153552
...
>* [Configuring the Rich Text Editor for producing accessible content](../../administering/using/rte-accessible-content.md)  
>
...
* **Use lists**: You can use HTML to specify three different types of lists:
  ...
  ![](assets/screen_shot_2018-03-21at165756.png)
...
* **Use tables**:
  ...
  ![Table properties dialog.](assets/chlimage_1-165.png) 

  <!--
  Comment Type: draft

  <img alt="Table properties dialog; setting the first row as a header row." imageRotate="0" src="assets/chlimage_1-166.png" />
  -->
  ...
  ![Call properties dialog; setting a row (usually the first one) as a header row.](assets/chlimage_1-167.png) 

  <!--
  Comment Type: draft

  <img alt="Call properties dialog; setting a row (usually the first one) as a header row." imageRotate="0" src="assets/chlimage_1-168.png" />
  -->
...
![Title and Text tab (edit dialog); the title ‘Description’ has been added.](assets/chlimage_1-169.png) 
...
![Image button with the Alt Text set in the Title field (edit dialog).](assets/chlimage_1-170.png) 
...
![Adding items to the radio group. The group title is 'Contact me by' - defined in the Title field.](assets/chlimage_1-171.png) 
...
![Adding additional information (the word required) for screen reader users in the ‘Title’ field.](assets/chlimage_1-172.png)
