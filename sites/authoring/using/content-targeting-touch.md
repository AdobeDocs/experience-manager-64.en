...
uuid: 7a628eb3-0f30-4c55-865f-be7e325bfa26
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: 054614c6-526b-4d7c-af21-7139f343c130
...
You can use either AEM or Adobe Target as the targeting engine (you must have a valid Adobe Target account to use Adobe Target). If you are using Adobe Target, you must configure the integration first. See [instructions for integrating with Adobe Target](../../administering/using/target.md).

![](assets/chlimage_1-35.png)

The activities and experiences that you see in Target mode reflect the [Activites console](../../authoring/using/activitylib.md):
...
When you add an activity, it also appears in the [Activities console](../../authoring/using/activitylib.md).
...
1. Use the **Brand** drop-down menu to select the brand for which you want to create the activity.
   ...
   >[!NOTE]
   >
   >It is recommended to [create brands through the activities console](../../authoring/using/activitylib.md#main-pars-title).
   >
   >
...
1. In the **Targeting** engine drop-down menu, select your targeting engine.
    ...
    * If you select **Adobe Target**, you can select a configuration (by default, it is the configuration you provided when you [configured the account](../../administering/using/opt-in.md)) and Activity Type.
    
    * If you are using the AEM/Adobe Campaign integration and are sending targeted content (newsletters), select **Adobe Campaign**. See [Integrating with Adobe Campaign](../../administering/using/campaign.md) for more information.
...
After you [start the targeting process](../../authoring/using/content-targeting-touch.md#main-pars-title-7), select an experience to see the offers that are provided for that experience. When you select an experience, the targeted components on the page change to show the offer for that experience.
...
Offers that are [authored on the page](../../authoring/using/content-targeting-touch.md#main-pars-title-14) and used for a single experience are called custom offers. The following image is superimposed on the content of a custom offer:

![](assets/chlimage_1-42.png)

Offers that are [added from an offer library](../../authoring/using/content-targeting-touch.md#main-pars-title-3) are superimposed with the following image:
...
Using the Create step of [the targeting process](../../authoring/using/content-targeting-touch.md#main-pars-title-7), you can add and remove experiences. In addition, you can duplicate an experience and also rename it.
...
* [Target an existing component](../../authoring/using/content-targeting-touch.md#main-pars-title-5). The content becomes the offer of the Default Experience.
* [Add a Target component](../../authoring/using/content-targeting-touch.md#main-pars-title-4), then add content to the component.

After a component is targeted, you can add offers for each experience:

* [Add custom offers](../../authoring/using/content-targeting-touch.md#main-pars-title-14).
* [Add offers from a library](../../authoring/using/content-targeting-touch.md#main-pars-title-3).

The following tools are available for working with offers:

* [Add a custom offer to an offer library](../../authoring/using/content-targeting-touch.md#main-pars-title-15).
* [Convert a library offer to a custom offer](../../authoring/using/content-targeting-touch.md#main-pars-title-16).
* [Open a library offer and edit the content](../../authoring/using/content-targeting-touch.md#main-pars-title-17).
...
Perform the following procedure after [starting the targeting process](../../authoring/using/content-targeting-touch.md#main-pars-title-7).
...
See [Configuring Target component options](../../authoring/using/content-targeting-touch.md#configuringtargetcomponentoptions) for information on customizing this component.

>[!NOTE]
>
>Offers that you create using the [Offers console](../../authoring/using/offerlib.md) can also contain several components. These offers belong to an offer library and can be used for multiple experiences.
...
1. Create the offer:
    ...
    * For non-default experiences, either [add a custom offer](#addingacustomoffer) or [add a library offer](../../authoring/using/content-targeting-touch.md#main-pars-title-3).
...
Add an offer from the [offer library](../../authoring/using/offerlib.md) to an experience. You can add any offer from the library of the brand that you are currently targeting.
...
Add a custom offer to the [offer library](../../authoring/using/offerlib.md) when you want to reuse it as the offer for multiple experiences. You can add offers to the library of the current brand that you are targeting.

For information about using the Offers console to create a reusable offer, see [Add an Offer to an Offer Library](../../authoring/using/offerlib.md#addanoffertoanofferlibrary).
...
For information targeting engines, see [Targeting Engine](../../authoring/using/personalization.md#targetingengine).
...
After configuring, you can [view the performance of your activities](../../authoring/using/activitylib.md#viewingperformanceandconvertingwinningexperiencesabtest) that use Adobe Target (either experience or A/B test targeting). In addition, with A/B test targeting, you can [convert the winners.](../../authoring/using/activitylib.md#viewingperformanceandconvertingwinningexperiencesabtest)
...
* The [Activities that are On](../../authoring/using/activitylib.md).
* The [rules that define the segments](../../administering/using/campaign-segmentation.md).
* The content of the experiences in the Target components.
* The [configuration of the Targeting engine](../../authoring/using/activitylib.md).
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody> 
  ...
  <tr> 
   ...
   You select **Adobe Campaign** as the engine if you are integrating AEM with Adobe Campaign. See [Integrating AEM with Adobe Campaign](../../administering/using/campaign.md) for more information.

   Select **ContextHub** as the engine if you are using ContextHub for targeting. See [Configuring ContextHub.](../../administering/using/contexthub-config.md)
