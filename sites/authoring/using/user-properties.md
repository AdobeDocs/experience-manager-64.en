...
uuid: e1eaa20a-034f-4732-a5e3-cf756b8cb9f9
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: introduction
content-type: reference
discoiquuid: 807d1c9c-e1b7-47e7-9b4a-36e1f3327129
...
Using the [User](../../authoring/using/user-properties.md#main-pars-title-3) option in the [header](../../authoring/using/basic-handling.md#main-pars-title-21) and the associated [My Preferences](#userpreferences) dialog, you can modify your user options such as.

Begin by acessing the [User](../../authoring/using/user-properties.md#main-pars-title-3) option in the header.
...
* Impersonate as
    ...
    * With the [Impersonate as](../../administering/using/security.md#main-pars-title-23) functionality a user can work on behalf of another user.

* Profile

    * Offers a convenient link to your [user settings](../../administering/using/security.md))
...
The **My Preferences** dialog is access via the [User](../../authoring/using/user-properties.md#main-pars-title-3) option in the header.
...
* **Use Classic Authoring Experience  
  **
  ...
  This option enables [classic UI](/classic-ui-authoring/user-guide)-based page authoring. By default the standard UI is used.
