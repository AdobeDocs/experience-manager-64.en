...
uuid: aa0e36ad-2967-47a6-be9c-a42dcdad3645
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: f110cb0b-babe-4744-99a0-0f8f89806830
...
Preparing the design package for importing is covered in [Extending and Configuring the Design Importer](../../administering/using/extending-the-design-importer-for-landingpages.md). Integrating with Adobe Analytics is covered in [Integrating Landing Pages with Adobe Analytics.](../../administering/using/integrating-landing-pages-with-adobe-analytics.md)
...
1. [Prepare the HTML and assets.](../../administering/using/extending-the-design-importer-for-landingpages.md)
...
The Text component lets you enter a text block using a WYSIWYG editor. See [Text component](../../authoring/using/default-components.md#text) for more information.
...
The title component lets you display a title and configure the size (h1-6). See [Title component](../../authoring/using/default-components.md#title) for more information.
...
The image component displays an image that you can either drag and drop from the Content Finder or click to upload. See [image component](../../authoring/using/default-components.md) for more information.
...
>
>Not all options are available to all lead form components. See Forms for more information on these [common settings](../../authoring/using/default-components.md#formsgroup).
...
1. [Prepare the HTML for importing.](../../administering/using/extending-the-design-importer-for-landingpages.md)
...
Before importing the design package, the HTML needs to be prepared. See [Extending and Configuring the Design Import](../../administering/using/extending-the-design-importer-for-landingpages.md) for more information.

### Importing the Design Package {#importing-the-design-package}

After an importer page has been created, you can import a design package onto it. Details on creating the design package and its recommended structure are explained in [Extending and Configuring the Design Import](../../administering/using/extending-the-design-importer-for-landingpages.md).
...
>[!NOTE]
>
>If you have trouble importing the design package, see [Troubleshooting](../../administering/using/extending-the-design-importer-for-landingpages.md#troubleshooting).
...
>[!NOTE]
>
>If a component on the landing page cannot be edited, you need to re-import the zip file after [modifying the HTML file.](../../administering/using/extending-the-design-importer-for-landingpages.md) It means that during the import, the non-editable parts were not converted into AEM components.
