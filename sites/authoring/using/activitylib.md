...
uuid: 722704b4-7d29-4451-81d5-e266af869902
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: ddae6492-741b-4b69-ab87-2e6fad97a0ee
...
The Activities console enables you to create, organize, and manage the marketing [activities](../../authoring/using/personalization.md#main-pars-title-44) of your brands:
...
Activities are available in Targeting mode for [authoring targeted content](../../authoring/using/content-targeting-touch.md), where you can also create activities. Activities that you create in Targeting mode appear in the Activities console.
...
When you create a brand using the Activities console, it also appears in the [Offers console](../../authoring/using/offerlib.md) where you can create offers for the experiences of your activities.
...
* **Targeting Engine:** Either [AEM](../../authoring/using/personalization.md#main-pars-title-4) or [Adobe Target](../../authoring/using/personalization.md#main-pars-title-5) as the engine for targeted content.
...
1. If you are using Adobe Target as your targeting engine, select what you would like to measure with this activity. See [Configuring the Activity and Setting Goals](../../authoring/using/content-targeting-touch.md) for more information on the success metrics available. You must select at least one goal.
1. Click or tap **Save**.
