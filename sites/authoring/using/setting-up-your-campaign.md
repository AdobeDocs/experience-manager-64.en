...
uuid: 764c2cf9-8350-48ee-aae5-2819a69256ca
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: 1781d9e1-fb8a-46e0-9528-ebdbc5bbd8a3
...
* If creating a Teaser:
    ...
    1. [Create a teaser experience](../../authoring/using/campaigns.md#creatingateaserexperience).
    1. [Add content to your teaser](../../authoring/using/campaigns.md#addingcontenttoyourteaser).
    1. [Create a Touchpoint for your Teaser](../../authoring/using/campaigns.md#creatingatouchpointforyourteaser) (add your teaser to a content page).

* If creating a Newsletter:

    1. [Create a newsletter experience](../../authoring/using/campaigns.md#creatinganewsletterexperience).
    1. [Add content to the newsletter.](../../authoring/using/campaigns.md#addingcontenttonewsletters)
    1. [Personalize the newsletter.](../../authoring/using/campaigns.md#personalizingnewsletters)
    1. [Create a compelling newsletter landing page](../../authoring/using/campaigns.md#settingupanewsletterlandingpage).
    1. [Send the newsletter](../../authoring/using/campaigns.md#sendingnewsletters) to subscribers or leads.

* If creating an Adobe Target (formerly Test&Target) Offer:

    1. [Create an Adobe Target offer experience](../../authoring/using/campaigns.md#creatingatesttargetofferexperience).
    1. [Integrate with Adobe Target](../../authoring/using/target-offers.md).
...
* [Creating a Teaser](../../authoring/using/campaigns.md#creatingateaser)
* [Creating a Newsletter](../../authoring/using/campaigns.md#creatinganewsletter)
* [Creating an Adobe Target Offer](../../authoring/using/campaigns.md#creatingatesttargetoffer)
...
* [Teaser](../../authoring/using/campaigns.md#teasers):

    * [Connect the teaser page to visitor segments.](../../authoring/using/campaigns.md#applyingasegmenttoyourteaser)
    * [Create a Touchpoint for your Teaser](../../authoring/using/campaigns.md#creatingatouchpointforyourteaser) (add your teaser to a content page).

* [Newsletter](../../authoring/using/campaigns.md#newsletters):

    * [Add content to the newsletter.](../../authoring/using/campaigns.md#addingcontenttonewsletters)
    * [Personalize the newsletter.](../../authoring/using/campaigns.md#personalizingnewsletters)
    * [Send the newsletter](../../authoring/using/campaigns.md#sendingnewsletters) to subscribers or leads.
    * [Create a compelling newsletter landing page](../../authoring/using/campaigns.md#settingupanewsletterlandingpage).

* [Adobe Target Offer](../../authoring/using/campaigns.md#testtargetoffers):
