...
uuid: 23028afe-fef1-4a2e-b0f6-fb1ca0f7707a
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 579a24fc-b0fb-43ed-81de-d77fe0ac74d5
disttype: dist5
gnavtheme: light
...
![](assets/chlimage_1-180.png)  ![](assets/dc_chart_use.png)
...
Once the image is uploaded (and not before) you can use [inplace editing](../../authoring/using/editing-content.md#main-pars-title-12) to crop/rotate the image as required:
