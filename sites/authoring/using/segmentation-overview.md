...
uuid: 647f8757-cbfd-438e-849d-8eeeca3e10c4
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: dff0413a-1741-4acb-aa4a-f3dd4515c996
...
Segments are defined in [Configuring Segmentation](../../administering/using/campaign-segmentation.md). They are used to steer the actual content seen by a specific target audience.
...
>[!NOTE]
>
>Please see [Segmentation](../../administering/using/campaign-segmentation.md) for further information on segments in AEM.
