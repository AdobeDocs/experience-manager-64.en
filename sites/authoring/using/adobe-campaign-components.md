...
uuid: 67a1138c-72bc-4913-beac-66f3fdbb5e23
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: f7438c12-2873-41fb-babc-94fb58ddb116
...
All the Campaign components follow the best practices outlined in [Best Practices for Email Templates](../../administering/using/best-practices-for-email-templates.md) and are based on the Adobe markup language [HTL](/content/help/en/experience-manager/htl/using/overview).
...
You can either drag and drop an image from the [Asset Browser](../../authoring/using/author-environment-tools.md#assetsbrowsertouchoptimizedui) directly onto the component or its [Configure dialog](../../authoring/using/editing-content.md#editconfigurecopycutdeletepastetouchoptimizedui). You can also upload an image from the Configure dialog; this dialog also controls all definitions and manipulation of the image:
...
After the image is uploaded (and not before) you can use [inplace editing](../../authoring/using/editing-content.md#editcontenttouchoptimizedui) to crop/rotate the image as required:
...
Click **Edit** to configure the component. You can configure the settings described in this section. This Scene7 Image template is described in detail in [Scene7 Image Template component](/content/help/en/experience-manager/6-4/assets/using/scene7#ImageTemplate).
...
The Text & Personalization (Campaign) component lets you enter a text block using a WYSIWYG editor, with functionality provided by the [Rich Text editor](../../authoring/using/rich-text-editor.md). In addition, this component lets you use context fields and personalization blocks available from Adobe Campaign; also see [Inserting Personalization](../../authoring/using/campaign.md#insertingpersonalization).

The selection of icons allow you to format your text, including font characteristics, alignment, links, lists and indentation. The functionality is basically the same in [both UIs](../../authoring/using/editing-content.md), although the look-and-feel is different:

![](assets/chlimage_1-106.png)

In the inplace editor you can add text, change the justification, add and remove links, add context fields or personalization blocks, and enter full-screen mode. When finished adding text/personalization, select the check mark to save your changes (or x to cancel). See [Inplace editing](../../authoring/using/editing-content.md#editcontenttouchoptimizedui) for more information.
...
>
>See [Inserting Personalization](../../authoring/using/campaign.md#insertingpersonalization).
...
You use Adobe Campaign components to create a form that users fill out to either subscribe to a newsletter, unsubscribe from a newsletter, or update their user profiles. See [Creating Adobe Campaign Forms](../../authoring/using/adobe-campaign-forms.md) for more information.
