...
uuid: 39a5382d-2c02-4e00-b90f-d0fce082a679
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: introduction
content-type: reference
discoiquuid: 1579263f-c2ec-4583-bb8e-4cbdddd33517
...
Various keyboard shortcuts are available throughout AEM. Some apply to the use of consoles, others to [page editing](../../authoring/using/page-authoring-keyboard-shortcuts.md).

>[!NOTE]
>
>The [modifier keys](../../authoring/using/keyboard-shortcuts.md#main-pars-header-879548855) required for AEM keyboard shortcuts vary depending on operating system.
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody>
  ...
  <tr>
   <td> </td> 
   <td><span class="kbd">/</span></td> 
   <td>Invoke <a href="../../authoring/using/search.md">search</a></td> 
  </tr>
  <tr>
   <td> </td> 
   <td><span class="kbd">Alt+&lt;Number&gt;</span></td> 
   <td>Toggle which <a href="../../authoring/using/basic-handling.md#main-pars-title-53c">rail selector option</a> to view</td> 
  </tr>
  <tr>
   <td> </td> 
   <td><span class="kbd">`</span></td> 
...
The key combinations are listed with the Windows [modifier keys](../../authoring/using/keyboard-shortcuts.md#main-pars-header-879548855).

Various keyboard shortcuts are also available for desktop users when using the [page editor](../../authoring/using/page-authoring-keyboard-shortcuts.md) to author pages.
...
>
>Adobe recommends [disabling AEM keyboard shortcuts](../../authoring/using/keyboard-shortcuts.md#main-pars-header) when using a screen reader.
...
* [My Preferences](../../authoring/using/user-properties.md#main-pars-title-2)
* The [help menu](../../authoring/using/basic-handling.md#main-pars-title-24)
