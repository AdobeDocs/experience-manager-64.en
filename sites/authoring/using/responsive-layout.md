...
uuid: 9c416d6f-3c15-4e73-b5e5-a98a84ebf313
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 1311bbe0-fa7a-4ae6-9add-7762f33d5903
...
This provides a paragraph system that allows you to position components within a responsive grid. This grid can rearrange the layout according to the device/window size and format. The component is used in conjunction with the [**Layout** mode](../../authoring/using/responsive-layout.md#main-pars-title), which allows you to create and edit your responsive layout dependent on device.
...
* [**Layout Container**](#addingalayoutcontaineranditscontenteditmode) component  
  This component is available in the [component browser](../../authoring/using/author-environment-tools.md#main-pars-title-17) and provides a grid-paragraph system to allow you to add and position components within a responsive grid. It can also be set as the default paragraph system on your page.  

* [**Layout** **Mode**](../../authoring/using/responsive-layout.md#main-pars-title)  
...
>[!NOTE]
>
>Use of the above mechanisms is enabled by configuration on the template. See [Configuring Responsive Layout](../../administering/using/configuring-responsive-layout.md) for further information.
...
1. Select the **Emulator** icon from the top toolbar:
   ...
   ![](assets/screen_shot_2018-03-23at084256.png)
...
1. The emulator toolbar will open.
   ...
   ![](assets/screen_shot_2018-03-23at084612.png) ![](assets/screen_shot_2018-03-23at084637.png)

    * **Select Device** - Define a specific device to emulate from a list (see next step for details)

   ![](assets/screen_shot_2018-03-23at084743.png)
...
1. Once a specific device has been selected you can:
    ...
    * See the active marker for the appropriate [breakpoint](../../authoring/using/responsive-layout.md#main-pars-title-2) such as **Tablet.**
    ...
    * The fold can also be considered the page line break (not to be confused with the [breakpoints](../../authoring/using/responsive-layout.md#main-pars-title-2)) for the content. This is displayed for convenience to show what part of the content the user will see on the device before scrolling.
...
>[!NOTE]
>
>If not already available, the **Layout Container** must be explicitly [activated for a paragraph system/page](../../administering/using/configuring-responsive-layout.md#activatingthelayoutcontainerforapage) (for example, by using [**Design** mode](../../authoring/using/default-components-designmode.md)).

1. The **Layout Container** is available as a standard component in the [Components Browser](../../authoring/using/author-environment-tools.md#main-pars-title-17). From here you can drag it to the required location on the page after which you will see the **Drag Components here** placeholder.
...
1. If you mouseover or tap the grid placeholder, the action menu is displayed.
   ...
   ![](assets/screen_shot_2018-03-23at085417.png)
...
* By using the [mode menu in the toolbar](../../authoring/using/author-environment-tools.md#main-pars-title-20) and choosing **Layout** mode
...
* When [editing an individual component.](../../authoring/using/editing-content.md#editcomponentlayout)
...
* In **Layout** mode you can tap/click on the **Drag components here** to select the entire component. This will show the toolbar for this mode.
  ...
  ![](assets/screen_shot_2018-03-23at090823.png)
  ...
  ![](assets/screen_shot_2018-03-23at090834.png)
