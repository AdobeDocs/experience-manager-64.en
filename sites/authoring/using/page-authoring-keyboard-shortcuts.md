...
uuid: b2e6dbe2-d9c5-474f-a42b-4df13ce7749d
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 54bf0013-094f-425f-a91d-0d53d0a72d59
...
Various keyboard shortcuts are available throughout AEM. Some apply when editing pages, others to the [use of consoles](../../authoring/using/keyboard-shortcuts.md).

>[!NOTE]
>
>The [modifier keys](../../authoring/using/page-authoring-keyboard-shortcuts.md#main-pars-header) required for AEM keyboard shortcuts vary depending on operating system.
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody>
  ...
  <tr>
   ...
   <td>Toggle between <a href="../../authoring/using/author-environment-tools.md#main-pars-title-20"><strong>Preview</strong> and the currently selected mode</a> (e.g. <strong>Edit</strong>, <strong>Layout</strong>, etc).*</td> 
  </tr>
  <tr>
   <td><strong>Edit</strong> mode</td> 
   <td><span class="code">Ctrl-z</span></td> 
   <td><a href="../../authoring/using/editing-content.md#main-pars-title-19">Undo last change</a>.</td> 
  </tr>
  <tr>
   <td> </td> 
   <td><span class="code">Ctrl-y</span></td> 
   <td><a href="../../authoring/using/editing-content.md#main-pars-title-19">Redo last change</a>.</td> 
  </tr>
  <tr>
   <td> </td> 
...
Various keyboard shortcuts are also available for desktop users when using the [consoles](../../authoring/using/keyboard-shortcuts.md).

>[!NOTE]
>
>Editor keyboard shortcuts are always active regardless if the [console shortcuts have been deactivated](../../authoring/using/keyboard-shortcuts.md#main-pars-header).
