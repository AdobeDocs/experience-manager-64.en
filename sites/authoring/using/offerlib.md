...
uuid: 473f5158-a81c-4335-a2f5-0e7852e21098
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: 181a1105-e2d9-44a3-92d8-b1125ea53875
...
Use the Offers console to create offers that you can [use in activity experiences](../../authoring/using/content-targeting-touch.md). Creating offers in the Offers console saves time when several experiences require the same offer:
...
When you create a brand using the Offers console, it also appears in the [Activities console](../../authoring/using/activitylib.md) where you can add and administer activities for the brand.
...
<p>See <a href="../../authoring/using/search.md">Searching</a> for detailed information.</p>
-->
...
1. Enter your keyword to search for offers. Select from the results.
   ...
   <p>For more information on how to add criteria see <a href="../../authoring/using/search.md">Searching</a>.</p>
   -->
