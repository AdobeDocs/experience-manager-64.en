...
uuid: d9218462-a921-447e-9b67-ca691a516e02
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: a58b42ef-5b8e-439e-a49e-39ea3a2db5bc
...
Some are immediately available through the sidekick, various others are also available by using [Design mode](../../classic-ui-authoring/using/classic-page-author-design-mode.md) to enable/disable them.
...
The components are available when [editing a page](../../classic-ui-authoring/using/classic-page-author-edit-content.md) from the **Components** tab of the sidekick and the **Insert New Component** selector (when you double-click in the **Drag components or assets here** area).

You can select a component and drag it to the required location on your page and then [Edit Content and Properties](../../classic-ui-authoring/using/classic-page-author-edit-content.md#main-pars-title-7-adkyem-refd).
...
Last Modified Date: 2017-12-07T05:35:12.517-0500
...
![](assets/chlimage_1-36.png)  ![](assets/dc_chart_use.png)
...
[Content fragments](../../classic-ui-authoring/using/classic-page-author-content-fragments.md) are created and managed as page-independent assets. You can then use these fragments, and their variations, when authoring your content pages.
...
Comment Type: remark
Last Modified By: Alison Heimoz (aheimoz)
Last Modified Date: 2017-12-07T05:35:13.510-0500
...
>[!CAUTION]
>
>Although the Layout container component is available in the classic UI, its full functionality is only available in the touch-enabled UI. For details see [Responsive Layout](../../classic-ui-authoring/using/classic-page-author-responsive-layout.md).
...
Comment Type: remark
Last Modified By: Alison Heimoz (aheimoz)
Last Modified Date: 2017-12-07T05:35:14.642-0500
...
Comment Type: remark
Last Modified By: Alison Heimoz (aheimoz)
Last Modified Date: 2017-12-07T05:35:14.813-0500
...
Comment Type: remark
Last Modified By: Alison Heimoz (aheimoz)
Last Modified Date: 2017-12-07T05:35:14.843-0500
...
Last Modified Date: 2017-12-07T05:35:14.965-0500
...
>[!NOTE]
>
>The **Table** component is based on the [Rich Text editor](../../classic-ui-authoring/using/classic-page-author-rich-text-editor.md), as is the ** [Text](#text)** component.
>
...
For more information about applying tags, visit [Using Tags](../../classic-ui-authoring/using/classic-feature-tags.md).

### Text {#text}

>[!NOTE]
>
>The **Text** component is based on the [Rich Text editor](../../classic-ui-authoring/using/classic-page-author-rich-text-editor.md), as is the ** [Table](#table)** component.
>
>It is recommended to use the **Table** component for tables, although they can also be constructed with the **Text** component.

The Text component lets you enter a text block using a WYSIWYG editor, with functionality provided by the [Rich Text editor](../../classic-ui-authoring/using/classic-page-author-rich-text-editor.md). A selection of icons allow you to format your text, including font characteristics, alignment, links, lists and indentation.
...
For more detailed information about the Text component and the functionality provided by the Rich Text editor, see the [Rich Text Editor](../../classic-ui-authoring/using/classic-page-author-rich-text-editor.md) page.
...
Comment Type: remark
Last Modified By: Alison Heimoz (aheimoz)
Last Modified Date: 2017-12-07T05:35:18.007-0500
...
Comment Type: remark
Last Modified By: Alison Heimoz (aheimoz)
Last Modified Date: 2017-12-07T05:35:20.105-0500
...
Comment Type: remark
Last Modified By: Alison Heimoz (aheimoz)
Last Modified Date: 2017-12-07T05:35:20.159-0500
