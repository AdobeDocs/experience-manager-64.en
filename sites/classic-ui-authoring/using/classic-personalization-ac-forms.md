...
uuid: 96f753f2-3640-49f5-bcf6-0e3e4d32e9e8
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: personalization
content-type: reference
discoiquuid: cb219b24-0bad-4af4-8fb1-d8d6fe9109c2
...
To do this, see the [Templates documentation](../../developing/using/page-templates-static.md#templateavailability).

First of all, check the connection between the author and publish instances and Adobe Campaign is working. See [Integrating with Adobe Campaign Standard](../../administering/using/campaignstandard.md) or [Integrating with Adobe Campaign 6.1](../../administering/using/campaignonpremise.md).
...
1. Select either **Adobe Campaign Profile (AC 6.1)** or **Adobe Campaign Profile (ACS)** template and enter the page properties.
   ...
   >[!NOTE]
   >
   >If the template is not available, refer to the [Making a template available](../../classic-ui-authoring/using/classic-personalization-ac.md#activatingatemplate) section.
...
>[!NOTE]
>
>If the desired template is not available, see [Making a template available](../../classic-ui-authoring/using/classic-personalization-ac.md#activatingatemplate).

This section only details specific links to Adobe Campaign. For more information on a more general overview of how to use forms in Adobe Experience Manager, see [Editmode components](../../classic-ui-authoring/using/classic-page-author-edit-mode.md).
...
1. Add your selected components by dragging them from the toolbox and dropping them into the form. For more information on the available Adobe Campaign specific components, see [Adobe Form Components](../../classic-ui-authoring/using/classic-personalization-ac-components.md).
