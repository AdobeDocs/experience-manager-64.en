...
uuid: 39b3ff1e-be63-4992-b70e-74ad4f18162a
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: personalization
content-type: reference
discoiquuid: bc152a81-71e7-4fa9-866d-7d278d48c18e
...
>[!NOTE]
>
>Email notifications need to be configured via the osgi configuration. See [Configuring Email Notification.](../../administering/using/notification.md)
...
1. A new dialog will open immediately. Here you can enter properties for the newsletter.
   ...
   The **Default Recipients List** is a mandatory field as this forms the touchpoint for the newsletter (see [Working with Lists](../../classic-ui-authoring/using/classic-personalization-campaigns.md#workingwithlists) for more information about lists).
