...
uuid: dba871be-31c1-47d3-865c-3990b0737d51
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: fc6cbec7-8d44-442c-81da-743630d215e0
...
Various keyboard shortcuts are available throughout AEM. Some apply when editing pages, others to the [use of consoles](../../classic-ui-authoring/using/author-env-keyboard-shortcuts.md).
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Shows the <a href="../../administering/using/client-context.md">client context</a>.</td> 
  </tr> 
  <tr> 
...
Various keyboard shortcuts are also available for desktop users when using the [consoles](../../classic-ui-authoring/using/author-env-keyboard-shortcuts.md).
