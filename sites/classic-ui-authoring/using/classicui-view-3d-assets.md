...
uuid: 0041a223-8ab5-4b25-a5ac-077a574200c8
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
topic-tags: authoring
content-type: reference
discoiquuid: 02799e9e-75b9-4831-a100-484477db7468
...
See [About the use of stages in AEM 3D](../../classic-ui-authoring/using/classicui-stages-aem3d.md).
...
1. Make sure you have uploaded 3D assets into AEM.  
   See [About the uploading and processing of 3D assets in AEM](../../classic-ui-authoring/using/classicui-upload-proc-3d.md).
...
1. Do one of the following:
    ...
    * Render the 3D asset.  
      See [Rendering 3D assets](../../classic-ui-authoring/using/classicui-rendering-3d.md).
