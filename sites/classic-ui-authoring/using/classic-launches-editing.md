...
uuid: 940635b8-3262-456f-b6f0-d8523dc05d9c
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: site-features
discoiquuid: db9cf03a-e9ca-4afa-90b5-2729fd260c02
...
1. Select the required launch and click **Edit** to open the dialog:
    ...
    * In the **General** tab, you can edit:
      ...
      See [Launches - the Order of Events](../../authoring/using/launches.md#main-pars-title-6) for information about the purpose and interaction of these fields.
