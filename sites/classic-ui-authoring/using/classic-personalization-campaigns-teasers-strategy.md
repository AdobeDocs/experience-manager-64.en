...
uuid: d0cc8862-9b0b-4276-bfd7-72a942653795
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: personalization
content-type: reference
discoiquuid: f7c3cc42-4a2a-4396-b347-bc47f5cfb8e3
...
>[!NOTE]
>
>The Teaser component has been deprecated in AEM 6.2. Please use the [Target component](../../classic-ui-authoring/using/classic-personalization-content-targeting-touch.md#creatinganofferbyaddingatargetcomponent) instead.
...
<ol> 
 ...
 <li> 
  ...
  </draft-comment><p>Click <strong>New...</strong><br /> </p> <p>You can specify the <strong>Title</strong>, <strong>Name</strong> and type of experience to be created; in this case, <strong>Teaser Page</strong>.<br /> </p> <img imageRotate="0" src="assets/chlimage_1-4.png" /></li> 
...
1. Edit the teaser component to add the:
    ...
    * ** [Strategy](../../classic-ui-authoring/using/classic-personalization-campaigns.md#strategies)** 
