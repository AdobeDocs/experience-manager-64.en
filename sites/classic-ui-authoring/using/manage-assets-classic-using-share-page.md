...
uuid: d8f3027a-35a7-4566-bf52-64a1ff8da24d
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
topic-tags: authoring
content-type: reference
discoiquuid: 6ea69788-27a8-46df-80ae-66f42c67c6ed
disttype: dist5
gnavtheme: light
...
This section describes possible ways to search for and find digital assets. However, the methods that are available to you depend on the design of your Asset Share page. (See [Creating customized Asset Share and Asset Editor pages](/content/help/en/experience-manager/6-4/assets/using/assets-finder-editor).)
