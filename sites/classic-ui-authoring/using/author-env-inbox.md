...
uuid: 3788b45c-9bc4-47e5-8a94-300d3a4ac79f
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: introduction
content-type: reference
discoiquuid: 0ec2066c-8139-4b71-8ab2-e08d727ddbde
...
* A specialized inbox for workflow items is described in the [Participating in Workflows](/classic-ui-authoring/using/classic-workflows-participating) document.
...
1. Select the notification channel:
   ...
   >[!NOTE]
   >
   >A few settings need to be configured in order to be notified by email. It is also possible to customize the email template or to add an email template for a new language. Please refer to [Configuring Email Notification](../../administering/using/notification.md#configuringemailnotification) to configure email notifications in AEM.
