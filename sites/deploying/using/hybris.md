...
uuid: a00e4dc8-e201-471f-ae3f-e30ff1d6ad4e
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: e-commerce
content-type: reference
discoiquuid: 096e4220-2933-40d2-b4a7-02362c20aaa5
disttype: dist5
gnavtheme: light
...
The hybris extension of the eCommerce Integration Framework has been updated to support Hybris 5 (as default), while maintaining backward compatibility with [Hybris 4](../../developing/using/hybris.md#developingforhybris4).
...
>[!NOTE]
>
>For developers [API documentation](../../developing/using/ecommerce.md#apidocumentation) is also available for download.
...
1. Download the following files to the root folder of your extracted hybris distribution, `  
   ...
   [5.6.0 and later](assets/setup-1.groovy)
...
1. In the **Configuration** tab, **Upload** the following **Import file**:
   ...
   [](assets/geometrixx-outdoors-export.csv)
...
1. **Upload** the following **Media-Zip**:
   ...
   [](assets/geometrixx-outdoors-images.zip)
...
1. **Upload** the following **Import file**:
   ...
   [](assets/base-store.csv)
   For hybris 5.7, please use the following:

   [](assets/base-store-5_7.csv)
