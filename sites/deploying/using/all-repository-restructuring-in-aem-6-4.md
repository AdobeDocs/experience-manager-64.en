...
uuid: 99bbe44f-1a7e-457f-a8f4-24bbafabe3ac
contentOwner: chaikels
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: repo_restructuring
discoiquuid: 2db08dfc-cd46-4250-a626-b39fe472f388
index: y
internal: n
snippet: y
---
...
* [Workflow Instances](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#workflowinstances)
* [Workflow Models](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#workflowmodels)
* [Workflow Launchers](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#workflowlaunchers)
* [Workflow Scripts](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#workflowscripts)

**Prior to 6.5 Upgrade**

* [ContextHub Configurations](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#contexthubconfigurations)
* [Classic Cloud Services Designs](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#classiccloudservicesdesigns)
* [Classic Dashboards Designs](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#classicdashboardsdesigns)
* [Classic Reports Designs](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#classicreportsdesigns)
* [Default Designs](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#defaultdesigns)
* [Adobe DTM JavaScript Endpoint](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#adobedtmjavascriptendpoint)
* [Adobe DTM Web-Hook Endpoint](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#adobedtmwebhookendpoint)
* [Inbox Tasks](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#inboxtasks)
* [Multi-site Manager Blueprint Configurations](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#multisitemanagerblueprintconfigurations)
* [AEM Projects Dashboard Gadget Configurations](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#aemprojectsdashboardgadgetconfigurations)
* [Replication Notification E-mail Template](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#replicationnotificationemailtemplate)
* [Tags](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#tags)
* [Translation Cloud Services](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#translationcloudservices)
* [Translation Languages](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#translationlanguages)
* [Translation Rules](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#translationrules)
* [Translation Widget Client Library](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#translationwidgetclientlibrary)
* [Tree Activation Web Console](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#treeactivationwebconsole)
* [Vendor Translation Connector Cloud Services](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#vendortranslationconnectorcloudservices)
* [Workflow Notification Email Templates](../../deploying/using/all-repository-restructuring-in-aem-6-4.md#workflownotificationemailtemplates)
