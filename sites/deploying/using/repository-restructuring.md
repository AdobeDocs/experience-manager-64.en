...
uuid: 91698aad-5aa0-4b50-903e-ac638fa3f0d5
contentOwner: chaikels
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: repo_restructuring
discoiquuid: ea90b12e-859b-47f7-964c-8b1a810b0394
index: y
internal: n
snippet: y
---
...
* [Repository restructuring common to all AEM solutions](../../deploying/using/all-repository-restructuring-in-aem-6-4.md)
* [AEM Sites repository restructuring](../../deploying/using/sites-repository-restructuring-in-aem-6-4.md)
* [AEM Assets repository restructuring](../../deploying/using/assets-repository-restructuring-in-aem-6-4.md)
* [AEM Assets Dynamic Media repository restructuring](../../deploying/using/dynamicmedia-repository-restructuring-in-aem-6-4.md)
* [AEM Forms repository restructuring](../../deploying/using/forms-repository-restructuring-in-aem-6-4.md)
* [AEM Communities repository restructuring](../../deploying/using/communities-repository-restructuring-in-aem-6-4.md)
* [AEM Commerce repository restructuring](../../deploying/using/ecommerce-repository-restructuring-in-aem-6-4.md)
