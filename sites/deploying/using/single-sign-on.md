...
uuid: b069ecf9-d00e-4197-8299-6c4258984eea
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: configuring
content-type: reference
topic-tags: Security
discoiquuid: b226ae4e-0a16-43ef-9dea-7462add494be
...
To configure SSO for a AEM instance, you need to configure the [SSO Authentication Handler](../../deploying/using/osgi-configuration-settings.md#adobegranitessoauthenticationhandler):

1. When working with AEM there are several methods of managing the configuration settings for such services; see [Configuring OSGi](../../deploying/using/configuring-osgi.md) for more details and the recommended practices.
...
>[!NOTE]
>
>Single Sign On is often used in conjunction with [LDAP](../../administering/using/ldap-config.md).
