...
uuid: 9158fdf3-8909-4731-9e22-5bca11e7c2e6
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: configuring
content-type: reference
discoiquuid: 024e1d04-c8f3-456f-a7c6-b452df34049c
...
* Configuration  
  Shows the current configuration (as defined for the [Apache Sling Resource Resolver](../../deploying/using/osgi-configuration-settings.md#apacheslingresourceresolver)).
...
>[!NOTE]
>
>You can use `/etc/map.publish` to hold the configurations for the publish environment. These must then be replicated, and the new location ( `/etc/map.publish`) configured for the **Mapping Location** of the [Apache Sling Resource Resolver](../../deploying/using/osgi-configuration-settings.md#apacheslingresourceresolver) of the publish environment.
