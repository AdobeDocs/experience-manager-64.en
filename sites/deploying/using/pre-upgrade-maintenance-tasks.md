...
uuid: beeec18e-bf59-48d8-a479-4f419df0f464
contentOwner: sarchiz
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: upgrading
discoiquuid: 4dd9eb73-0ad4-4e91-8412-d0cd64e6d030
...
## Back Up Changes to /etc {#back-up-changes-to-etc}
...
## Generate The quickstart.properties File {#generate-the-quickstart-properties-file}
...
## Configure Workflow and Audit Log Purging {#configure-workflow-and-audit-log-purging}
...
## Install, Configure, and Run The Pre-Upgrade Tasks {#install-configure-and-run-the-pre-upgrade-tasks}
...
## Remove Updates From The /install Directory {#remove-updates-from-the-install-directory}
...
## Stop Any Cold Standby Instances {#stop-any-cold-standby-instances}
