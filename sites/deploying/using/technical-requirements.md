...
uuid: e5477ce0-2f1b-456a-a817-2183e133ae7a
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: platform
discoiquuid: f63c411d-5e3f-4115-b199-5e59987ea84b
...
>[!NOTE]
>
>* Digital asset use cases need more base memory. See [Deploying and Maintaining](../../deploying/using/deploy.md#main-pars-title-1) for details.
...
>
>In order to get the most of your AEM deployment with MongoDB, Adobe recommends licensing the MongoDB Enterprise version in order to benefit from professional support. See [Recommended Deployments](../../deploying/using/recommended-deploys.md#main-pars-title-1707113207) for more information.
>
