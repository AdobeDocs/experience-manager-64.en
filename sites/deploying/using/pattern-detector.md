...
uuid: df94869f-8e59-4e16-909e-8811d778fbc1
contentOwner: sarchiz
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: upgrading
content-type: reference
discoiquuid: 41f39604-ef8a-47ce-91cd-870f838dcd9d
...
The Pattern detector is released as part of the new `pre-upgrade-package` for source AEM versions 6.1 to 6.3 and can be installed using the [Package Manager](../../administering/using/package-manager.md).
