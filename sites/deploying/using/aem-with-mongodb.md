...
uuid: 9f5facff-d94b-4272-9e85-5ad651c29435
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: platform
content-type: reference
discoiquuid: 1c5f4630-f7c0-4c7d-8ce0-ce1e2150cc2f
...
For more deployment related information, consult the [Deploying and Maintaining](../../deploying/using/deploy.md) section of the documentation.
...
For a list of supported operating systems for AEM 6, see the [Technical Requirements page](../../deploying/using/technical-requirements.md).
...
For more information how to configure Node Stores, see [Configuring Node Stores and Data Stores in AEM](../../deploying/using/data-store-config.md).
