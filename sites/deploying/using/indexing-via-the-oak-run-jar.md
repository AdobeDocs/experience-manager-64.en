...
uuid: ec189c45-5d7e-4f52-802c-726ccc71134d
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: deploying
discoiquuid: 1aef55aa-3a23-4dd4-b3e4-d1bd0c51adac
...
## Index Consistency Checks {#index-consistency-checks}
...
## Re-indexing Approach Decision Tree {#re-indexing-approach-decision-tree}

This diagram is a decision tree for when to use the various re-indexing approaches.

![](assets/oak_-_reindexingwithoak-run.png) 

## Re-indexing MongoMK / RDMBMK {#re-indexing-mongomk-rdmbmk}
...
### Text Pre-extraction for SegmentNodeStore and DocumentNodeStore {#text-pre-extraction-for-segmentnodestore-and-documentnodestore}
...
### Online re-indexing for MongoMK or RDBMK using oak-run.jar {#online-re-indexing-for-mongomk-or-rdbmk-using-oak-run-jar}
...
## Re-indexing TarMK {#re-indexing-tarmk}
...
### Online Re-Indexing for TarMK {#online-re-indexing-for-tarmk}
...
### Online Re-Indexing TarMK using oak-run.jar {#online-re-indexing-tarmk-using-oak-run-jar}
...
### Offline Re-Indexing TarMK using oak-run.jar {#offline-re-indexing-tarmk-using-oak-run-jar}
...
### Out-of-band Re-Indexing TarMK using oak-run.jar  {#out-of-band-re-indexing-tarmk-using-oak-run-jar}
...
## Updating Indexing Definitions {#updating-indexing-definitions}
...
### Creating and Updating index definitions on TarMK using ACS Ensure Index {#creating-and-updating-index-definitions-on-tarmk-using-acs-ensure-index}
...
### Creating and Updating index definitions on TarMK using oak-run.jar {#creating-and-updating-index-definitions-on-tarmk-using-oak-run-jar}
...
### Creating and Updating Index Definitions on MonogMK using oak-run.jar {#creating-and-updating-index-definitions-on-monogmk-using-oak-run-jar}
