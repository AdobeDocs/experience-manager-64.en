...
uuid: 9f8eceee-2761-4145-9dcc-6e1cccab0921
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: deploying
discoiquuid: 872446bc-934f-4648-9e5d-38ff5e35be5a
...
For more information on the level of Relational Database support in AEM, please see the [Technical Requirements page](../../deploying/using/technical-requirements.md).
...
1. Configure the data source and the JDBC parameters by creating another configuration file with the following name in the `crx-quickstart\install` folder:
   ...
   >[!NOTE]
   >
   >For detailed information on the data source configuration for each supported database, see [Data Source Configuration Options](../../deploying/using/rdbms-support-in-aem.md#main-pars-title-2).
...
* `url:` The URL string of the database that needs to be used with JDBC. Each database type has its own URL string format. For more info, see [URL String Formats](../../deploying/using/rdbms-support-in-aem.md#main-pars-title-4) below.  
