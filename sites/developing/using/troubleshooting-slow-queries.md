...
uuid: 301b1b67-aa4b-4b2d-a141-50f39fe2b05e
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: best-practices
discoiquuid: d1a72e76-738a-4105-b349-94e7b8579edd
...
* Visit the AEM [Query Performance](../../administering/using/operations-dashboard.md#queryperformance) operations console and [Explain](../../administering/using/operations-dashboard.md#explainquery) slow queries looking for traversal or no index query explanations.
...
* Visit the AEM [Query Performance](../../administering/using/operations-dashboard.md#queryperformance) operations console and [Explain](../../administering/using/operations-dashboard.md#explainquery) slow queries looking for query plans that do not resolve query property restrictions to index property rules.
...
1. ***This adjustment is Query Builder specific, and does not apply to JCR-SQL2 or XPath.***
   ...
   Use [Query Builder' guessTotal](../../developing/using/querybuilder-api.md#usingpguesstotaltoreturntheresults) when the full set of results is **not **immediately needed.
...
* ** [Explain Query](../../administering/using/operations-dashboard.md#explainquery)**
...
* ** [Slow/Popular Queries](../../administering/using/operations-dashboard.md#queryperformance)**

    * An AEM Operations dashboard listing the recent slow and popular queries executed on AEM.

* ** [Index Manager](../../administering/using/operations-dashboard.md#theindexmanager)**
...
* ** [Logging](../../administering/using/operations-dashboard.md#logmessages)**
