...
uuid: 2a18ac12-2353-4612-af18-514f7edf4c78
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: platform
content-type: reference
discoiquuid: 25c31d43-e115-4b34-b2c5-6f9799772fee
...
* Templates are built up of [Components](../../developing/using/components.md);
* Components use, and allow access to, Widgets and these are used to render the Content.

>[!NOTE]
>
>[Editable templates](../../developing/using/page-templates-editable.md) are also available and are the recommended type of templates for most flexibility and the newest features.
...
Last Modified Date: 2018-08-07T05:47:30.218-0400
<p>For some reason, there was urgency to have this documented even though it is only available in 6.4.2.0 which is scheduled for a late September 2018 release. Therefore this section has been marked as draft and will be republished once the SP is available. CQDOC-12979</p>
-->

When styles are defined in the UI using [Design Mode](../../authoring/using/default-components-designmode.md), the design is persisted at the exact path of the content node for which the style is being defined.

>[!CAUTION]
>
>Adobe recommends only applying designs through [Design Mode](../../authoring/using/default-components-designmode.md).
>
...
If designs are only applied using Design Mode, then the following sections, [Design Path Resolution](../../developing/using/page-templates-static.md#main-pars-header-2012439475), [Decision Tree](../../developing/using/page-templates-static.md#main-pars-header-927666231), and the [Example](../../developing/using/page-templates-static.md#main-pars-header-1217991144) are not applicable.
...
This is a graphical representation of the [Design Path Resolution](../../developing/using/page-templates-static.md#main-pars-header-2012439475) logic.
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody> 
  ...
  <tr> 
   <td><span class="code">leaf<br /> </span></td> 
  ...
  <tr> 
   <td><span class="code">branch</span></td> 
   <td><p><span class="code">branch</span></p> <p><span class="code">leaf<br /> </span></p> </td> 
   <td><span class="code">branch</span></td> 
   <td> </td> 
  </tr> 
  <tr> 
   <td><span class="code">branch</span></td> 
   <td><p><span class="code">root</span></p> <p><span class="code">branch<br /> </span></p> </td> 
   <td><span class="code">branch</span></td> 
   <td> </td> 
  </tr> 
  <tr> 
   <td><span class="code">branch</span></td> 
   <td><p><span class="code">root</span></p> <p><span class="code">leaf<br /> </span></p> </td> 
   <td><span class="code">root</span></td> 
...
This example illustrates how to allow a template to be used for certain content paths. The templates that are available to the page author when creating new pages are determined by the logic defined in [Template Availability](../../developing/using/templates.md#main-pars-title-1885710792).

1. In CRXDE Lite, navigate to the template you want to use for your page, for example, the Newsletter template.
1. Change the `allowedPaths` property and other properties used for [template availabillity](../../developing/using/templates.md#main-pars-title-1885710792). For example, `allowedPaths`: `/content/geometrixx-outdoors/[^/]+(/.*)?` means that this template is allowed in any path under `/content/geometrixx-outdoors`.
