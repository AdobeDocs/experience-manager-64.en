...
uuid: 257e6352-ec64-47a7-8323-883cfa826138
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: development-tools
content-type: reference
discoiquuid: 93725746-9cfc-4136-8e81-f3e27979f399
...
>[!NOTE]
>
>Adobe now provides the [AEM Development Tools for Eclipse](../../developing/using/aem-eclipse.md) which helps you to develop AEM solutions with Eclipse.
...
1. Follow the instructions on [How-To Work with JSPs](../../developing/using/ht-projects-maven.md#howtoworkwithjsps) in [How-To Build AEM Projects using Apache Maven](../../developing/using/ht-projects-maven.md).
1. Add the following to the &lt;build /&gt; section in your content module's POM.
   ...
   This is not a problem: as noted in [How-To Work with JSPs](../../developing/using/ht-projects-maven.md#main-pars-title-10), the maven-jspc-plugin in this setup is only used to validate that JSPs compile as part of the build process. Eclipse already reports any problems in JSPs and does not rely on this Maven plugin to be able to do so.
