...
uuid: 9d4ff851-f66a-4c83-b907-7a7deb8da828
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: platform
content-type: reference
discoiquuid: bc01558a-0e0e-489f-a1e9-5fccd37f1d58
...
* When [creating a page you need to select a template](#templatespages); this will be used as the base for the new page. The template defines the structure of the resultant page, any initial content and the [components](../../authoring/using/default-components.md) that can be used (design properties).
...
>[!NOTE]
>
>When using a template to [create a new page](../../authoring/using/managing-pages.md#creatinganewpage) there is no visible difference (to the page author) and no indication of the type of template being used.
...
* Can be [created](../../authoring/using/templates.md#creatinganewtemplate) and [edited](../../authoring/using/templates.md#editingatemplate) by your authors.
...
* See [Editable Templates](../../developing/using/page-templates-editable.md) for further information.
...
* Uses [Design Mode](../../authoring/using/default-components-designmode.md) to persist design properties.
* Are stored under `/apps`
* See [Static Templates](../../developing/using/page-templates-static.md) for further information.
