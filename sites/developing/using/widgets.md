...
uuid: a4879989-d67b-48eb-aaee-eddb8fd4e3dc
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: components
content-type: reference
discoiquuid: 0c70a473-a611-425d-ab2b-d1f890c653c3
disttype: dist5
gnavtheme: light
...
For a complete reference of all the available widgets in AEM you can refer to the [widget API documentation](/developing/using/reference-materials/widgets-api/index) or to the [list of existing xtypes](../../developing/using/xtypes.md). In addition, many examples showing how to use the ExtJS framework are available on the [Sencha](http://www.sencha.com/products/extjs/examples/) site, the owner of the framework.
...
>[!NOTE]
>
>This page describes the usage of widgets within the classic UI. Adobe recommends that you leverage the modern, [touch-enabled UI](../../developing/using/touch-ui-concepts.md) based on [Coral UI](../../developing/using/touch-ui-concepts.md#main-pars-title-0) and [Granite UI](../../developing/using/touch-ui-concepts.md#main-pars-title-3).
...
For more details refer to the description of the [<ui:includeClientLib>](../../developing/using/taglib.md#main-pars-title-1565813984) tag.
...
>[!NOTE]
>
>The examples on this page are based on the Geometrixx sample content, which is no longer shipped with AEM, having been replaced by We.Retail. See the document [We.Retail Reference Implementation](../../developing/using/we-retail.md#main-pars-title-2a55) for how to download and install Geometrixx.
...
* Is defined by a node: node type = `cq:Dialog`, xtype = ` [dialog](../../developing/using/xtypes.md#dialog)`.

* Displays 3 tabs (node type = `cq:Panel`).
* Each tab has 2 textfields (node type = `cq:Widget`, xtype = ` [textfield](../../developing/using/xtypes.md#textfield)`).  
...
* Displays 1 tab (node type = `cq:Dialog`, xtype = ` [panel](../../developing/using/xtypes.md#panel)`)

* The tab has 2 textfields (node type = `cq:Widget`, xtype = ` [textfield](../../developing/using/xtypes.md#textfield)`)  
...
* Is defined by a node (node type = `cq:Dialog`, xtype = ` [tabpanel](../../developing/using/xtypes.md#tabpanel)`).
...
* The first tab has a ` [dialogfieldset](../../developing/using/xtypes.md#dialogfieldset)` widget with a ` [textfield](../../developing/using/xtypes.md#textfield)` and a ` [selection](../../developing/using/xtypes.md#selection)` widget with 3 options, and a collapsible ` [dialogfieldset](../../developing/using/xtypes.md#dialogfieldset)` with a ` [textarea](../../developing/using/xtypes.md#textarea)` widget.

* The second tab has a ` [dialogfieldset](../../developing/using/xtypes.md#dialogfieldset)` widget with 4 ` [textfield](../../developing/using/xtypes.md#textfield)` widgets, and a collapsible `dialogfieldset` with 2 ` [textfield](../../developing/using/xtypes.md#textfield)` widgets.
...
* Has 3 optional tabs (node type = `cq:Panel`), each one has 2 textfields (node type = `cq:Widget`, xtype = ` [textfield](../../developing/using/xtypes.md#textfield)`). Only one optional tab is displayed at a time.  
...
* Displays 1 tabpanel widget (node type = `cq:Widget`, xtype = ` [tabpanel](../../developing/using/xtypes.md#tabpanel)`) with 1 panel (node type = `cq:Panel`)

* The panel has a smartfile widget (node type = `cq:Widget`, xtype = ` [smartfile](../../developing/using/xtypes.md#smartfile)`) and an ownerdraw widget (node type = `cq:Widget`, xtype = ` [ownerdraw](../../developing/using/xtypes.md#ownerdraw)`)
...
* Displays 1 tabpanel widget (node type = `cq:Widget`, xtype = ` [tabpanel](../../developing/using/xtypes.md#textpanel)`) with 1 panel (node type = `cq:Panel`).

* The panel has a selection/checkbox widget (node type = `cq:Widget`, xtype = ` [selection](../../developing/using/xtypes.md#selection)`, type = ` [checkbox](../../developing/using/xtypes.md#checkbox)`) and a collapsible dialogfieldset widget (node type = `cq:Widget`, xtype = ` [dialogfieldset](../../developing/using/xtypes.md#dialogfieldset)`) that is hidden by default, with 2 textfield widgets (node type = `cq:Widget`, xtype = ` [textfield](../../developing/using/xtypes.md#textfield)`).
...
* Displays 1 tabpanel widget (node type = `cq:Widget`, xtype = ` [tabpanel](../../developing/using/xtypes.md#tabpanel)`) containing a panel (node type = `cq:Widget`, xtype = ` [panel](../../developing/using/xtypes.md#panel)`).  

* The panel has a `multifield` widget (node type = `cq:Widget`, xtype = ` [multifield](../../developing/using/xtypes.md#multifield)`).
...
* The `multifield` widget has a fieldconfig (node type = `nt:unstructured`, xtype = `ejstcustom`, optionsProvider = `Ejst.x3.provideOptions`) that is based on the custom xtype ' `ejstcustom`':
    ...
    * ' `fieldconfig`' is a config option of the ` [CQ.form.MultiField](/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.MultiField)` object.  
...
* Extends the ` [CQ.form.CompositeField](/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.CompositeField)` widget.  
...
* Overrides `CQ.Ext.Component#initComponent` to add the 3 fields:
    ...
    * `allowField` is a [CQ.form.Selection](/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.Selection) object of type 'select'. optionsProvider is a configuration of the Selection object that is instantiated with the optionsProvider configuration of the CustomWidget defined in the dialog
    
    * `otherField` is a [CQ.Ext.form.TextField](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TextField) object

* Overrides the methods `setValue`, `getValue` and `getRawValue` of [CQ.form.CompositeField](/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.CompositeField) in order to set and retrieve the value of CustomWidget with the format:  
...
* Extends ` [CQ.Ext.form.TriggerField](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TriggerField)`.
* Defines a browse window called `browseWindow`.  

* Overrides ` [CQ.Ext.form.TriggerField](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TriggerField)#onTriggerClick` to show the browse window when the arrow is clicked.
* Defines a [CQ.Ext.tree.TreePanel](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.tree.TreePanel) object:

    * It gets its data by calling the servlet registered at `/bin/wcm/siteadmin/tree.json`.
    * Its root is " `apps/extjstraining`".

* Defines a `window` object ( ` [CQ.Ext.Window](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Window)`):
...
* Extends the ` [CQ.form.rte.plugins.Plugin](/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.rte.plugins.Plugin)` object.
* The following methods define the ` [CQ.form.rte.plugins.Plugin](/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.rte.plugins.Plugin)` object and are overridden in the implementing plugin:
...
* If the window displaying the tree does not exist, `treePanel` ([CQ.Ext.tree.TreePanel](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.tree.TreePanel)) is created:
...
* `tree` ( ` [CQ.Ext.Window](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Window)`) is set based on the pre-defined `treePanel`, and is displayed with:  
  `tree.show();`
...
* Is defined by a node (node type = `cq:Dialog`, xtype = ` [panel](../../developing/using/xtypes.md#panel)`).  

* The panel has a sizefield widget (node type = `cq:Widget`, xtype = ` [sizefield](../../developing/using/xtypes.md#sizefield)`) and a selection widget (node type = `cq:Widget`, xtype = ` [selection](../../developing/using/xtypes.md#selection)`, type = `radio`) with 2 options (true/false)  
...
* If `grid` does not exist, a [CQ.Ext.grid.GridPanel](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel) object ( `gridPanel`) is defined by calling the `getGridPanel()` method (see below). This method is defined in `defaultgrid.js`.

* `grid` is a ` [CQ.Ext.Window](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Window)` object, based on the pre-defined GridPanel, and is displayed: `grid.show();`

* If `grid` already exists, it is displayed based on the width, heigth and docked properties retrieved from the repository.

The javascript file ( `defaultgrid.js`) referenced in the component jsp defines the `getGridPanel()` method which is called by the script embedded in the JSP and returns a ` [CQ.Ext.grid.GridPanel](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel)` object, based on static data. The logic is as follows:
...
* `gridPanel` is a ` [CQ.Ext.grid.GridPanel](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel)` object that consumes `store`:
...
The javascript code referenced in the component jsp ( `referencesearch.js`) defines the `getGridPanel()` method called from the component jsp and returns a ` [CQ.Ext.grid.GridPanel](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel)` object, based on data that are dynamically retrieved from the repository. The logic in `referencesearch.js` defines some dynamic data as a base for the GridPanel:

* `reader` is a ` [CQ.Ext.data.JsonReader](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.JsonReader)`object that reads the servlet response in json format for 3 columns.

* `cm` is a ` [CQ.Ext.grid.ColumnModel](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.ColumnModel)` object for 3 columns.  
  The "Test" column cells can be edited as they are defined with an editor:  
  `editor: new [CQ.Ext.form.TextField](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TextField)({})`  

* the columns are sortable:  
  `cm.defaultSortable = true;`

* `store` is a ` [CQ.Ext.data.GroupingStore](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.data.GroupingStore)` object:
...
* `gridPanel` is a ` [CQ.Ext.grid.EditorGridPanel](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.EditorGridPanel)` object that can be edited:

    * it is based on the pre-defined `store` and on the column model `cm`  
    
    * only one row at a time can be selected:  
      `sm: new [CQ.Ext.grid.RowSelectionModel](/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.RowSelectionModel)({singleSelect:true})`  
