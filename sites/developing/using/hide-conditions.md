...
uuid: b82bbe49-548f-426a-a06b-94779bc15c88
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: components
content-type: reference
discoiquuid: e9a0d62e-edc8-44a7-ad1c-cbe5da78dc34
...
The implementation makes use of the Granite [ELResolver API](/developing/using/reference-materials/granite-ui/api/jcr_root/libs/granite/ui/docs/server/el) and adds a `cqDesign` custom variable via the ExpressionCustomizer.
