...
uuid: e9941464-e387-4915-8bfd-043ca5d8115b
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: testing
content-type: reference
discoiquuid: 126b0f3f-6bbd-4ae4-894e-d500e27a0f0c
...
<note type="note"> 
 <p>For information about maximizing response times, see <a href="../../deploying/using/configuring-performance.md">Performance Optimization</a>.</p> 
 <p> </p> 
</note>
...
<note type="note"> 
 <p>For estimating the number of users on an author instance, you can use the <a href="../../developing/using/analyze-request.md">Request Analysis Script</a></p> 
 <p> </p> 
</note>
...
<img imageRotate="0" src="assets/chlimage_1-258.png" />
