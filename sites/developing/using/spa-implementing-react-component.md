...
uuid: 019387d2-6cde-4ff9-a570-c9c825310f15
contentOwner: bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: spa
content-type: reference
discoiquuid: a559763c-b38a-4888-b7c8-ae0e926aa596
index: y
internal: n
snippet: y
---
...
You should be familiar with the [structure of an SPA application for AEM](../../developing/using/spa-getting-started-react.md) before reading this article.
...
For further information about developing SPAs for AEM see the article [Developing SPAs for AEM](../../developing/using/spa-architecture.md).
