...
uuid: cc1aeeaa-65c3-4f0a-aa66-8219838c04a4
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: platform
content-type: reference
discoiquuid: dc6c7599-7728-4cc8-bc69-d3a7a3a811b9
...
* Allow specialized authors to [create and edit templates](../../authoring/using/templates.md).
...
>[!NOTE]
>
>[Static templates](../../developing/using/page-templates-static.md) are also available.

This document:

* Gives an overview of creating editable templates

    * For details see [Creating Page Templates](../../authoring/using/templates.md)
...
This document assumes that you are already familiar with creating and editing templates. See the authoring document [Creating Page Templates](../../authoring/using/templates.md), which details the capabilities of editable templates as exposed to the template author.
...
Creating editable templates is primarily done with the [template console and template editor](../../authoring/using/templates.md) by a template author. This section gives an overview of this process and follows with a description of what occurs at a technical level.
...
1. Select a [template type](#templatetype). This is copied to create the [template definition](#templatedefinitions).
   ...
   >[!NOTE]
   >
   >A selection of template types are provided out-of-the-box. You can also [create your own site-specific template types](../../developing/using/page-templates-editable.md#main-pars-title-42ef) if required.
...
1. Configure the structure, content policies, initial content, and layout of the new template.
   ...
   **Structure**
   ...
   For details on how a template author defines the structure, see [Creating Page Templates](../../authoring/using/templates.md#main-pars-title-1754153843).

   For technical deatils of the structure, see [Structure](../../developing/using/page-templates-editable.md#main-pars-title) in this document.
   ...
   **Policies**
   ...
   For details on how a template author defines policies, see [Creating Page Templates](../../authoring/using/templates.md#main-pars-title-1754153843).

   For technical deatil of policies, see [Content Policies](../../developing/using/page-templates-editable.md#main-pars-title-1229629872) in this document.
   ...
   **Initial Content**
   ...
   For details on how a template author defines the structure, see [Creating Page Templates](../../authoring/using/templates.md#main-pars-title-1266227611).

   For technical details on initial content, see [Initial Content](../../developing/using/page-templates-editable.md#main-pars-title-2033911382) in this document.
   ...
   **Layout**
   ...
   For details on how a template author defines the template layout, see [Creating Page Templates](../../authoring/using/templates.md#main-pars-title).

   For technical details on template layout, see [Layout](../../developing/using/page-templates-editable.md#main-pars-title-514933864) in this document.
...
1. Enable the template, then allow it for specific content trees.
   ...
   For details on how a template author enables a template, see [Creating Page Templates](../../authoring/using/templates.md#main-pars-title-663293913).

   For technical deatils on enabling a template, see [Enabling and Allowing a Template for Us](../../developing/using/page-templates-editable.md#main-pars-title-1542123978)e in this document
...
1. Use it to create content pages.
   ...
   For details on how a page author uses templates to create a page, see [Creating and Organizing Pages](../../authoring/using/managing-pages.md#main-pars-title-1).

   For technical details on creating pages with editable templates, see [Resultant Content Pages](../../developing/using/page-templates-editable.md#main-pars-title-1300723715) in this document.
...
>
>See [Using Client-Side Libraries](../../developing/using/clientlibs.md) for further information.
...
1. In *addition* to the standard authoring permissions and privileges (e.g. `content-authors`) you now need to assign group(s) and define the required access rights (ACLs) for your authors to be able to create templates in the new folder.
   ...
   The `template-authors` group is the default group that needs to be assigned. See the following section [ACLs and Groups](../../developing/using/page-templates-editable.md#main-pars-title-1739798510) for details.

   See [Access Right Management](../../administering/using/user-group-ac-admin.md#accessrightmanagement) for full details on managing and assigning access rights.
...
The template folders for the [We.Retail reference implementation](../../developing/using/we-retail.md) can be used as an example.
...
The [device groups](../../developing/using/mobile.md#main-pars-title-2) used for an editable template (set as relative path of the property `cq:deviceGroups`) define which mobile devices are available as emulators in the [layout mode](../../authoring/using/responsive-layout.md) of page authoring. This value can be set in two places:
...
>[!NOTE]
>
>With [static templates](../../developing/using/page-templates-static.md), the value of `cq:deviceGroups` could be set at the root of the site.
>
...
1. Create a template as you would any editable template [as documented here](../../authoring/using/templates.md#main-pars-title-1665652500), which will serve as the basis of your template type.
1. Using CRXDE Lite, copy the newly-created template from the `templates` node to the `template-types` node under the [template folder](../../developing/using/page-templates-editable.md#main-pars-title-1575837874).
1. Delete the template from the `templates` node under the [template folder](../../developing/using/page-templates-editable.md#main-pars-title-1575837874).
...
Definitions for editable templates are stored [user-defined folders](../../developing/using/page-templates-editable.md#main-pars-title-1575837874) (recommended) or alternatively in `global`. For example:
...
When [editing a template you can define the layout](../../authoring/using/templates.md), this uses [standard responsive layout](../../authoring/using/responsive-layout.md) that can also be [configured](../../administering/using/configuring-responsive-layout.md).
...
1. **Enable the Template**
    ...
    * [Enabling the template](../../authoring/using/templates.md#enablingatemplateauthor) from the **Templates** console.
...
1. **Allowed Templates**
    ...
    * [Define the Allowed Template path(s) on the **Page Properties**](../../authoring/using/templates.md#allowingatemplateauthor) of the appropriate page or root page of a sub-branch.
    * Set the property:  
      `cq:allowedTemplates`  
...
* Model - OSGi bundles  
  The [OSGI bundles](../../deploying/using/osgi-configuration-settings.md) implement the functionality.  

* View - `/apps/<*my-site*>/components`  
  On both the author and publish environments the content is rendered by [components](../../developing/using/components.md).
