...
uuid: 4ba70aea-059e-4f8b-9325-8ba710b3a3a7
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: personalization
content-type: reference
discoiquuid: a23c2764-8d24-497a-8392-c12f497c8a33
...
Returns a session store of a specified name. See also [Accessing a Session Store](../../developing/using/client-context.md#main-pars-title-34).
...
Provides methods for listening for session store activation and registration. See also [Checking That a Session Store is Defined and Initialized](../../developing/using/client-context.md#main-pars-title-6).
...
Registers a listener for an event. See also [Creating a Listener to React to a Session Store Update](../../developing/using/client-context.md#main-pars-title-5).
