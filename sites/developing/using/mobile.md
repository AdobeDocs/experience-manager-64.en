...
uuid: ea783e60-eb9f-45b4-8753-723b9ee8188a
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: mobile-web
content-type: reference
discoiquuid: 44da9787-51ef-43fa-b3ca-d9ac0f5915be
...
Use Multi Site Manager (MSM) to create a mobile live copy from a standard site. The standard site is automatically transformed into a mobile site: the mobile site has all the features of the mobile sites (e.g. edition within an emulator) and can be managed in sync with the standard site. Refer to the section [Creating a Live Copy for different Channels](../../administering/using/msm.md) in the Multi Site Manager page.

#### Server-Side Mobile API {#server-side-mobile-api}

The Java packages containing the mobile classes are:

* [com.day.cq.wcm.mobile.api](/developing/using/reference-materials/javadoc/com/day/cq/wcm/mobile/api/device/capability/package-summary) - defines MobileConstants.  

* [com.day.cq.wcm.mobile.api.device](/developing/using/reference-materials/javadoc/com/day/cq/wcm/mobile/api/device/package-summary) - defines Device, DeviceGroup and DeviceGroupList.  

* [com.day.cq.wcm.mobile.api.device.capability](/developing/using/reference-materials/javadoc/com/day/cq/wcm/mobile/api/device/capability/package-summary) - defines DeviceCapability.  

* [com.day.cq.wcm.mobile.api.wurfl](/developing/using/reference-materials/javadoc/com/day/cq/wcm/workflow/api/package-summary) - defines WurflQueryEngine.  

* [com.day.cq.wcm.mobile.core](/developing/using/reference-materials/javadoc/com/day/cq/wcm/mobile/core/package-summary) - defines MobileUtil, which provides various utility methods revolving around WCM Mobile.
...
Mobile devices emulators are based on the generic emulator framework. For more details please refer to the [Emulators](../../developing/using/emulators.md) page.
...
To create an emulator, please refer to the [Creating a Custom Mobile Emulator](../../developing/using/emulators.md) section in the generic Emulators page.
...
For more information, see [Creating Device Group Filters](../../developing/using/groupfilters.md).
...
For information, go to [Creating Device Group Filters](../../developing/using/groupfilters.md).
...
>[!NOTE]
>
>For more information about Client Library integration, please read the [Using Client-Side HTML Libraries](../../developing/using/clientlibs.md) section.
