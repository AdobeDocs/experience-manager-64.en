...
uuid: cec08195-8f3b-4f40-85a8-82bdae0750c4
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: components
content-type: reference
discoiquuid: 6f57d594-6675-472f-9573-72672139cb5f
disttype: dist5
gnavtheme: light
...
1.
   ...
   On each of these nodes ( `cq:ChildEditorConfig`) define the properties:
...
>[!NOTE]
>
>For further details see [Configuring the Rich Text Editor](../../administering/using/rich-text-editor.md).
...
For general information about adding an in-place editor see the document [Customizing Page Authoring](../../developing/using/customizing-page-authoring-touch.md#main-pars-title-3).
