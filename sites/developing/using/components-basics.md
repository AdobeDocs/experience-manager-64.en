...
uuid: 88ec01f3-4ae9-4ed5-a270-ba2ce56af350
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: components
content-type: reference
discoiquuid: fdfb6276-f2ac-4316-8c2f-cea91871e1cc
disttype: dist5
gnavtheme: light
...
* Do you need to create your component from scratch, or can you [inherit the basics from an existing component](#extendingexistingcomponentsanddialogs)?
    ...
    * There are several mechanisms provided by AEM to allow you to inherit and extend details from another component definition including override, overlay and the [Sling Resource Merger](../../developing/using/sling-resource-merger.md).
...
* What security aspects should I take into consideration?
    ...
    * See [Security Checklist - Development Best Practices](../../administering/using/security-checklist.md#developmentbestpractices) for further details.
...
* **Touch-Enabled UI** 
  [The standard user interface](../../developing/using/touch-ui-concepts.md) that was introduced in AEM 5.6.0 as a preview and extended in 6.x. It is based on the unified user experience for the Adobe Marketing Cloud, using the underlying technologies of [Coral UI](../../developing/using/touch-ui-concepts.md#coralui) and [Granite UI](../../developing/using/touch-ui-concepts.md#graniteui).  

* **Classic UI** 
  User interface based on ExtJS technology that was introduced with CQ 5.1.

See [UI Interface Recommendations for Customers](../../deploying/using/ui-recommendations.md) for more details.
...
The discussion of whether to use [HTL](/content/help/en/experience-manager/htl/user-guide) or JSP (Java Server Pages) when developing your own components should be straightforward as HTL is now the recommended scripting language for AEM.
...
* [AEM Components for the Touch-Enabled UI](../../developing/using/developing-components.md)
* [AEM Components for the Classic UI](../../developing/using/developing-components-classic.md)
...
* [Developing Components](../../developing/using/developing-components-samples.md) (focused on the touch-enabled UI)
...
* [Use Package Manager](../../administering/using/package-manager.md) to add your components to a package and move them to another AEM instance.
* [Use the Activate Tree replication tool](../../authoring/using/publishing-pages.md#howtoactivateacompletesectiontreeofyourwebsite) to replicate the components.
...
* Paragraph system(s):
    ...
    * There are various paragraph systems available within a standard instance (e.g. `parsys`, ` [responsivegrid](../../authoring/using/responsive-layout.md)`).
...
* **Vital Properties**:
    ...
    * Touch UI
        ...
        * See the section [Component Icon in Touch UI](../../developing/using/components-basics.md#main-pars-title-4779) for details.
...
1. `cq:icon` - String property pointing to a standard icon in the [Coral UI library](/developing/using/reference-materials/coral-ui/coralui3/Coral.Icon) to display in the component browser
...
The [Component Console](../../authoring/using/default-components-console.md#main-pars-title-1913426132) displays how the icon for a particular component is defined.
...
>* The [Dialog Conversion Tool](../../developing/using/dialog-conversion.md) is also provided to help you extend/convert components that only have dialogs defined for the classic UI.
>
...
[Design dialogs are available in Design Mode](../../authoring/using/default-components-designmode.md), though they are not needed for all components e.g. **Title** and **Image** both have design dialogs, whereas **Text** does not.
...
1. Open [Design Mode](../../authoring/using/default-components-designmode.md) for a page and enable the required component.
...
>[!NOTE]
>
>See [Add New Action to a Component Toolbar](../../developing/using/customizing-page-authoring-touch.md#addnewactiontoacomponenttoolbar) as an example for the touch-enabled UI.
