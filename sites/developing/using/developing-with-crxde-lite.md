...
uuid: ba0e26de-16d5-4a34-a544-07b1bfa0ab6a
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: development-tools
content-type: reference
discoiquuid: f98335ac-1185-4e71-a8c4-5f911494b799
...
>[!NOTE]
>
>By default, all AEM users can access CRXDE Lite. If desired, [configure ACLs](../../administering/using/security.md#permissionsandacls) for the following node so that only developers can access CRX DE Lite:
>
>`/libs/granite/crxde`

>[!NOTE]
>
>It is recommended to use the [AEM Developer Tools for Eclipse](../../developing/using/aem-eclipse.md) and the [AEM HTL Brackets Extension](../../developing/using/aem-brackets.md) during project development.
...
![](assets/chlimage_1-193.png)  ![](assets/chlimage_1-194.png) 
...
You can also use the Dialog Editor to edit a dialog. Double clicking the dialog node in CRXDE Lite will bring up the editor. More information about the Dialog Editor can be found [here](../../developing/using/dialog-editor.md).
...
>[!NOTE]
>
>See [Users, Groups and Access Rights Administration](../../administering/using/user-group-ac-admin.md) for more information.
