...
uuid: 51b4b111-7b68-49f4-867d-7767fab18172
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: 2ba89be9-c81a-46ba-b58f-eec9e77d6727
...
To optimize high ingestion loads you can define a [workflow as transient](/developing/using/workflows#TransientWorkflows).
...
For performance tuning guidelines for DAM workflows, see the [AEM Assets Performance Tuning Guide](/content/help/en/experience-manager/6-4/assets/using/performance-tuning-guidelines).
...
* Configure the ** [OSGi Configuration](../../deploying/using/configuring-osgi.md)** from the AEM Web console; for **Queue: Granite Workflow Queue** (an **Apache Sling Job Queue Configuration**).
...
For further details on maintenance tasks in AEM, see the [Operations Dashboard](../../administering/using/operations-dashboard.md).
...
>[!NOTE]
>
>See also [Repository Restructuring in AEM 6.4](../../deploying/using/repository-restructuring-in-aem64.md).
...
There is one listener that is responsible for all of the [workflow launchers](../../administering/using/workflows-starting.md#workflowslaunchers) that are registered:
...
The custom [launcher configuration](../../administering/using/workflows-starting.md#workflowslaunchers) has been enhanced to support the following:
...
You can define [workflow stages](/developing/using/workflows#WorkflowStages), then assign tasks/steps to a specific workflow stage.

This information is used for displaying the progress of a workflow when you click on the [**Workflow Info** tab of a workitem from the **Inbox**](../../authoring/using/workflows-participating.md#openingaworkflowitemtoviewdetailsandtakeactions). Existing workflow models can be edited to add stages.
...
* [Developing and Extending Workflows](/developing/using/workflows)
