...
uuid: 6a74ffd7-fb56-4328-96ca-81a0cb0d1e5c
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: platform
discoiquuid: 113e1b9a-a833-4ccb-90f3-ad10c0c7cd4c
...
The entry point for the search API is the `CommerceService#search` method which returns a `CommerceResult` object. See the [API Documentation](../../developing/using/ecommerce.md#apidocumentation) for more information on this topic.
