...
uuid: 9d9dbee1-6575-4cb9-8576-12aa1299e745
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: components
discoiquuid: 581410bd-613a-4c90-af0a-d33ae5da8b39
...
1. Fill the fields as required and click OK. ![](assets/chlimage_1-165.png)

1. You can now click **OK **or see the Target Dictionary.

   >[!NOTE]
   >
   >For more information about translation projects, read [Managing Translation Projects](../../administering/using/tc-manage.md).
...
Note that [the code that requests the translated string](../../developing/using/i18n-dev.md#main-pars-title-13) provides values for the indexed variables according to the context.
...
After you add the English string to a dictionary, you can add translations of the string. You can also [export the dictionary](../../developing/using/i18n-translator.md#main-pars-title-8) to have it translated by a third party.
...
>[!NOTE]
>
>When using Dispatcher, you need to [invalidate cached pages](/content/help/en/experience-manager/dispatcher/using/page-invalidate) to include new dicationary strings in rendered component strings.
