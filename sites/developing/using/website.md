...
uuid: 359d5c0d-82cd-45f3-853a-ca913c566318
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: introduction
content-type: reference
discoiquuid: bb91439c-1951-4a57-ad76-699b7f21f8b2
disttype: dist5
gnavtheme: light
...
>[!NOTE]
>
>This article describes how to create a website using JSP and based on the classic UI. Adobe recommends leveraging the latest AEM technologies for your websites as described in detail in the article [Getting Started Developing AEM Sites](../../developing/using/getting-started.md).
...
To follow along with the tutorial rather than performing the exercises, download website-1.0.zip. This file is an AEM content package that contains the results of this tutorial. Use [Package Manager](../../administering/using/package-manager.md) to install the package to your author instance.
...
[Sample static.css file and images](assets/mywebsite.zip)
...
1. [Using WebDAV](../../administering/using/webdav-access.md) access to the URL at http://localhost:4502, copy the sample `static.css` file and `images` folder from the downloaded mywebsite.zip file into the `/etc/designs/mywebsite` folder. 
...
1. In the** Create Page** window, enter the following:
   ...
   Last Modified Date: 2017-12-06T06:28:41.457-0500
   <p>Add image for template.<br /> </p>
   -->
...
Comment Type: remark
Last Modified By: Alva Ware-Bevacqui (alvawb)
Last Modified Date: 2017-12-06T06:28:45.320-0500
<p>Add some HTMl comment inside the jsp file to explain why we have div.<br /> </p>
-->
...
This exercise demonstrates [Sling request processing](../../developing/using/the-basics.md#main-pars-title-10). The topnav.jsp script is modified to call a script that dynamically generates images to use for the page navigation links. In this exercise, Sling parses the URL of image source files to determine the script to use to render the images.
...
1. Copy the following code into `navimage.png.java.`The code extends the AbstractImageServlet class:
    ...
    * [AbstractImageServlet](/developing/using/reference-materials/javadoc/com/day/cq/wcm/commons/AbstractImageServlet) creates an ImageContext object that stores the properties of the current resource.
    * The parent page of the resource is extracted from the ImageContext object. The page title and subtitle are then obtained. 
    * [ImageHelper](/developing/using/reference-materials/javadoc/com/day/cq/commons/ImageHelper) is used to generate the image from the navimage_bg.jpg file of the site design, the page title, and the page subtitle.
