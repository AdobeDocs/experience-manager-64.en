...
uuid: 65cae837-5191-4aba-ae97-0d2fba71f741
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: components
content-type: reference
discoiquuid: dac101fb-84f3-48a2-981c-f85257a045ff
...
>
>See the document [JSON Exporter for Content Services](../../developing/using/json-exporter.md).
...
>[!NOTE]
>
>Similar to PageInfoProviders, use ListInfoProviders to update lists of information in JSON format. (See [Customizing the Websites Administration Console](../../developing/using/customizing-siteadmin.md).)
...
The following Java class implements [PageInfoProvider](/developing/using/reference-materials/javadoc/index) and returns the published URL of the current page resource.
