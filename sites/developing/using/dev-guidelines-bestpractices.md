...
uuid: ad776773-b28e-4ff4-ab70-ada304db1701
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: introduction
content-type: reference
discoiquuid: e8549637-84c2-4d3a-8038-9aef7595042a
disttype: dist5
gnavtheme: light
...
* [Customizing a Component](../../developing/using/components.md)  
...
* [Customizing pages shown by the Error Handler](../../developing/using/customizing-errorhandler-pages.md#howtocustomizepagesshownbytheerrorhandler)  
...
>[!NOTE]
>
>If you use the [Query Builder](../../developing/using/querybuilder-api.md), you use JCR Queries, as the Query Builder generates JCR Queries under the hood.
>
...
>[!NOTE]
>
>It is also worthwhile referencing the [security checklist](../../administering/using/security-checklist.md).
...
[The XSSAPI cheat sheet.](assets/xss_cheat_sheet_2016.pdf)
...
See [Customizing Error Pages shown by the Error Handler](../../developing/using/customizing-errorhandler-pages.md) for full details.

### Open Files in the Java Process {#open-files-in-the-java-process}

Because AEM can access a large number of files it is recommended that the number of [open files for a Java process](../../deploying/using/configuring.md#openfilesinthejavaprocess) be explicitly configured for AEM.
