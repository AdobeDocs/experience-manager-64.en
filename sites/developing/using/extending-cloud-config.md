...
uuid: e4856bfc-bf06-42c2-9166-74dcbfaf5893
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: eb71b06b-12b5-440d-bf8c-5fb001c71ce1
...
* Easily extensible.
* Has the flexibility to cater for more complex configurations, such as [SiteCatalyst](../../administering/using/marketing-cloud.md#integratingwithsitecatalyst).
* Support for dependencies (e.g. [SiteCatalyst](../../administering/using/marketing-cloud.md#integratingwithsitecatalyst) plugins need a [SiteCatalyst](../../administering/using/marketing-cloud.md#integratingwithsitecatalyst) configuration).
...
For reference documentation on the API see [com.day.cq.wcm.webservicesupport](/developing/using/reference-materials/javadoc/com/day/cq/wcm/webservicesupport/package-summary).
...
* [Tracker Snippets](../../administering/using/external-providers.md) (Google, WebTrends etc.)
* [SiteCatalyst](../../administering/using/marketing-cloud.md#integratingwithsitecatalyst)
* [Test&Target](../../administering/using/marketing-cloud.md#integratingwithtesttarget)
* [Search&Promote](../../administering/using/marketing-cloud.md#integratingwithsearchpromote)
* [Scene7](../../administering/using/marketing-cloud.md#integratingwithscene7)

>[!NOTE]
>
>See also [Creating a Custom Cloud Service](../../developing/using/extending-cloud-config-custom-cloud.md).
