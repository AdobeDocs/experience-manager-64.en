...
uuid: cbc86069-9c08-484a-bf23-52c9f5c3b06c
contentOwner: bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: spa
content-type: reference
discoiquuid: dee385ba-d67d-42f2-8b70-d1301996257e
index: y
internal: n
snippet: y
---
...
For a detailed description, please refer to the [PageModelManager](../../developing/using/spa-blueprint.md#main-pars-header-249430796) section of the SPA Blueprint document.
...
The `ModelRouter` automates the fetching of fragments of the model. But as any automated tooling it comes with limitations. When needed the `ModelRouter` can be disabled or configured to ignore paths using meta properties (See the Meta Properties section of the [SPA Page Component](../../developing/using/spa-page-component.md) document). Front end developers can then implement their own model routing layer by requesting the `PageModelManager` to load any given fragment of model using the `getData()` function.
