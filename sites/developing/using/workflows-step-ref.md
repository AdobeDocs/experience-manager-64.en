...
uuid: 77c2afbc-2164-4621-ac95-08295d9ab255
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: 06dc83be-a614-4948-bb2f-2fd760566196
...
>
>* [AEM Forms Workflow Step Reference](/content/help/en/experience-manager/6-4/forms/using/aem-forms-workflow-step-reference)
>* [Processing Assets Using Media Handlers and Workflows](/content/help/en/experience-manager/6-4/assets/using/media-handlers)
>
...
* **Workflow Stage  
  **A drop down selector to apply a [Stage](/developing/using/workflows#WorkflowStages) to the step.  
...
* **User/Group**
    ...
    * See [Participating in Workflows](../../authoring/using/workflows-participating.md) for more information.
...
* Edit the **OR Split Properties**:
  ...
  >[!NOTE]
  >
  >See [Defining a Rule for an OR Split](/developing/using/workflows-models#DefiningaRuleforanORSplit).
...
>[!NOTE]
>
>Some properties need to be configured to enable email notifications. You can also customize the email template or add an email template for a new language. See [Configuring Email Notification](../../administering/using/notification.md#configuringemailnotification) to configure email notifications in AEM.
...
1. **Dialog Structure**
   ...
   >[!NOTE]
   >
   >For further information see [Creating and Configuring a Dialog](../../developing/using/developing-components.md#creatingandconfiguringadialog).
...
1. **Example Dialog Definition**
   ...
   The following XML code snippet represents a dialog that stores a `String` value in the `watchEmail` node of the payload content. The title node represents the [TextField](/developing/using/reference-materials/granite-ui/api/jcr_root/libs/granite/ui/components/coral/foundation/form/textfield/index) component:
...
* **OSGi service**
  ...
  Services must implement the [com.day.cq.workflow.exec.ParticipantStepChooser](/developing/using/reference-materials/javadoc/com/day/cq/workflow/exec/ParticipantStepChooser) interface. The interface defines the following members:
...
>[!CAUTION]
>
>This section deals with the [Forms section of Foundation Components for Page Authoring](../../authoring/using/default-components-foundation.md#form).
...
<note type="note"> 
 <p>The <a href="/developing/using/workflows-models#CollectingDataUsingFormsandWorkflows">Collecting data using forms and workflows</a> tutorial walks you through the creation of a workflow that uses the <strong>Form Participant Step</strong> and the related forms.</p> 
</note>
...
<note type="note"> 
 <p>For information about creating forms, see <a href="../../developing/using/developing-forms.md">Developing Forms</a>. For information about available form components, see the <a href="../../authoring/using/default-components-foundation.md#form">Forms section of Components for Page Authoring</a>.</p> 
</note>
...
* **Process**
    ...
    * **Process**: The process implementation to execute. Use the drop-down menu to select the ECMAScript or OSGi service. For information about:
        ...
        * The standard ECMAScripts and OSGi services, see [Built-In Processes for Process Steps](../../developing/using/workflows-process-ref.md).
        * Creating ECMAScripts for a Process step, see [Implementing a Process Step with an ECMAScript](/developing/using/workflows-customizing-extending#UsingECMAScript).
        * Creating OSGi services for a Process step, see [Implementing a Process Step with a Java Class](/developing/using/workflows-customizing-extending#ImplementingaProcessStepwithaJavaClass).
