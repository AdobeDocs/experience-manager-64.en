...
uuid: 6f91a251-9714-4a9d-b174-a1bc1e964bb2
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: 9c3b1b40-e92a-4f65-be64-44204a28e864
disttype: dist5
gnavtheme: light
...
AEM provides various mechanisms to enable you to customize the consoles (and the [page authoring functionality](../../developing/using/customizing-page-authoring-touch.md)) of your authoring instance.
...
>* [Granite](/developing/using/reference-materials/granite-ui/api/index) 
>
...
`aem-admin-extension-new-console` is a sample package showing how to [create a new AEM 6 console](#createacustomconsole). This package provides a UI for managing [Launches](../../authoring/using/launches.md) and adds a link in the navigation:
...
<img imageRotate="0" src="assets/chlimage_1-194.png" />
 ...
 -->
    ...
    * this can contain (according to requirements):
        ...
        * the corresponding [clientlibs](../../developing/using/clientlibs.md) for custom actions and `less`/ `css` definitions
...
<img imageRotate="0" src="assets/chlimage_1-197.png" />
...
1. Open the [user and/or group management](../../administering/using/security.md) and select the user/group you want to restrict access for.

   >[!NOTE]
   >
   >Avoid assigning/restricting permissions on a user-by-user basis. It is [recommended to use groups](../../administering/using/security.md#bestpractices).

1. Remove access [permissions](../../administering/using/security.md#permissions) to the appropriate node(s) under `/libs/cq/core/content/nav/sites`. These correlate to the navigation options in the rail:
...
1. Overlay the list of available columns.
   ...
   See [Using Overlays (and the Sling Resource Merger)](../../developing/using/overlays.md) for more information.

1. Optionally:

    * If you want to plug additional data, you need to write a ` [PageInforProvider](/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/PageInfoProvider)` with a   
...
In order to keep the list to a reasonable size and also relevant to the use case, a filter can be implemented in the form of a custom predicate. See [this article](../../developing/using/customizing-page-authoring-touch.md#main-pars-title-936239831) for details.
