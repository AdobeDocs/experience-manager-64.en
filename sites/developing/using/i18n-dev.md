...
uuid: 16e9c612-da88-4052-b264-838b0108d437
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: components
discoiquuid: a5035490-fe89-428e-875e-4e7dfbcd5ca1
...
For an overview of the internationalization and localization process, see [Internationalizing Components](../../developing/using/i18n.md).  
...
The Javascript API enables you to localize strings on the client. As with [Java and JSP](../../developing/using/i18n.md#main-pars-title-0) code, the Javascript API enables you to identify strings to localize, priovide localization hints, and include variables in the localized strings.

The `granite.utils` [client library folder](../../developing/using/clientlibs.md) provides the Javascript API. To use the API, include this client library folder on your page. Localization functions use the `Granite.I18n` namespace.
...
Similar to [translation hints in the Java API](../../developing/using/i18n.md#main-pars-title-12), you can provide translation hints to distinguish duplicate strings in the dictionary. Provide the translation hint as a property of the node that contains the internationalized property. The name of the hint property is comprised of the name of the internationalized property name with the `_commentI18n` suffix:
