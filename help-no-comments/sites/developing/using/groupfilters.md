...
uuid: c678b17a-1708-4ce6-acfa-b2d476cfa52e
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: mobile-web
content-type: reference
discoiquuid: e3dbd293-8f6a-4eb4-a766-c2c85360c790
...
>[!NOTE]
>
>Ensure the WURFL™ database that is deployed to AEM includes the capabilities that you use as filter criteria. (See [Device Detection](../../../sites/developing/using/mobile.md#main-pars-title-3).)
