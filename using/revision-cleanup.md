...
uuid: 5e7c5564-6347-4fe7-99a1-8335c9f3c38b
...
discoiquuid: 8efb58f2-9238-42b3-b2cb-08257423c157
...
sha1: e537eef95c89126b1f68479e4b8baf1e5a614cf1
...
>[!CAUTION]
>
><p>Using the <span class="code">--force</span> parameter will upgrade the segment store to the latest version, which is incompatible with older Oak versions. Also, take into consideration that no downgrade is possible. As a general rule, you should use these parameters with caution and only if you are knowledgeble about how to use them.</p>
