...
uuid: f3c43e1e-4c26-4b15-969d-476ca8a56c0e
...
discoiquuid: e9c424d5-c49b-416f-8ed5-dfefd992481a
...
sha1: e153de70de187adc6d4dbf4efdd0ba5bba7819ca
...
1. Oak-run index command  a new indexing toolset for AEM 6.4.
...
Going forward we can build up on reindexing flow implemented via `oak-run` to support following features:

1. Interrupt Resilience - It should be possible for reindexing to resume from some last state instead of starting again in case of network failure

1. Faster Reindexing - We need to explore ways to perform reindexing in faster mode. One such approach is being explored in OAK-6353

1. For SegmentNodeStore setups implement OAK-5553 such that reindexing can be done on same server with minimum hassel and some lesser impact
