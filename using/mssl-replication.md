...
uuid: 7e34048b-8fb9-4b7b-aa93-4c356dc5f87e
...
discoiquuid: d38f9997-56bc-49b8-abc1-35b7ed19e4b9
...
sha1: dc56d49c290879e1d717c41db4c75aa67591b744
...
![](assets/mssl-replication/chlimage_1.png)
...
1. In the Account Settings area, click Manage Keystore.
   ...
   ![](assets/mssl-replication/chlimage_1-1.png)

1. Click Add Private Key From Key Store File.

   ![](assets/mssl-replication/chlimage_1-2.png)
...
1. Close the KeyStore Management dialog box.
   ...
   ![](assets/mssl-replication/chlimage_1-3.png)
...
1. Click Add Certificate From CER File.
   ...
   ![](assets/mssl-replication/chlimage_1-4.png)
...
1. Close the TrustStore Management dialog box.
   ...
   ![](assets/mssl-replication/chlimage_1-5.png)
...
![](assets/mssl-replication/chlimage_1-6.png)
