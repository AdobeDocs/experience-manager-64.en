...
uuid: 1b08212e-d076-4117-b3e8-35d84337fcba
...
discoiquuid: 2e9e2d75-237b-4d00-85a9-373b0b719660
disttype: dist5
...
sha1: 735a34e86286d6769274bd47aceaf21100288917
...
>[!NOTE]
>
><p>For AEM 6.1, ensure that&nbsp;<a href="/content/help/en/experience-manager/release-notes--aem-6-1-cumulative-fix-pack-.html">AEM 6.1 CFP 11</a>&nbsp;is installed.</p>
...
## Identifying and remediating a stuck re-indexing process
...
1. In order to identify the cause of stuck indexing the following information must be collected:
    ...
    * Collect data from the async `IndexStats` MBean:
        ...
        * Navigate to AEM OSGi Web Console&gt;Main&gt;JMX&gt;IndexStat&gt;async or go to [http://localhost:4502/system/console/jmx/org.apache.jackrabbit.oak%3Aname%3Dasync%2Ctype%3DIndexStats](http://localhost:4502/system/console/jmx/org.apache.jackrabbit.oak%3Aname%3Dasync%2Ctype%3DIndexStats)
