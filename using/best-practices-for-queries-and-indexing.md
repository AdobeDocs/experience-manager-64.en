...
uuid: bace0e76-616c-42c0-a7e0-b8b0638ff713
...
discoiquuid: f4191a8d-e835-46f8-8c65-e87379bd77f2
...
sha1: 20320ba90a6a8a1cf9b8a8ee9c6ed7959710efbd
...
>[!NOTE]
>
>When using QueryBuilder, it will determine the result count by default, which is slower in Oak as compared to previous versions of Jackrabbit. To compensate for this, you can use the [guessTotal parameter](/content/help/en/experience-manager/6-4/sites/developing/using/querybuilder-api#main-pars_title_2032974994).
...
>* the query resolves to the expected index (using [Explain Query](/content/help/en/experience-manager/6-4/sites/administering/using/operations-dashboard#Diagnosistools))
...
>[!NOTE]
>
>In AEM 6.4, [oak-run.jar is the ONLY supported method](indexing-via-the-oak-run-jar.md#ReindexingApproachDecisionTree) for re-indexing on MongoMK or RDBMK repositories.
...
![Text pre-extraction process flow](assets/best-practices-for-queries-and-indexing/chlimage_1.png)
