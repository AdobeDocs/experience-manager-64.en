...
uuid: 6fa8adc7-0de1-467e-bdd7-b2942921442f
...
discoiquuid: 7ba7d6b5-42ee-4ad8-b0ef-c119b0778fd9
...
sha1: ba25b0a2c9b0ab983d31dd146b4a3f61b9567f63
...
| `DataStoreGarbageCollectionTask` |crx2 |Will run mark and sweep. For shared datastores, remove this step and run manually or properly prepare instances before executing. |
...
>[!NOTE]
>
><p>The MBean methods can be invoked via:</p> <ul> <li> The JMX Console<br /> </li> <li>Any external application that connects to JMX<br /> </li> <li>cURL</li> </ul>
...
>[!NOTE]
>
><p>For more information, see <a href="https://jackrabbit.apache.org/oak/docs/security/authentication/externalloginmodule.html">Authentication with the External Login Module</a>.</p> <p>For an example of <span class="code">LoginModule</span> configuration in AEM 6, see <a href="/content/help/en/experience-manager/6-4/sites/administering/using/ldap-config.html">Configuring LDAP with AEM 6</a>.</p>
...
>[!NOTE]
>
><p>Only remove packages from the crx-quickstart/install directory AFTER shutting down the AEM instance. This will be one of the last steps before starting the in-place upgrade procedure.</p>
...
>[!NOTE]
>
><p>This step is only necessary for TarMK installations</p>
...
>[!NOTE]
>
><p>This step is only necessary for instances running crx3</p>
