...
* Repository Restructuring: Significant restructuring (primarily /etc) to facilitate easier upgrades and promote implementation best practices. [Read more.](/help/sites/deploying/using/repository-restructuring-in-aem64.md)
* Please see the [Upgrade documentation](/help/sites/deploying/using/upgrade.md) for more details on these features.
