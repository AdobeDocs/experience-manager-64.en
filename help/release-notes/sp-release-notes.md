...
*   \[Dynamic Media\] Updated DM viewers to 5.10.1 release which enables check for duplicate names on Image Preset page. Refer to [Update Dynamic Media Viewers (5.10.1)](/help/release-notes/sp-release-notes.md#update-dynamic-media-viewers). NPR-24403: Hotfix for CQ-4247554
...
*   \[DMHybrid\] Color profiles and catalog settings are not registering in a debug\_info=catalog call. Hotfix for CQ-4242346
...
*   \[DMS7\] Remove the MIME Type mapping: image\_x-eps. Hotfix for CQ-4240394
...
*   \[Page Authoring\] Image Editor enhancements. For more information, see [Image Editor](/help/sites-developing/image-editor.md). NPR-24267: Hotfix for CQ-4245502
