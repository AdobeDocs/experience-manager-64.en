...
>[!NOTE]
>
>For information about creating a web-based application that renders forms based on fragments, see [Creating Web Applications that Renders Forms](/help/forms/developing/rendering-forms-rendering-forms creating-web-applications-renders-forms.md#creating_web_applications_that_renders_forms).
...
[Render forms based on fragments using the Java API](/help/forms/developing/rendering-forms-rendering-forms rendering-forms-based-fragments-rendering rendering-forms-based-fragments-rendering.md#render_forms_based_on_fragments_using_the_java_api)

[Render forms based on fragments using the web service API](/help/forms/developing/rendering-forms-rendering-forms rendering-forms-based-fragments-rendering rendering-forms-based-fragments-rendering.md#render_forms_based_on_fragments_using_the_web_service_api)
...
[Rendering Forms Based on Fragments](/help/forms/developing/rendering-forms-rendering-forms rendering-forms-based-fragments-rendering.md#rendering_forms_based_on_fragments)
