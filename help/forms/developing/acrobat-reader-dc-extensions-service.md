...
uuid: 848feb62-9b45-442c-9df7-e68793474dcc
contentOwner: admin
content-type: reference
topic-tags: develop
discoiquuid: 8af1ae41-5c72-481e-8e4f-0096bf1d6ea1
unpublishexternaldate: 2017-11-01T04 29 29.632-0400
index: y
internal: n
snippet: y
---
...
[Removing Usage Rights from PDF Documents](/programming-with-aem-forms/assigning-usage-rights#removing_usage_rights_from_pdf_documents)
...
The following Java code example removes usage rights from a rights-enabled PDF document named *LoanUsageRights.pdf*. (See [Removing Usage Rights from PDF Documents](/programming-with-aem-forms/assigning-usage-rights#removing_usage_rights_from_pdf_documents).)
...
The following Java code example retrieves information about the credential that is used to apply usage-rights to a rights-enabled PDF document named *LoanUsageRights.pdf*. (See [Retrieving Credential Information](/programming-with-aem-forms/assigning-usage-rights#retrieving_credential_information).)
