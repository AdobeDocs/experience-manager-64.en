...
The following Java code example unlocks a password-encrypted PDF document named *EncryptLoan.pdf*. (See [Unlocking Encrypted PDF Documents](/help/forms/developing/encrypting-decrypting-pdf-documents.md#unlocking_encrypted_pdf_documents).)
...
The following Java code example determines the type of encryption that is protecting a PDF document named *EncryptLoan.pdf*. (See [Determining Encryption Type](/help/forms/developing/encrypting-decrypting-pdf-documents.md#determining_encryption_type).)
