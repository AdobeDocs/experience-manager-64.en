...
uuid: aca43078-49a9-4ae7-92aa-384721b4cbdd
acrolinxdate: 2017-02-21T07 51 53.136-0500
acrolinxlastcheckedby: khsingh
acrolinxpagestatus: green
acrolinxreporturl: http //acrolinx.corp.adobe.com 8031/output/en/working_with_adobe_sign_krs_workflow_6accf30e2250b8db_747_report.xml
acrolinxsentences: 161
acrolinxwords: 2194
contentOwner: khsingh
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: develop
discoiquuid: aec0609e-2bca-4903-9704-b1c224c2f33b
...
[Create an adaptive form for Adobe Sign](../../forms/using/working-with-adobe-sign.md#main-pars-header-129868725) describes the steps to create a basic adaptive form. See [Creating an adaptive form](../../forms/using/creating-adaptive-form.md) for other options available while creating a adaptive form.
...
1. Select the **Adobe Sign Block** component and tap the **Edit ** ![](assets/AEM_6_3_Edit.png)

   icon. It displays options to add fields and format appearance of a field. 

   ![](assets/Adobe-Sign-Block-Select-Fields.png)

1. Tap the **Adobe Sign Field** ![](assets/AEM_6_3_AdobeSign.png)

   icon. It displays options to select and add Adobe Sign fields.

   Expand the **Type** drop-down field to select a Adobe Sign field and tap the Done  ![](assets/AEM_6_3_Forms_save.PNG){width="18"} icon to add the selected field to Adobe Sign block. The **Type** drop-down field includes Signature, Signer info, and Data field types. Adobe Sign integration with AEM Forms support fields listed in the Type drop-down box only. For detailed information about Adobe Sign fields, see [Adobe Sign documentation](/content/help/en/sign/help/field-types).
...
1. In the Content browser, tap **Form Container**, and tap the **Configure** ![](assets/Configure.png){width="18"}

   icon. It opens properties browser and displays Adaptive Form container properties.
...
1. [Add Signers to an adaptive form](../../forms/using/working-with-adobe-sign.md#main-pars-header-1374317451) and tap the Done  ![](assets/AEM_6_3_Forms_save.PNG){width="18"}
...
1. In the Content browser, tap **Form Container**, and tap the **Configure ** ![](assets/Configure.png){width="18"}
   ...
   icon. It opens properties browser with Adaptive Form container properties.
1. In the properties browser, expand the **Electronic Signature **accordion, and select the **Enable Adobe Sign** option. It enables Adobe Sign for an adaptive form.
...
1. ![](assets/phone-details.png)
   ...
   Click the **Edit ** ![](assets/AEM_6_3_Edit.png)

   icon to specify the following information about the signer:
   ...
   icon. The signer is added and configured.
...
1. Select the newly added Signature step component and tap the **Configure ** ![](assets/Configure.png){width="18"}
