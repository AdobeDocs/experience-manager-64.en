...
uuid: e04a1cb5-2928-4eb4-b046-2dc1a2683c36
contentOwner: khsingh
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: develop
discoiquuid: 2be18cc0-970a-4b4b-855a-b762b705782d
noindex: true
index: y
internal: n
snippet: y
...
1. In the Content browser, tap **Form Container**, and tap the **Configure** ![](assets/Configure.png){width="18"} icon. It opens properties browser and displays Adaptive Form container properties.
...
1. [Add Signers to an adaptive form](../../forms/using/working-with-adobe-sign.md#main-pars-header-1374317451) and tap the Done ![](assets/AEM_6_3_Forms_save.PNG){width="18"} icon to save the changes.
...
1. In the Content browser, tap **Form Container**, and tap the **Configure ** ![](assets/Configure.png){width="18"} icon. It opens properties browser with Adaptive Form container properties.
1. In the properties browser, expand the **Electronic Signature **accordion, and select the **Enable Adobe Sign** option. It enables Adobe Sign for an adaptive form.
...
1. ![](assets/phone-details.png)
   ...
   Tap the Done ![](assets/AEM_6_3_Forms_save.PNG){width="18"} icon. The signer is added and configured.
...
1. Select the newly added Signature step component and tap the **Configure ** ![](assets/Configure.png){width="18"} icon. It opens properties browser and displays Signature step properties. Configure the following properties:
   ...
   Tap the Done ![](assets/AEM_6_3_Forms_save.PNG){width="18"} icon to save the changes.
