...
uuid: 5af51131-70ac-455f-b71e-f88fc13fa968
topic-tags: grdp
products: SG_EXPERIENCEMANAGER/6.4/FORMS
discoiquuid: 05c336ca-9387-4e52-b1bd-dd870f06e55c
---
...
1. Depending on whether your GDS points to a file system or a database, perform one of the following steps:
    ...
    1. Execute the following commands for each session ID:
