...
uuid: 50962da0-89ad-43e6-94b2-415ea6b62ab9
acrolinxdate: 2016-05-31T06 36 24.008-0400
acrolinxlastcheckedby: vishgupt
acrolinxpagestatus: red
acrolinxreporturl: http //checkstyle.corp.adobe.com 8031/output/en/creating_forms_repeatable_sections_admin_5e12de0b318c6865_1990_report.xml
acrolinxsentences: 74
acrolinxwords: 1095
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: author
discoiquuid: cf51161a-33bc-4108-bed7-2e74d9be2a31
isreadyforlocalization: false
lastpublishqadate: 2015-11-25T06 06 06.876-0500
index: y
internal: n
snippet: y
---
...
1. The parent of the panel, which is to be repeated, should contain add and delete buttons to manage instances of the repeatable panels. Perform the following steps to insert buttons to the parent and enable scripts on the buttons:
    ...
    1. From the sidebar, drag-and-drop a button component to the parent of the panel**. **Select the component and tap  ![](assets/edit-rules.png)    
    
       . The rules of the button open in the rule editor.
...
1. On a panel, which is to be repeated, tap  ![](assets/cmppr.png). You can see the panel properties in the sidebar. Enable the **Make Panel Repeatable** tab, and specify value for the **Maximum **and **Minimum** fields.
   ...
   Now, you can use the plus (+) and delete ( ![](assets/delete-panel.png)

   ) buttons to add and remove the panels.
...
[Attached .zip file contains a sample repeatable sub form.](assets/sampleRepeatableSubform.zip)
...
>[!MORE_LIKE_THIS]
>
>* [Creating adaptive forms](../../forms/using/creating-adaptive-form.md)
...
>* [Enabling eSign services signatures in adaptive forms](/forms/using/enabling-eSign-your-adaptive-forms)
>* [Localizing adaptive forms](/forms/using/localizing-adaptive-forms)
>* [Creating a custom adaptive form template](/forms/using/create-custom-templates-adaptive-forms-documents)
