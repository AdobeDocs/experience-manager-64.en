...
uuid: 28da6198-be6b-4f1a-a9fd-1fe5aead770a
contentOwner: khsingh
products: SG_EXPERIENCEMANAGER/6.3/FORMS
discoiquuid: 17708a4c-0b1e-4058-b404-2ed070a01308
unpublishexternaldate: 2018-07-12T03 59 14.655-0400
index: y
internal: n
snippet: y
---
...
1. Configure read and write services for the data model object.
    ...
    1. Select **get** from the Read Service drop-down. The **id** argument, which is the primary key in the customerdetails data model object is added automatically. Tap  ![](assets/AEM_6_3_Edit.png)    
    
       and configure the argument as follows.
