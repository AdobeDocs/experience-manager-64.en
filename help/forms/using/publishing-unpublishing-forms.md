...
uuid: ce873adc-0929-4f7b-9ca3-9cd53b123af4
acrolinxdate: 2016-05-31T06 42 33.374-0400
acrolinxlastcheckedby: vishgupt
acrolinxpagestatus: red
acrolinxreporturl: http //checkstyle.corp.adobe.com 8031/output/en/publishing_unpublishing_forms_admin_5e12de0b318c6865_2056_report.xml
acrolinxsentences: 98
acrolinxwords: 1311
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: publish
content-strategy: max-2018
discoiquuid: e66ec50c-da1c-4610-92e4-fa6cec41d009
isreadyforlocalization: false
lastpublishqadate: 2015-12-03T01 57 57.474-0500
...
1. Use one of the following to select and publish an asset.
    ...
    1. Move the pointer over an asset and tap **[!UICONTROL Publish]** ![](assets/aem6forms_globe.pngasset.png){width="16"}    
    
       .
    1. Do one of following and then tap Publish:

        * If you are in the card view, tap ****[!UICONTROL Enter Selection]** ** ![](assets/Aem6Forms_check-circle.png){width="16"}        
        
          , and tap the asset. The asset is selected.
...
1. In the Metadata Properties page, tap **[!UICONTROL Advanced]**, and then tap **[!UICONTROL Edit]** ![](assets/IllustratorCC_PencilTool_Cur_Edit_2_17.png){width="16"}

   .
1. In the **[!UICONTROL Publish On Time]** and **[!UICONTROL Publish Off Time]** fields, select the date and time.  
   Tap **[!UICONTROL Done]** ![](assets/Aem6Forms_Check.png){width="16"}

   .

## Unpublish an asset {#unpublish-an-asset}

1. Select an asset that is published and tap **[!UICONTROL Unpublish]** ![](assets/UnPublish.png){width="18"}

   .
1. Use one of the following to select and unpublish an asset.

    1. Move the pointer over an asset and tap **[!UICONTROL Unpublish]** ![](assets/UnPublish.png){width="18"}    
...
1. Before the asset is deleted, a confirmation dialog appears. Tap **[!UICONTROL Delete]**.
   ...
   >[!NOTE]
   >
   >Only the selected asset is deleted, and the dependent assets and are not deleted. To check references of an asset, tap  ![](assets/References.png)   >
   >
   >and then select an asset. 
   >
   >
