...
uuid: 8cb94152-2747-4234-a5e8-b57ca184c7e6
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: publish
content-strategy: max-2018
discoiquuid: 997594f1-454b-4cb5-94a2-5ad0ff378e81
index: y
internal: n
snippet: y
---
...
1. Use one of the following to select and publish an asset.
    ...
    1. Do one of following and then tap Publish:
        ...
        * If you are in the card view, tap ****[!UICONTROL Enter Selection]** ** ![](assets/Aem6Forms_check-circle.png){width="16"}, and tap the asset. The asset is selected.
