...
uuid: c587255d-842a-4999-af38-a79ec356e39b
acrolinxdate: 2018-05-02T09 56 03.146-0400
acrolinxlastcheckedby: khsingh
acrolinxpagestatus: yellow
acrolinxreporturl: http //acrolinx.corp.adobe.com 8031/output/en/Style_your_adaptive_form_krs_workflow_aaed56bc5e609850_163_report.xml
acrolinxsentences: 298
acrolinxwords: 1923
topic-tags: introduction
discoiquuid: 80b7de5d-fe7e-4b7d-917c-245c7907e825
preview: true
unpublishexternaldate: 2018-07-12T04 09 29.198-0400
index: y
internal: n
snippet: y
---
...
Learn to create a custom theme, style individual components, and use web fonts in a theme 
 ...
 ![](assets/08-style_your_adaptiveformmain.png) 

| This tutorial is a step in the [Create Your First Adaptive Form](/content/help/en/experience-manager/6-3/forms/using/create-your-first-adaptive-form) series. It is recommended to follow the series in chronological sequence to understand, perform, and demonstrate the complete tutorial use case. |
|---|

## About the tutorial  {#about-the-tutorial}

You can use themes to provide a unique appearance and style to an adaptive form. You can apply out of the box themes provided with adaptive forms editor or create custom themes of your own. AEM Forms provide a [theme editor](/content/help/en/experience-manager/6-3/forms/using/themes) to create custom themes. A single theme can provide the different appearance to the same adaptive form opened on mobile, tablet, or desktop. Any prior knowledge of CSS or LESS is not required to use theme editor but it is desired.
...
1. Select a theme from the **Adaptive Form Theme** field. For example, **Survey theme**. Tap  ![](assets/AEM_6_3_Forms_save.PNG)

   to apply the selected theme.

![Adaptive form with the default theme](assets/default-adaptive-form.png)  ![Adaptive form with the Survey theme](assets/adaptive-form-with-survey-theme.png) 
...
1. Change the existing logo and text of the header. To remove the logo:
    ...
    1. Tap logo image in the header component and tap  ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/6-2/cmppr.png)    
    
       properties. In the image property, tap X to remove the existing logo image.
    1. Tap upload, select the logo.png, and tap  ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Forms_save.PNG){width="18"} to save the changes. The image was downloaded in the [Before you start](../../forms/using/style-your-adaptive-form.md#main-pars-header-306050920) section.  
    
    1. Tap header text, `We.Retail`, and tap  ![](assets/AEM_6_3_Edit.png){width="18"}** **edit. Change header text to** ** `we retail`. Apply bold formatting only to `we`in `**we **retail`.
...
1. Remove title and add placeholder text:
    ...
    1. Delete the content of the **Title** field and tap  ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Forms_save.PNG){width="18"}    
...
1. Set the following properties in the** Text** accordion and tap  ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Forms_save.PNG){width="18"}
...
1. Tap the header widget and tap **Header**. The options to style the Header widget appear on the left. Expand the **Dimensions & Position** accordion, set the** Height** to `120px`, and tap  ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Forms_save.PNG){width="18"}

   .
1. Expand the Background accordion of the header widget, set the** Background Color** to `F6921E.`

   Hover over **Image & Gradient** &gt; **+ Add**, tap **Image**. Set the following properties and tap  ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Forms_save.PNG){width="18"}

   .

   | Property |Value |
   |---|---|
   | image |Upload the header-style.png. The image was downloaded in the [Before you start](../../forms/using/style-your-adaptive-form.md#main-pars-header-306050920) section. |
   | Position |Right Bottom |
   | Tiling |No Repeat |

1. In the theme editor, tap the logo in the header and tap **Header Logo**. Expand the Dimensions & Position accordion, set the following properties and tap  ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Forms_save.PNG){width="18"}
...
1. Tap the footer widget and tap **Footer**. Expand the **Background** accordion, set the** Background Color** to `F6921E`, and tap  ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Forms_save.PNG){width="18"}
...
1. Tap the Customer ID field and tap the **Field Widget **option. Set the following properties** **and tap  ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Forms_save.PNG){width="18"}
...
1. Tap on the empty area above the Customer ID field and tap **Responsive Panel Container**. Set the **Background** &gt; **Background Color** to F1F2F2. Tap  ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Forms_save.PNG){width="18"}.

   ![](assets/Responsive-panel-container.png)
...
1. Tap the **Submit **button and tap the **Button **option. Set the following properties and tap  ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Forms_save.PNG){width="18"}
...
1. [Apply the custom theme](../../forms/using/style-your-adaptive-form.md#main-pars-header-1828534871), Global Theme, to your adaptive form. If the style does not reflect on the adaptive form, clean the browser cache and try again.
...
1. Tap the **Government approved address proof** option and tap the  ![](https://helpx.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Edit.png)

   icon. Set the following properties:
...
1. Tap the **Submit** button and tap the  ![](https://helpx.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Edit.png)
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody> 
  ...
  <tr> 
   ...
   ![](assets/styled-adaptive-form-1.png)
...
1. Change the font family of all the components in Text accordion to Myriad Pro. 
1. Step text
