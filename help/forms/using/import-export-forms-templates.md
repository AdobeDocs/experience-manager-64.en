...
uuid: 25746e57-53b1-4447-9def-bab0cfcacb16
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: forms-manager
discoiquuid: 071cac6a-9714-4027-8622-65740cd1f685
index: y
internal: n
snippet: y
---
...
1. Tap Experience Manager ![](assets/AdobeExperienceManager.png){width="18"} icon &gt; navigation ![](assets/Compass.png){width="18"} icon&gt; Forms &gt; Forms & Documents. 
...
1. Log in to the AEM Forms instance.
1. Tap Experience Manager ![](assets/AdobeExperienceManager.png){width="18"} icon &gt; navigation ![](assets/Compass.png){width="18"} icon&gt; Forms&gt; Themes. 
