...
uuid: 3d4116df-97b2-4db0-8865-84b80748604c
acrolinxdate: 2016-05-31T06 39 43.099-0400
acrolinxlastcheckedby: vishgupt
acrolinxpagestatus: red
acrolinxreporturl: http //checkstyle.corp.adobe.com 8031/output/en/import_export_forms_templates_admin_5e12de0b318c6865_2022_report.xml
acrolinxsentences: 90
acrolinxwords: 1305
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: forms-manager
discoiquuid: 4e627404-3c0d-4725-b6bc-1b09858bd7d5
isreadyforlocalization: false
lastpublishqadate: 2015-08-05T10 47 30.665-0400
index: y
internal: n
snippet: y
---
...
1. Tap Experience Manager  ![](assets/AdobeExperienceManager.png){width="18"} icon &gt; navigation  ![](assets/Compass.png){width="18"}

   icon&gt; Forms &gt; Forms & Documents. 
...
1. Tap the **Download Exported Package** link to download the package file.
   ...
   To add the assets in the package to another instance of Correspondence Management, [import the package to an AEM Forms instance](../../forms/using/import-export-forms-templates.md#main-pars-header-7).
...
1. A new folder with the title you defined is displayed at the current location in the asset listing.
   ...
   If a folder exists with the name specified, the submission fails with an error. You can view the error message by hovering over the error  ![](assets/Aem6Forms_error_alert.png){width="16"}

   icon that appears beside the name field.
...
![](assets/Search_TopBar.png)  ![Side panel - Filters](assets/Search_SidePanel.png)
...
>* [Configure the synchronization scheduler](../../forms/using/configure-synchronization-scheduler.md)
