...
* Use compressed images. <!-- Fix broken link compressed images (assets/using/best-practices-for-optimizing-the-quality-of-your-images.md) --> It reduces the network activity and amount of memory required to render a form. Therefore, the form load time decreases substantially.
