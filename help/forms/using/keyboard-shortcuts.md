...
* Editing a text module after tapping the relevant Edit icon ( ![](assets/edittextmodule.png)) when [creating a correspondence](/help/forms/using/create-correspondence.md).
