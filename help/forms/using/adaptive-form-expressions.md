...
uuid: 83c781da-c7e8-49e9-952a-21eb48c3921a
acrolinxdate: 2016-05-31T06 30 54.283-0400
acrolinxlastcheckedby: vishgupt
acrolinxpagestatus: red
acrolinxreporturl: http //checkstyle.corp.adobe.com 8031/output/en/adaptive_form_expressions_admin_5e12de0b318c6865_1944_report.xml
acrolinxsentences: 179
acrolinxwords: 2675
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: develop
discoiquuid: b6707d9d-389c-4e92-bb72-c8dbe836d1ff
isreadyforlocalization: false
lastpublishqadate: 2015-11-20T08 12 45.388-0500
index: y
internal: n
snippet: y
---
...
* ** [Calculate expressions](../../forms/using/adaptive-form-expressions.md#main-pars-header)**: to auto-compute value of a field.
* ** [Click expression](../../forms/using/adaptive-form-expressions.md#main-pars-header-6)**: to handle actions on click event of a button. 
* ** [Initialization Script](../../forms/using/adaptive-form-expressions.md#main-pars-header-20):** perform an action on initialization of a field.  

* ** [Options expression](../../forms/using/adaptive-form-expressions.md#main-pars-header-7)**: to dynamically fill a drop-down list.
* [**Summary expression**](#summary): to dynamically compute the title of an accordion.
* ** [Validate expressions](../../forms/using/adaptive-form-expressions.md#main-pars-header-3)**: to validate a field.
* ** [Value Commit Script](../../forms/using/adaptive-form-expressions.md#main-pars-header-21):** to change the components of a form after the value of a field is changed.  

* ** [Visibility expression](../../forms/using/adaptive-form-expressions.md#main-pars-header-5)**: to control visibility of a field and panel.
* ** [Step completion expression](../../forms/using/adaptive-form-expressions.md#main-pars-header-8)**: to prevent a user from going to next step of a wizard.
...
The validation of a field can also be computed using expressions on different fields. These expressions are written inside **Validation Script** field of the **Script** tab of **Edit** dialog of the component. The validation status of a field depends upon the value that the expression returns. For information on how to write such expressions, see [Validate Expression](../../forms/using/adaptive-form-expressions.md#main-pars-header-3).
