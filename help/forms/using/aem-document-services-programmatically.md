...
uuid: 11911723-1368-444f-9d4f-dccb75abf3b6
acrolinxdate: 2016-05-31T06 33 22.885-0400
acrolinxlastcheckedby: vishgupt
acrolinxpagestatus: red
acrolinxreporturl: http //checkstyle.corp.adobe.com 8031/output/en/aem_document_services_programmatically_admin_5e12de0b318c6865_1956_report.xml
acrolinxsentences: 1104
acrolinxwords: 16908
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: document_services
discoiquuid: 380ce54b-6451-41fa-952b-dd617a406e5e
isreadyforlocalization: false
lastpublishqadate: 2015-09-23T06 32 53.486-0400
index: y
internal: n
snippet: y
---
...
Client classes required to build Maven Projects using AEM Document Services are available in the [AEM Forms Client SDK](/content/help/en/aem-forms/kb/aem-forms-releases) jar. For information around maven projects, see [how to build your AEM project using Maven](../../sites/developing/using/ht-projects-maven.md).
...
**Syntax**: `public Document addSignatureField(Document inDoc,  
...
**Syntax**: `secureDocument(Document inDoc, EncryptionOptions encryptionOptions,  
...
**Syntax**: `secureDocument(Document inDoc,  
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody> 
  ...
  <tr> 
   <td><span class="code">signatureField<br /> Name</span><br /> </td> 
...
* ** [generatePDFOutput](../../forms/using/aem-document-services-programmatically.md#main-pars-header-1): **Generates a PDF document by merging a form design with data stored on a network location, local file system, or HTTP location as literal values.  

* ** [generatePDFOutput](../../forms/using/aem-document-services-programmatically.md#main-pars-header-4): **Generates a PDF document by merging a form design with data that are stored in an application.
* ** [generatePDFOutputBatch](../../forms/using/aem-document-services-programmatically.md#main-pars-header-7):** Merges a form design with data to create a PDF document. Optionally, generates a metadata file for each record or saves the output to a PDF file.
* ** [generatePrintedOutput](../../forms/using/aem-document-services-programmatically.md#main-pars-header-10):** Generates a PCL, PostScript, or ZPL output from a form design and data file stored on a network location, local file system, or HTTP location as literal values.  
...
**Syntax:** ` Map exportPDF(Document inputDoc, String inputFileName, String formatType, Document settingsDoc) throws ConversionException, InvalidParameterException, FileFormatNotSupportedException;  
`
...
**Syntax:** ` OptimizePDFResult optimizePDF(Document inputDoc, String fileTypeSettings, Document settingsDoc) throws ConversionException, InvalidParameterException, FileFormatNotSupportedException;  
`
...
**Syntax:** ` HtmlToPdfResult htmlToPdf2(String inputUrl, String fileTypeSettingsName, String securitySettingsName, Document settingsDoc, Document xmpDoc) throws ConversionException, InvalidParameterException, FileFormatNotSupportedException;  
`
...
**Syntax:** ` Map createPDF(Document inputDoc, String inputFileName, String pdfSettings, String securitySettings, Document settingsDoc, Document xmpDoc) throws ConversionException, InvalidParameterException, FileFormatNotSupportedException;  
`
