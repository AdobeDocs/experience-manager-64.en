...
uuid: 604bce6e-a099-441d-aa26-369d818fdd06
acrolinxdate: 2016-05-31T06 36 06.990-0400
acrolinxlastcheckedby: vishgupt
acrolinxpagestatus: red
acrolinxreporturl: http //checkstyle.corp.adobe.com 8031/output/en/creating_adaptive_form_admin_5e12de0b318c6865_1987_report.xml
acrolinxsentences: 96
acrolinxwords: 1677
content-type: reference
topic-tags: author
products: SG_EXPERIENCEMANAGER/6.4/FORMS
discoiquuid: 28e7c977-6292-4ee4-9891-1400b350b05b
lastpublishqadate: 2015-09-14T03 29 41.729-0400
index: y
internal: n
snippet: y
---
...
1. An option to select a template appears. For more information about templates, see [Adaptive form templates](../../forms/using/creating-adaptive-form.md#main-pars-header-6). Tap a template to select it and tap Next.
...
1. You can create an adaptive form based on one of following form models:
    ...
    * [Form data model](#fdm)
    * [XFA form template](../../forms/using/creating-adaptive-form.md#main-pars-header-0)
    * [XML or JSON schema](../../forms/using/creating-adaptive-form.md#main-pars-header-1)
...
>* [Introduction to installing and deploying AEM Forms](../../forms/using/installing-configuring-aem-forms-osgi.md)
>* [Introduction to authoring an adaptive form](../../forms/using/introduction-forms-authoring.md)
>* [Introduction to managing adaptive forms](../../forms/using/introduction-managing-forms.md)
>* [Introduction to publishing adaptive forms](../../forms/using/introduction-publishing-forms.md)
