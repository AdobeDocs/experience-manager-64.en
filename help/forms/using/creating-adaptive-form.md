...
>[!NOTE]
>
>When you open an adaptive form created using the advanced template for editing, an error message appears. The advanced template has a Signature Step component and Acrobat Sign is enabled for it by default. Create and select an [Acrobat Sign cloud configuration](/help/forms/using/adobe-sign-integration-adaptive-forms.md) and [configure a signer](/help/forms/using/working-with-adobe-sign.md#addsignerstoanadaptiveform) to resolve the error.
