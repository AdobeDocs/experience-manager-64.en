...
* **Input Attachment Path**:Choose the path (Relative to Payload or Variable) for the documents and the documents append at the end of generated DoR for signing. PDF files supported by Adaptive forms are supported here as well.  
