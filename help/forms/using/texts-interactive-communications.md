...
uuid: 4189d9a2-d470-402c-8e9f-ff0bf81c9063
topic-tags: interactive-communications
products: SG_EXPERIENCEMANAGER/6.4/FORMS
discoiquuid: ebaa19ad-e46f-4cdf-b092-60b6adfc6f5c
...
1. Select the appropriate operator to evaluate the rule, such as Is Equal To, Contains, and Starts With. 
   ...
   ![](assets/RuleEditorFDM-1-1.png)

1. Insert the evaluating expression, value, data model property, or variable.

   ![Rule to display the selected text if the location of the recipient is US according to the source data of FDM](assets/RuleEditorFDM-1-2.png)

    * While creating or editing a rule, you can also tap  ![](assets/Icon_Resize.png)    
    
      (Resize) to expand the Create Rule/Edit Rule dialog. The expanded, full-window dialog allows you to drag-and-drop form data model properties and variables to construct rules. Tap Resize again to go back to the Create Rule dialog. 
...
[ ![Select type of toolbar](assets/ToolbarSelection-1.png)](assets/ToolbarSelection.png)  ![Font editing toolbar](assets/ParagraphToolbar-1.png)  ![Alignment toolbar](assets/AlignmentToolbar.png)  ![Listing toolbar](assets/ListingToolbar.png) 
