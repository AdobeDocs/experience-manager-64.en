...
uuid: 74d98a87-f1c3-4626-a05c-93dee8719804
acrolinxdate: 2016-12-22T04 59 05.940-0500
acrolinxlastcheckedby: vishgupt
acrolinxpagestatus: yellow
acrolinxreporturl: http //acrolinx.corp.adobe.com 8031/output/en/rule_editor_access_user_groups_krs_workflow_c77e08fb6f309c49_30_report.xml
...
discoiquuid: e04e28e8-60ec-4d18-a9b5-7d5f431f97f9
...
1. In the author instance, click ** ![](assets/AdobeExperienceManager.png)Adobe Experience Manager &gt; Tools  ![](assets/Hammer.png)
   ...
   &gt; Operations &gt; Web Console. **The Web Console opens in a new window.
...
1. Use the following property to specify the name of a group that can access rule editor (For example, RuleEditorsUserGroup) and click **Save All**.
   ...
   Now, when a user that is not a part of the a specified user group (here RuleEditorsUserGroup) taps a field, the Edit Rule icon ( ![](assets/edit-rules1.png)
