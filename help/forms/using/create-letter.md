...
* Other XDPs ([layout fragments](../../forms/using/document-fragments.md#main-pars-header-13)) that form parts of the letter. The XDPs\Layouts are created in [Designer](https://help.adobe.com/en_US/AEMForms/6.1/DesignerHelp/). 
