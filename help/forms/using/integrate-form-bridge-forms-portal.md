...
uuid: b31b7580-b6c4-49e8-a5c3-1ae5dcdfd527
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: hTML5_forms
discoiquuid: 68e0683e-7c77-41c9-a9e9-2fdcad75b037
index: y
internal: n
snippet: y
---
...
1. Include XFA runtime, XFA locale library, and XFA form HTML snippet in the profile renderer, design your web page, and place the form inside the web page.
...
1. The following is a sample script you can add to set values in a form field.
