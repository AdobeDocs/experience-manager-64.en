...
uuid: 5cce4e9f-de6e-477d-a46c-51aacebd3174
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: correspondence-management
discoiquuid: 2255498d-1565-4fa5-8da9-042ef095260c
index: y
internal: n
snippet: y
---
...
1. Edit the content modules, as required, in the Content tab. To bring focus to the relevant content module in the content hierarchy, you can either tap the relevant line or paragraph in the letter preview or tap the content module directly in the Content hierarchy.
   ...
   In the Content or Data tab, by tapping Highlight Selected Modules ( ![](assets/HighlightSelectedModulesinContentCCR.png){width="16"}) on upper left of the HTML letter preview, you can disable or enable functionality to go to the content/data module when the relevant text, paragraph, or data field is selected in the letter preview.
...
1. To edit an inline or editable text module, tap the relevant **Edit** icon ( ![](assets/EditTextModule.png){width="16"}) or double-click the relevant text module in the letter preview.
...
1. Edit the content modules, as required, in the Content tab. To bring focus to the relevant content module in the content hierarchy, you can either tap the relevant line or paragraph in the letter preview or tap the content module directly in the Content hierarchy.
   ...
   By tapping Highlight Selected Modules in Content ( ![](assets/HighlightSelectedModulesinContentCCR.png){width="16"}), you can disable or enable functionality to highlight the content module in Content tab when the relevant text, paragraph, or data field is tapped in the letter preview.
...
1. To preview the letter as a flattened PDF with the exact layout and page breaks as it will be submitted, tap ( ![](assets/Preview.png){width="48"}) Preview.
