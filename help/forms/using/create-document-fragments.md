...
uuid: 24b58e6e-a50c-4faa-9cb8-da74e3f116e3
acrolinxdate: 2018-11-22T05 30 59.791-0500
acrolinxlastcheckedby: anujkapo
acrolinxpagestatus: green
acrolinxreporturl: http //acrolinx.corp.adobe.com 8031/output/en/create_document_fragments_krs_workflow_27a21c3e5e538b90_66_report.xml
acrolinxsentences: 175
acrolinxwords: 1621
contentOwner: anujkapo
products: SG_EXPERIENCEMANAGER/6.4/FORMS
discoiquuid: 56cafd03-e0df-463f-a6dc-1cd9a3efcf1a
...
1. In the **Create Variable** section:
   ...
   ![](assets/variables_bill_details.PNG)
...
1. Select the **Data Model Objects** tab, place the cursor next to the **Charges current bill period** field in the right pane, and double-click the **bills** &gt; **usagecharges** property.
   ...
   ![](assets/bill_summary_static_variables.PNG)
