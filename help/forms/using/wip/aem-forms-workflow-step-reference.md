...
uuid: 9769895c-57a3-4196-b76c-cb8d765a16cb
discoiquuid: 7ce5fb8f-5cad-4418-a8fc-353c376da7ba
index: y
internal: n
snippet: y
---
...
* **Participant Chooser:** The option is available when the **Dynamically to a user or group** option is selected in the Assign options field. You can use an ECMAScript or a service to dynamically select a user or a group. For more information, see [Dynamically assign a workflow to the users](/content/help/en/experience-manager/kb/HowToAssignAWorkflowDynamicallyToParticipants) and [Creating a custom Adobe Experience Manager Dynamic Participant step.](/content/help/en/experience-manager/using/dynamic-steps)
