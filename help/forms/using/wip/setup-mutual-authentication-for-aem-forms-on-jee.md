---
title: Set up Mutual Authentication for AEM Forms on JEE
seo-title: Set up Mutual Authentication for AEM Forms on JEE
description: null
seo-description: null
page-status-flag: never-activated
uuid: ca1cee69-4c3a-4f8a-848c-1b41c75bec79
acrolinxdate: 2018-12-05T07 32 20.957-0500
acrolinxlastcheckedby: khsingh
acrolinxpagestatus: yellow
acrolinxreporturl: http //acrolinx.corp.adobe.com 8031/output/en/setup_mutual_authentication_for_aem_forms_on_jee_krs_workflow_27a21c3e5e538b90_217_report.xml
acrolinxsentences: 97
acrolinxwords: 1150
contentOwner: khsingh
discoiquuid: ba891dfc-956f-4e2c-b20a-5914812eb5b3
preview: true
index: y
internal: n
snippet: y
...
# Set up Mutual Authentication for AEM Forms on JEE{#set-up-mutual-authentication-for-aem-forms-on-jee}
...
* [Configure application server](../../../forms/using/wip/setup-mutual-authentication-for-aem-forms-on-jee.md#main-pars-header-1346705516)
* [Configure AEM Forms on JEE server](/content/help/en/livecycle/kb/cac-mutual-authentication#main-pars_header_3)
...
* [Configure Microsoft SharePoint Connector Web part changes](/content/help/en/livecycle/kb/cac-mutual-authentication#main-pars_header_4)
...
* Obtain certificates from a trusted certifying authority (CA) or create [self-signed the certificates](../../../forms/using/wip/setup-mutual-authentication-for-aem-forms-on-jee.md#main-pars-header-680942598). These certificates are required to identify the server and clients in a mutual authentication environment.  

* Create and deploy the custom user management auth provider (AuthProvider) SPI to enable mutual authentication on the AEM Forms server. For detailed instructions, see [Server Configuration](/content/help/en/livecycle/kb/cac-mutual-authentication#main-pars_header_3).
...
1. Add certificates to AEM truststore and keystore:
    ...
    1. Tap **[!UICONTROL Create trustStore]** and set an access password for trustStore. For more information, see [Add the IdP Certificate to the AEM TrustStore](/content/help/en/experience-manager/6-3/sites/administering/using/saml-2-0-authenticationhandler#main-pars_title_0).
    1. Tap **[!UICONTROL Create keyStore]** and set a password for keyStore. For more information, see [Add the Service Provider key and certificate chain to the AEM keystore](/content/help/en/experience-manager/6-3/sites/administering/using/saml-2-0-authenticationhandler#main-pars_title_1971190167).
    1. Step text
