...
uuid: 0e042895-ddf0-44fe-9ef4-0fa5af2e5721
contentOwner: vishgupt
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: develop
discoiquuid: 4c18a077-8ae9-4073-a370-2ca7a290eced
...
1. In adaptive form authoring mode, select the Form Container object and tap  ![](assets/cmppr1.png)
...
1. Tap  ![](assets/check-button1.png)
...
1. Open the adaptive form in authoring mode, select any form object, and tap  ![](assets/edit-rules1.png)
