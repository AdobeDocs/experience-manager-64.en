...
uuid: 9c35f3e1-c9d6-4a23-bbb6-a12d8b8aaf3e
acrolinxdate: 2016-05-31T06 56 38.467-0400
acrolinxlastcheckedby: vishgupt
acrolinxpagestatus: red
acrolinxreporturl: http //checkstyle.corp.adobe.com 8031/output/en/configuring_file_type_settings_admin_5e12de0b318c6865_2290_report.xml
acrolinxsentences: 150
acrolinxwords: 2410
geptopics: SG_AEMFORMS/categories/working_with_pdf_generator
products: SG_EXPERIENCEMANAGER/6.4/FORMS
content-type: reference
discoiquuid: 8b42dcd8-3d3f-418e-9d92-33d71d69998c
...
1. Complete the required information in these sections:
   ...
   [Adobe PDF export settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-heading-2)

   [HTML-to-PDF settings](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-heading-3)

   [Flash videos to PDF settings](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-heading-9)

   [XPS to PDF settings](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-heading-10)

   [PDF optimizer settings](../../../forms/using/admin-help/configuring-file-type-settings.md)

   [Microsoft Excel settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-header-2030281838)

   [Microsoft PowerPoint settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-header)

   [Microsoft Project settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-header-1414452785)

   [Microsoft Word settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-header-184188244)

   [Microsoft Visio settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-header-1354428557)

   [Microsoft Publisher settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-header-608923096)

   [AutoCAD settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-header-1010503134)

   [OpenOffice settings](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-header-1031595935)

   [Other applications’ settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#main-pars-header-869340438)
...
These options determine how AutoCAD files are converted. For instructions about accessing these options, see [Create or edit file type settings](../../../forms/using/admin-help/configuring-file-type-settings.md#create-or-edit-file-type-settings).
