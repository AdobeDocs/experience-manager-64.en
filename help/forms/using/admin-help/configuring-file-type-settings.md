...
uuid: 7868f304-5d10-4e9d-bec4-eea7fe1fc07a
geptopics: SG_AEMFORMS/categories/working_with_pdf_generator
products: SG_EXPERIENCEMANAGER/6.4/FORMS
content-type: reference
discoiquuid: 33e54fa5-1dc6-46c1-a56b-c1440c472ddf
index: y
internal: n
snippet: y
---
...
* [Change the default settings](../../../forms/using/admin-help/configuring-file-type-settings.md#change-the-default-settings)
...
1. Complete the required information in these sections:
   ...
   [Microsoft Excel settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#microsoft-excel-settings-windows-only)

   [Microsoft PowerPoint settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#microsoft-powerpoint-settings-windows-only)

   [Microsoft Project settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#microsoft-project-settings-windows-only)

   [Microsoft Word settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#microsoft-word-settings-windows-only)
   ...
   [Microsoft Publisher settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#microsoft-publisher-settings-windows-only)

   [AutoCAD settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#autocad-settings-windows-only)

   [OpenOffice settings](../../../forms/using/admin-help/configuring-file-type-settings.md#openoffice-settings)

   [Other applications’ settings (Windows only)](../../../forms/using/admin-help/configuring-file-type-settings.md#other-applications-settings-windows-only)
