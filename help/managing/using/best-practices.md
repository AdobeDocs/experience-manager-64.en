...
* An [interactive checklist](/help/managing/using/best-practices-checklist.md) that allows you to track and monitor your progress with these best practices.
...
* Documentation, based directly on the [checklist](/help/managing/using/best-practices-checklist.md), that details the:
    ...
    * A [Glossary](/help/managing/using/best-practices-glossary.md) of the [Required Documents and Deliverables](#required-documents-and-deliverables).

* [Further reference](/help/managing/using/best-practices-further-reference.md) material to provide more details on specific areas.
...
* **System Architecture**
  ...
  The system architecture defines the conceptual view of your system; including (amongst other information):
    ...
    * Servers for each environment; see the [Technical Requirements](/help/sites/deploying/using/technical-requirements.md) and [Hardware Sizing Guidelines](/help/managing/using/hardware-sizing-guidelines.md)
...
* **Integration**
  ...
  Plan, document and test all aspects of the system and [solution integration](/help/sites/administering/using/integration.md), including:
    ...
    * Automated processes to [move applications from development to test, then production](/help/managing/using/enterprise-devops.md#code-movement)
    * Automated processes to [move content from production to test and development](/help/managing/using/enterprise-devops.md#content-movement)
...
* [Other Best Practices and Guidelines related to Managing an AEM project](/help/managing/using/manage-reference.md)
...
* AEM Documentation  
  In addition, the following sections of AEM documentation are of particular interest (however, this list is not exhaustive):
    ...
    * [Hardware sizing](/help/managing/using/hardware-sizing-guidelines.md)
    * Concepts of AEM:
