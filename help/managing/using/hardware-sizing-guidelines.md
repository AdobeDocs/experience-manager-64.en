...
Allocate at least 16GB of heap and configure the DAM Update Asset workflow to use the [Camera Raw package](camera-raw.md) for the ingestion of raw images.
