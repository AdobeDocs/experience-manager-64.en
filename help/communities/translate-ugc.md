...
The translation feature for AEM Communities extends the concept of [translating page content](/help/sites/administering/using/translation.md) to the user generated content (UGC) posted to community sites using [social component framework (SCF) components](/help/communities/scf.md).
