...
A component's [SocialEvent](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/javadoc/com/adobe/cq/social/scf/core/SocialEvent.html) instance records the events as `actions`that occur for a `topic`. The SocialEvent includes a method to return a `verb`associated with the action. There is an *n-1* relationship between `actions`and `verbs`.
...
** [Calendar Component](/help/communities/calendar-basics-for-developers.md)** 
...
** [Comments Component](/help/communities/essentials-comments.md)** 
...
** [File Library Component](/help/communities/essentials-file-library.md)** 
...
** [Forum Component](/help/communities/essentials-forum.md)** 
...
** [Journal Component](/help/communities/blog-developer-basics.md)** 
...
** [QnA Component](/help/communities/qna-essentials.md)** 
...
** [Reviews Component](/help/communities/reviews-basics.md)** 
...
** [Rating Component](/help/communities/rating-basics.md)** 
...
**[Voting Component](/help/communities/essentials-voting.md)** 
SocialEvent `topic`= com/adobe/cq/social/tally
...
For a custom component, the [SocialEvent abstract class](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/javadoc/com/adobe/cq/social/scf/core/SocialEvent.html) must be extended d to record the component's events as `actions`that occur for a `topic`.
...
[com.adobe.cq.social.scf.core.SocialEvent](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/javadoc/com/adobe/cq/social/scf/core/SocialEvent.html);  
[com.adobe.granite.activitystreams.ObjectTypes](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/javadoc/com/adobe/granite/activitystreams/ObjectTypes.html);  
[com.adobe.granite.activitystreams.Verbs](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/javadoc/com/adobe/granite/activitystreams/Verbs.html);
...
Requires [latest feature pack](/help/communities/deploy-communities.md#latestfeaturepack).
