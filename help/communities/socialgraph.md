...
The ability for a community member to follow [activities](/help/communities/activities.md) as well as be followed is established through two components: `Follow`and `Following`.
...
More information may be found on the [Social Graph Essentials](/help/communities/essentials-socialgraph.md) page for developers.
