...
| ** [⇐ Initial Sandbox Application](/help/communities/using/initial-app.md)** |** [Develop Sandbox Application ⇒](/help/communities/using/develop-app.md)** |
|---|---|

In this section, you create the following pages which all use the [page template](/help/communities/using/initial-app.md#createthepagetemplate):
...
Now that there is a [page template](/help/communities/using/initial-app.md#createthepagetemplate), we can establish the root page of the website in the /content directory.
...
When ` [/etc/designs/an-scf-sandbox](/help/communities/using/setup-website.md#setupthedesigntreeetcdesigns)` was created using the designs section of the Tools console, the property ``
...
>[!NOTE]
>
>The use of cq:designPath is optional and is unrelated to the [use of clientlibs](/help/communities/using/develop-app.md#includeclientlibsintemplate), which are essentially required as the SCF components use [clientlibs](/help/communities/using/client-customize.md#clientlibs-for-scf) to manage their JS and CSS.
