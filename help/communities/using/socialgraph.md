...
The ability for a community member to follow [activities](/help/communities/using/activities.md) as well as be followed is established through two components: `Follow`and `Following`.
...
The `Following`component simply lists the members that are either following the current member or are being followed by the current member. This social graph of the relationships between members is included in the user profile established for a [community site](/help/communities/using/overview.md#communitiessites).
...
When the [required client-side libraries](/help/communities/using/essentials-socialgraph.md#essentials-for-client-side) are included, this is how the `Following` component will appear:
...
More information may be found on the [Social Graph Essentials](/help/communities/using/essentials-socialgraph.md) page for developers.
