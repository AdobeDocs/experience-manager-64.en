...
Tagging of enablement resources allows for filtering of resources and learning paths as members browse [catalogs](/help/communities/using/functions.md#catalog-function).

Essentially:

* [create a tag namespace](/help/sites/administering/using/tags.md#creating-a-namespace) for each catalog

    * [set tag permissions](/help/sites/administering/using/tags.md#setting-tag-permissions)

        * for community members only (closed community)

            * allow read access for the [community site's member group](/help/communities/using/users.md#publish-group-roles)

        * for any site visitor, whether signed-in or anonymous (open community)

            * allow read access for the `Everyone`group

    * [publish the tags](/help/sites/administering/using/tags.md#publishing-tags)

* [define the scope of tags for a community site](/help/communities/using/sites-console.md#tagging)

    * [configure catalogs that exist in the site's structure](/help/communities/using/functions.md#catalog-function)

        * can add tags to the catalog instance to control the list of tags presented in the UI filters
        * can add [pre-filters](/help/communities/using/catalog-developer-essentials.md#pre-filters), to restrict a catalog's included resources

* [publish the community site](/help/communities/using/sites-console.md#publishing-the-site)
* [apply tags to enablement resources](/help/communities/using/resources.md#create-a-resource) so they may be categorically filtered
* [publish the enablement resources](/help/communities/using/resources.md#publish)

## Community Site Tags {#community-site-tags}

When creating or editing a community site, the [Tagging setting](/help/communities/using/sites-console.md#tagging) sets the scope of tags available for features of the site by selecting a subset of existing tag namespaces.

While tags may be created and added to the community site at any time, it is recommended to design a taxonomy beforehand, similar to designing a database. See [Using Tags](/help/sites/authoring/using/tags.md).
...
For a community site, after the site is published and the tags are published, it is necessary to enable read access to members of the community. See [Setting Tag Permissions](/help/sites/administering/using/tags.md#setting-tag-permissions).
...
Restricting enablement resources and learning paths to specific catalogs is accomplished by creating [pre-filters](/help/communities/using/catalog-developer-essentials.md#pre-filters).
