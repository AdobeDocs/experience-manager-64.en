...
uuid: 6b2a86c9-c326-41dd-a996-95f0682bee44
acrolinxdate: 2018-04-04T03 47 30.081-0400
acrolinxlastcheckedby: mgulati
acrolinxpagestatus: yellow
acrolinxreporturl: http //acrolinx.corp.adobe.com 8031/output/en/whats_new_aem_communities_krs_workflow_0eaa5f398ed6741b_341_report.xml
acrolinxsentences: 64
acrolinxwords: 985
contentOwner: mgulati
discoiquuid: b40c5716-5ed9-4b79-a48a-ae37f7e5768a
...
* Switch to bulk mode and Exit bulk mode have been removed from the Bulk Moderation UI. To enter multi-select mode click the Select ( ![](assets/SelectIcon.png)

  ) icon on a post, which appears on hovering over it with the mouse (desktop) or pressing and holding a finger on the post (mobile).
