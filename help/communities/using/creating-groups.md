...
This ability is present when the [groups function](/help/communities/using/functions.md#groups-function) is present in the [community site](/help/communities/using/sites-console.md) structure.

A [community group template](/help/communities/using/tools-groups.md) provides the design of the community group page when a community group is dynamically created.
...
The ability to create a new community group relies on the existance of a community site which includes the groups function, such as one created from the ` [Reference Site Template](/help/communities/using/sites.md)`.

The examples that follow use the community site created from the `Reference Site Template` as described in the [Getting Started with AEM Communities](/help/communities/using/getting-started.md) tutorial.
...
More information may be found on the [Community Group Essentials](/help/communities/using/essentials-groups.md) page for developers.

For other information related to community groups, visit [Managing Users and User Groups](/help/communities/using/users.md).
