...
For another means of identifying current trends, visit [Activity Trends](/help/communities/using/trends.md).

This page documents the `Social Tag Cloud` component dialog settings and describes the user experience.

For detailed information for developers see [Tag Essentials](/help/communities/using/tag.md).
...
When the [required client-side libraries](/help/communities/using/tag.md#essentials-for-client-side) are included, this is how the `Social Tag Cloud` component will appear:
...
To edit the display of the **Social Tag Cloud**, enter [Design Mode](/help/sites/authoring/using/default-components-designmode.md) and double click on the placed `Social Tag Cloud` component to open a dialog with an additional tab.
...
More information may be found on the [Tag Essentials](/help/communities/using/tag.md) page for developers.

See [Tagging User Generated Content](/help/communities/using/tag-ugc.md) (UGC) for information about creating and managing tags.
