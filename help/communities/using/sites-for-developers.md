...
This is available from the [Communities Sites console](/help/communities/using/sites-console.md#exporting-the-site).
...
This only removes user generated content (entered on publish) and not authored content (entered on author). Therefore, [shadow nodes](/help/communities/using/srp.md#shadownodes) are not affected.

### Community User Groups {#community-user-groups}

On all author and publish instances, from the [security console](/help/sites/administering/using/security.md), locate and remove the [user groups](/help/communities/using/users.md) that are:
