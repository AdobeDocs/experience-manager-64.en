...
This tutorial describes how to setup [MSRP](/help/communities/using/msrp.md) for* one author *instance and *one publish* instance.
...
1. run Solr in standalone or [SolrCloud mode](/help/communities/using/msrp.md#solrcloudmode)
1. install [standard](/help/communities/using/msrp.md#installingstandardmls) or [advanced](/help/communities/using/msrp.md#installingadvancedmls) multilingual search (MLS)
...
Follow the instructions on the main documentation page: [MSRP - MongoDB Common Store](/help/communities/using/msrp.md)
...
1. Make sure MSRP has been configured to be the default provider:
    ...
    * On all author and publish AEM instances, revisit the [Storage Configuration console](/help/communities/using/srp-config.md)  
