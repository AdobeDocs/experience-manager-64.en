...
The blog feature is comprised of two main components that are available by adding the [Blog function](functions.md#blog-function) or by adding the components to a page in author edit mode.
...
See [Primary Publisher](deploy-communities.md#primary-publisher) for more details.
