...
uuid: aadaecb7-a2f4-4988-904c-a75a4bc5947a
contentOwner: jsyal
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/SCREENS
topic-tags: authoring
discoiquuid: 2486e206-b775-4e16-8c8c-8c45c689387d
---
...
1. Navigate to your **Locations** folder in your AEM Screens project and create two location folders as **Region A** and **Region B**.
...
1. Navigate to the **Demo** -&gt; **Locations** -&gt; **Region A** -&gt; **Region A** and click **Edit** from the action bar. Drag and drop the assets you would like to add to your channel.
...
1. Navigate and select **Schedules** folder in your AEM Screens project and click **Create** from the action bar to create a new schedule.
...
1. Navigate to the **Global** Channel, you intially created in **Demo** project.
