...
uuid: 4483c43b-5132-4a24-9458-2eeb86a33d43
products: SG_EXPERIENCEMANAGER/6.4/SCREENS
content-type: reference
topic-tags: developing
discoiquuid: c61a3a68-f2c6-4cf3-b38a-b69ee5eb84ea
firstpublishinternaldate: 2018-05-08T10 59 52.310-0400
lastpublishinternaldate: 2018-05-11T11 28 24.828-0400
publishinternaldate: 2018-05-11T11 28 24.828-0400
publishinternalurl: https //helpx-internal.corp.adobe.com/content/help/en/experience-manager/kt/screens/using/developing-custom-component-tutorial-develop.html
...
1. Download and install the following packages using [CRX package manager](http://localhost:4502/crx/packmgr/index.jsp):
   ...
   [](assets/base-screens-weretail-runuiapps-001-snapshot.zip)

   [](assets/base-screens-weretail-runuicontent-001-snapshot.zip)
   ...
   **`mvn -PautoInstallPackage clean install`**
   ...
   [Start HelloWorld SRC Screens We.Retail Run Project](assets/SRC-screens-weretail-run.zip)
...
[](assets/screens-weretail-runuiapps-001-snapshot.zip)

[](assets/screens-weretail-runuicontent-001-snapshot.zip)

[](assets/screens-weretail-run.zip)
