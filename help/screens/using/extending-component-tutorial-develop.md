...
uuid: fa5e45e0-0416-4d13-9483-7ba2e2868f41
products: SG_EXPERIENCEMANAGER/6.4/SCREENS
content-type: reference
topic-tags: developing
discoiquuid: a4ac73a7-9ccb-49da-84d3-bc908b58323c
firstpublishinternaldate: 2018-05-08T11 01 43.854-0400
lastpublishinternaldate: 2018-05-11T11 28 49.262-0400
publishinternaldate: 2018-05-11T11 28 49.262-0400
publishinternalurl: https //helpx-internal.corp.adobe.com/content/help/en/experience-manager/kt/screens/using/extending-component-tutorial-develop.html
...
1. Download and install the following packages using [CRX package manage](http://localhost:4502/crx/packmgr/index.jsp)r:
   ...
   [](assets/start-poster-screens-weretail-runuiapps-001-snapshot.zip)

   [](assets/start-poster-screens-weretail-runuicontent-001-snapshot.zip)
   ...
   **`mvn -PautoInstallPackage clean install`**
   ...
   [SRC Start Screens We.Retail Run Project](assets/start-poster-screens-weretail-run.zip)
...
[](assets/final-poster-screens-weretail-runuiapps-001-snapshot.zip)

[](assets/final-poster-screens-weretail-runuicontent-001-snapshot.zip)

[SRC Final Screens We.Retail Run Project](assets/src-screens-weretail-run-001.zip)
