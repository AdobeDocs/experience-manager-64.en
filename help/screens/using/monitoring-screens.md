...
Additionally, click **Clear cache** and **Update** to clear the cache of your device and update the [firmware](/help/screens/using/screens-glossary.md) version respectively from this panel.
...
>[!NOTE]
>
>To learn more about the events associated with device's automatic or manual updates, see the section ***Automatic versus Manual Updates from the Device Dashboard*** in [Managing Channels](/help/screens/using/managing-channels.md).
...
See [Video Playback Configuration and Troubleshooting](/help/screens/using/troubleshoot-videos.md) to debug and troubleshoot videos playing in your channel.
