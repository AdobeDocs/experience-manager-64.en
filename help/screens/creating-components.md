...
>[!NOTE]
>
>To learn about the details of creating AEM Components, see [Developing AEM Components](/help/sites-developing/components-basics.md).
...
>[!NOTE]
>
>To learn about the basics on developing your AEM application using CRXDE Lite, See [Developing with CRXDE Lite](/help/sites-developing/developing-with-crxde-lite.md).
