...
>[!NOTE]
>
>To learn more about the author and publish architectural overview and how the content is authored on an AEM author instance and then forward-replicated to multiple publish instances, refer to <!-- FAIL [Author and Publish Architectural Overview](author-publish-architecture-overview.html). -->
