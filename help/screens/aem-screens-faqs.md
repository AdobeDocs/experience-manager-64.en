...
For more information on how to implement Android Player, please refer to [**Implementing Android Player**](/help/screens/implementing-android-player.md).
...
For more information on where you can monitor device activity, please refer to [**AEM Screens Notifications Service**](/help/screens/screens-notifications-service.md).
...
To learn in detail on how to configure a higher file size limit (for example, 30GB ) in the */apps* directory, please refer to *Configuration to upload video assets that are larger than 2 GB* in <!-- FAIL [Managing Video Assets](managing-video-assets.md).-->
