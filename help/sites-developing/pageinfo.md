...
The following Java class implements [PageInfoProvider](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/javadoc/index.html) and returns the published URL of the current page resource.
