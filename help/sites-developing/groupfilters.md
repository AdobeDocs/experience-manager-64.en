...
>[!NOTE]
>
>Ensure the WURFL™ database that is deployed to AEM includes the capabilities that you use as filter criteria. (See [Device Detection](/help/sites-developing/mobile.md#server-side-device-detection).)
