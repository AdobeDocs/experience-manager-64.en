...
+ Deleted section Remove duplicates and move others to sections above {#deleted}
    ...
    + [We.Retail Reference Implementation](we-retail.md)
    + [Extending Tough Day](extending-tough-day.md)
    ...
    + [cq-spa-page-model-manager](reference-materials/spa/cq-spa-page-model-manager.md)
    + [index](reference-materials/spa/cq-spa-component-mapping/index.md)
    + [cq-spa-component-mapping](reference-materials/spa/cq-spa-component-mapping.md)
    + [index](reference-materials/spa/spa-react-editable-components/index.md)
    + [spa-react-editable-components](reference-materials/spa/spa-react-editable-components.md)
    + [spa (redirect)](reference-materials/spa.md)
