...
The [WCM Mode](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) cookie is set when switching to **Preview** mode even when the page is not refreshed.
...
>[!NOTE]
>
>In the touch-enabeld UI only the values `EDIT` and `PREVIEW` are used for the [WCM Mode](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) cookie.
...
[Coral UI](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/coral-ui/coralui3/index.html) and [Granite UI](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/granite-ui/api/index.html) define the modern look and feel of AEM.

[Granite UI provides a large range of the basic components (widgets)](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/granite-ui/api/index.html) needed to create your dialog on the authoring environment. When necessary you can extend this selection and create your own widget.
...
* Granite UI
    ...
    * [Granite UI Documentation](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/granite-ui/api/index.html)
...
>[!NOTE]
>
>For full details about the Granite UI, please see the [Granite UI documentation](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/granite-ui/api/index.html).
...
More specifically Granite UI provides a range of field components that are suitable for use in dialogs (or, more generally speaking, in [forms](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/granite-ui/api/jcr_root/libs/granite/ui/components/foundation/form/index.html)).
...
* HTL
    ...
    * Use of [HTL](https://helpx.adobe.com/experience-manager/htl/user-guide.html) is not compulsory, but if your component needs updating then it is an ideal time to consider [migrating from JSP to HTL](/help/sites-developing/components-basics.md#htl-vs-jsp).
...
* Dialogs
    ...
    * Migrate from vtypes to [Granite UI validation](https://helpx.adobe.com/experience-manager/6-4/sites-developing/reference-materials/granite-ui/api/jcr_root/libs/granite/ui/components/foundation/clientlibs/foundation/js/validation/index.html)
