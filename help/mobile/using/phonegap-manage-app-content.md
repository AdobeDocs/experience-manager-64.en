...
>**Prerequisite**: 
>
>In [Deploying and Maintaining](/help/sites/deploying/using/deploy.md), developers became familiar with AEM's system of components and templates.
...
>
>See [Mobile with Content Sync](/help/mobile/using/phonegap-contentsync.md) in Developer's section for more details.
...
In order to edit AEM Mobile content, *AEM authors *will need a solid understanding of AEM's content editiing interface: [Authoring pages in AEM.](/help/sites/authoring/using/page-authoring.md)
...
>
>See [Mobile Quickstart for AEM Verify](/help/mobile/using/phonegap-mobile-quickstart.md) for more details on AEM Verify app.
