...
>[!NOTE]
>
>Before you get started with AEM Mobile using Adobe PhoneGap, make sure you setup your environment and get started with the [AEM Mobile Application Dashboard](/help/mobile/using/phonegap-authoring-apps.md).

The following resources will help you get started with AEM Mobile using Adobe PhoneGap:

* [Developing Mobile Applications in AEM](/help/mobile/using/developing-mobile-applications.md)
* [Mobile with Content Sync](/help/mobile/using/phonegap-contentsync.md)
* [Page Templates](/help/mobile/using/phonegap-apps-arch-page-templates.md)
...
* [AEM Mobile Content Services: An Overview](/mobile/using/content-as-a-service.md)
    ...
    * To learn about Creating Models, see [Developing Models](/help/mobile/using/models-in-repository.md)
    * To learn about Rendering and Delivery, see [Rendering and Delivery of Content Services](/help/mobile/using/rendering-and-delivery.md)

>[!NOTE]
>
>To run your AEM mobile applications on any iOS or Android mobile device, see [Mobile Quickstart using AEM Verify App](/help/mobile/using/phonegap-mobile-quickstart.md).
