...
* If creating a Teaser:
    ...
    1. [Create a teaser experience](/help/sites-authoring/campaigns.md).
    1. [Add content to your teaser](/help/sites-authoring/campaigns.md).
    1. [Create a Touchpoint for your Teaser](/help/sites-authoring/campaigns.md) (add your teaser to a content page).

* If creating a Newsletter:

    1. [Create a newsletter experience](/help/sites-authoring/campaigns.md).
    1. [Add content to the newsletter.](/help/sites-authoring/campaigns.md)
    1. [Personalize the newsletter.](/help/sites-authoring/campaigns.md)
    1. [Create a compelling newsletter landing page](/help/sites-authoring/campaigns.md).
    1. [Send the newsletter](/help/sites-authoring/campaigns.md) to subscribers or leads.

* If creating an Adobe Target (formerly Test&Target) Offer:

    1. [Create an Adobe Target offer experience](/help/sites-authoring/campaigns.md).
    1. [Integrate with Adobe Target](/help/sites-authoring/target-offers.md).
...
* [Creating a Teaser](/help/sites-authoring/campaigns.md)
* [Creating a Newsletter](/help/sites-authoring/campaigns.md)
* [Creating an Adobe Target Offer](/help/sites-authoring/campaigns.md)
...
* [Teaser](/help/sites-authoring/campaigns.md):

    * [Connect the teaser page to visitor segments.](/help/sites-authoring/campaigns.md)
    * [Create a Touchpoint for your Teaser](/help/sites-authoring/campaigns.md) (add your teaser to a content page).

* [Newsletter](/help/sites-authoring/campaigns.md):

    * [Add content to the newsletter.](/help/sites-authoring/campaigns.md)
    * [Personalize the newsletter.](/help/sites-authoring/campaigns.md)
    * [Send the newsletter](/help/sites-authoring/campaigns.md) to subscribers or leads.
    * [Create a compelling newsletter landing page](/help/sites-authoring/campaigns.md).

* [Adobe Target Offer](/help/sites-authoring/campaigns.md):
