...
uuid: 79f82258-fc67-49d3-8277-a95c7bef0841
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: 2e42fac5-7851-436b-a79c-6b47299db59a
---
...
* [Teasers and Strategies](/help/sites-authoring/teasers-and-strategies.md)
* [E-mail Marketing](/help/sites-authoring/email-marketing.md)
* [Landing Pages](/help/sites-authoring/landingpages.md)
* [Target offers](/help/sites-authoring/target-offers.md)
* [Working with the Marketing Campaign Manager](/help/sites-authoring/marketing-campaign-manager.md)
* [Understanding Segmentation](/help/sites-authoring/segmentation-overview.md)
* [Setting up your campaign](/help/sites-authoring/setting-up-your-campaign.md)
...
* **Experiences** 
  The focused content forms the various experiences, presented to the visitor at **Touchpoints**. There are several types of experience available:
    ...
    * **Teasers** 
      [Teaser Pages / Paragraphs](/help/sites-authoring/teasers-and-strategies.md) are used to steer specific visitor **Segments** to content that is focused on their interests.  
      Teaser pages can:
