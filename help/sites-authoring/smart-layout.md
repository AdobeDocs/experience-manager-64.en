...
* [Create a new page with the targeting and smart layout containers, the latter holding experience fragments](/help/sites-authoring/smart-layout.md#create-a-page-with-containers).
* [Create an activity](/help/sites-authoring/smart-layout.md#create-an-activity).
* [Configure targeting](/help/sites-authoring/smart-layout.md#configure-targeting).
