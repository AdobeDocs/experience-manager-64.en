...
The Rich Text Editor provides a range of featues, these [depend on the configuration](/help/sites/administering/using/rich-text-editor.md) of the individual component. The features are available for both the touch-optimized and classic UI.
