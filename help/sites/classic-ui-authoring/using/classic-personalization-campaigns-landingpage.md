...
The Text component lets you enter a text block using a WYSIWYG editor. See [Text component](/help/sites/authoring/using/default-components.md#text) for more information.
...
The title component lets you display a title and configure the size (h1-6). See [Title component](/help/sites/authoring/using/default-components.md#title) for more information.
...
>
>Not all options are available to all lead form components. See Forms for more information on these [common settings](/help/sites/authoring/using/default-components.md#formsgroup).
