...
uuid: 02388ca5-6aaf-45d9-9d56-fcafe530bea8
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 46c7159c-d82a-474b-9ab6-0f514c21363d
index: y
internal: n
snippet: y
---
...
![Edit dialog of the Image component in the classic UI; shows the Alt Text field.](assets/chlimage_1-21.png)
...
![An example of the Paragraph element shown in source edit mode (classic UI).](assets/chlimage_1-22.png)
...
* **Using headings:**
  ...
  ![Headings H1 through to H3 shown in the drop down selector (classic UI).](assets/chlimage_1-23.png)
...
* **Use tables**:
  ...
  ![Table properties dialog.](assets/chlimage_1-24.png)
...
![Title and Text tab (edit dialog); the title ‘Description’ has been added.](assets/chlimage_1-26.png)
...
![Image button with the Alt Text set in the Title field (edit dialog).](assets/chlimage_1-27.png) 
...
![Adding items to the radio group. The group title is 'Contact me by' - defined in the Title field.](assets/chlimage_1-28.png)
...
![Adding additional information (the word required) for screen reader users in the ‘Title’ field.](assets/chlimage_1-29.png)
