...
uuid: eda7a1f1-c455-4db6-a6d5-4a24d5fceadb
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: introduction
content-type: reference
discoiquuid: 2ec20cc9-03bd-4a7f-9ca1-82c6ce79a234
...
* A specialized inbox for workflow items is described in the [Participating in Workflows](/sites/classic-ui-authoring/using/classic-workflows-participating) document.
