...
* The title appears in the [Sidekick](/help/sites/classic-ui-authoring/using/author-env-basic-handling.md#sidekick), from where authors can access them to work on them.
...
1. In the **Create Launch** dialog, specify values for the following properties:
    ...
    * **Keep In Sync**: Select this option to automatically update the content of launch pages when the source pages change. This is achieved by making the launch a [live copy](/help/sites/administering/using/msm.md).
...
1. In the [launches console](/help/sites/classic-ui-authoring/using/classic-launches.md), select the required launch.
