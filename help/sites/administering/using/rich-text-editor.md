...
![Inline editing with basic toolbar in Touch-enabled UI](assets/chlimage_1-238.png)
...
![The detailed RTE toolbar when editing in full screen mode in Touch-enabled UI](assets/chlimage_1-239.png) 
...
>[!MORE_LIKE_THIS]
>
>* [Configure RTE plug-ins](../../../sites/administering/using/configure-rich-text-editor-plug-ins.md)
