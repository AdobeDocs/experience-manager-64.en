...
uuid: 19ffa8e7-293d-42ec-81a4-95347c008020
contentOwner: asgupta
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: 52dd5ffd-cf5c-4989-93f5-ca087be107d2
index: y
internal: n
snippet: y
---
...
![Rich Text Editor toolbar in Touch-enabled UI](assets/chlimage_1-282.png)
...
![Inline editing with basic toolbar in Touch-enabled UI](assets/chlimage_1-283.png)
...
![The detailed RTE toolbar when editing in full screen mode in Touch-enabled UI](assets/chlimage_1-284.png)
...
![Dialog box in Classic UI that contains detailed toolbar for editing](assets/chlimage_1-285.png)
