...
To redirect the output to a separate log file, see [How to audit user management operations in AEM](/help/sites/administering/using/audit-user-management-operations.md).
...
To enable SSL by default, see [SSL by default](/help/sites/administering/using/ssl-by-default.md).
