...
uuid: 1fa1e76d-a4f0-42a9-8add-f4fdd2959660
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: 4e882932-6837-4d71-a881-1dfb9ea47537
index: y
internal: n
snippet: y
---
...
* The **Text** component in the touch-optimized UI:
  ...
  ![Text component (RTE) in full-screen-mode in the touch-optimized UI.](assets/chlimage_1-245.png)

* The **Text** component in the classic UI:

  ![Edit dialog (RTE) of the text component in the classic UI.](assets/chlimage_1-246.png)
...
![CRXDE Lite showing an example rtePlugin.](assets/chlimage_1-247.png) 
...
1. The paragraph formats are then available to the content author from the selection fields in the RTE. They can be accessed:
   ...
   ![Paragraph (pilcrow) icon.](assets/chlimage_1-248.png)
