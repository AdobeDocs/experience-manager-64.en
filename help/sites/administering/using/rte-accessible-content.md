...
uuid: 32e5c0e2-6028-405b-8b5f-9ba4faf24ad2
...
discoiquuid: 9df517a4-d202-4bd0-a3e8-37eb4c2cb75e
...
* The **Text** component in the touch-optimized UI:
  ...
  ![Text component (RTE) in full-screen-mode in the touch-optimized UI.](assets/chlimage_1-200.png)

* The **Text** component in the classic UI:

  ![Edit dialog (RTE) of the text component in the classic UI.](assets/chlimage_1-201.png)
...
![CRXDE Lite showing an example rtePlugin.](assets/chlimage_1-202.png) 
...
1. The paragraph formats are then available to the content author from the selection fields in the RTE. They can be accessed:
   ...
   ![Paragraph (pilcrow) icon.](assets/chlimage_1-203.png)
