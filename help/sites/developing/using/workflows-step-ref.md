...
uuid: a1f542de-b946-4a75-a453-c1a1ba7c1569
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: 2fc2d3df-7e0b-430f-9a60-5b5c5799be05
...
* **Workflow Stage  
  **A drop down selector to apply a [Stage](/sites/developing/using/workflows#WorkflowStages) to the step.  
...
* Edit the **OR Split Properties**:
  ...
  >[!NOTE]
  >
  >See [Defining a Rule for an OR Split](/sites/developing/using/workflows-models#DefiningaRuleforanORSplit).
...
* **Process**
    ...
    * **Process**: The process implementation to execute. Use the drop-down menu to select the ECMAScript or OSGi service. For information about:
        ...
        * Creating ECMAScripts for a Process step, see [Implementing a Process Step with an ECMAScript](/sites/developing/using/workflows-customizing-extending#UsingECMAScript).
        * Creating OSGi services for a Process step, see [Implementing a Process Step with a Java Class](/sites/developing/using/workflows-customizing-extending#ImplementingaProcessStepwithaJavaClass).
