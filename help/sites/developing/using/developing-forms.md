...
uuid: 5872fb8a-bc69-45b1-b8e6-a692a538a380
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: components
content-type: reference
discoiquuid: 3d01068f-4ef6-48d2-b5f2-b22f50069776
disttype: dist5
gnavtheme: light
...
>[!NOTE]
>
>This document focuses on developing forms using the [Foundation Components](../../../sites/authoring/using/default-components-foundation.md) in the classic UI. Adobe recommends leveraging the new [Core Components](/content/help/en/experience-manager/core-components/user-guide) and [Hide Conditions](../../../sites/developing/using/hide-conditions.md) for form development in the touch-enabled UI.
...
The **Items Load Path** is the path to node properties that is used to load predefined values into that specific field on the form, for example, a [drop down list](../../../sites/authoring/using/default-components-foundation.md#main-pars-title-25), [check box group](../../../sites/authoring/using/default-components-foundation.md#main-pars-title-57) or [radio group](../../../sites/authoring/using/default-components-foundation.md#main-pars-title-30).
