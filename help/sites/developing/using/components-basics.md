...
uuid: 1b338965-751e-4304-82f9-fa1571e832ec
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: components
content-type: reference
discoiquuid: 173800b5-5e78-471d-a23d-037d60de756b
...
* **Vital Properties**:
    ...
    * Touch UI
        ...
        * See the section [Component Icon in Touch UI](../../../sites/developing/using/components-basics.md#main-pars-title-4779) for details.
...
The [Component Console](../../../sites/authoring/using/default-components-console.md#main-pars-title-1913426132) displays how the icon for a particular component is defined.
