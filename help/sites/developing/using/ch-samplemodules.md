...
uuid: bec6f613-6b3a-4e7e-a779-9d89d88ff270
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: personalization
content-type: reference
discoiquuid: 5cecd7b8-6207-4e65-bb57-d66f68f21217
index: y
internal: n
snippet: y
---
...
For information about adding UI modules to ContextHub, see [Adding a UI Module](../../../sites/administering/using/contexthub-config.md#main-pars-title-2108758587). For information about developing UI modules, see [Creating ContextHub UI Module Types](../../../sites/developing/using/ch-extend.md#main-pars-title-2121301991).
...
The following example configures a contexthub.base UI module to display information from a [contexthub.emulators](../../../sites/developing/using/ch-samplestores.md#main-pars-title-427753803) store. The `template` item demonstrates how to obtain data from the store by using the key that the `storeMapping` item establishes.
