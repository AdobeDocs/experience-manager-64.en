...
uuid: b400344d-02c3-4d50-8b0e-36b490713d5f
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: platform
discoiquuid: 8dd6c10a-7a19-4038-aecc-d9fb2700cc7c
index: y
internal: n
snippet: y
---
...
1. The cart contents schema is fixed by the API:
...
1. The pricing schema is also fixed by the API:
...
1. However, order details are *not* fixed by the API:
