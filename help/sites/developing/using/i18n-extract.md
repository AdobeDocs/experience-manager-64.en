...
uuid: e785f45c-fabf-4c6b-ae66-62e5cc567a3c
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: components
discoiquuid: e023caa5-4f7b-42f6-a707-dfd4fa970edd
...
<table border="1" cellpadding="1" cellspacing="0" width="100%"> 
 <tbody> 
  ...
  <tr> 
   <td><span class="code">{ /exclude "/content/*" }<br /> { /include "/content/catalogs/geometrixx/templatepages" }<br /> { /include "/content/catalogs/geometrixx/templatepages/*" }</span></td> 
