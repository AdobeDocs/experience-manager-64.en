...
uuid: c3db7e53-057a-44ba-b076-f8a2bd5f99c5
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: platform
content-type: reference
discoiquuid: b6128a1a-77bf-4c75-9f15-d7d2f110b6ed
---
...
The global also declares the [Sling library](../../../sites/developing/using/taglib.md#main-pars-par13).
...
>[!CAUTION]
>
>`<cq:includeClientLib>` has been deprecated since AEM 5.6. [ `<ui:includeClientLib>`](../../../sites/developing/using/taglib.md#main-pars-title-1565813984) should be used instead. ``
