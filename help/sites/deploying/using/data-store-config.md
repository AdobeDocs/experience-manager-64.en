...
uuid: e158dc1b-7c6f-40d9-8a4b-fd6c2cd46567
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: deploying
discoiquuid: efa1b149-928a-43fa-b746-f014914e90de
...
1. Modify the data store configuration files on each instance to point to the same data store. For more information, see [this article](../../../sites/deploying/using/data-store-config.md#main-pars-title-5).
