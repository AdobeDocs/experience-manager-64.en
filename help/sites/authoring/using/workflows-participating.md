...
uuid: 0bad10f4-be24-42cb-9e13-0c18a4888a3b
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: site-features
discoiquuid: b7783254-1e95-4ef1-9bc8-edf084ae1ef6
...
* **WORKFLOW INFO**
  ...
  If [Workflow Stages](/sites/developing/using/workflows#WorkflowStages) have been configured for the model, you can view the progress according to these:
