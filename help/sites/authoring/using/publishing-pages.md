...
uuid: 56c87b83-5771-4a14-849e-9de4c44aad00
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: da59b99a-507f-42a3-bd6e-cfe97ebcb0e4
index: y
internal: n
snippet: y
---
...
>* This [workflow may have been customized](/sites/developing/using/workflows-models#main-pars_procedure_6fe6) by your development team.
...
1. If the published pages are associated with workflows, they may be shown in a final **Workflows** step of the publication wizard.
    ...
    * Keep the workflow package, provided that the workflow has [multi-resourse support](/sites/developing/using/workflows-models#main-pars_title_8277).
