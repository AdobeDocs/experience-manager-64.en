...
uuid: 8315b753-d9fd-4f00-b70a-d7d2a1486794
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 2afee311-437d-4e14-b5db-c4e8e6f5eac3
index: y
internal: n
snippet: y
---
...
* **Use tables**:
  ...
  ![Table properties dialog.](assets/chlimage_1-248.png)
  ...
  ![Call properties dialog; setting a row (usually the first one) as a header row.](assets/chlimage_1-249.png)
...
![Title and Text tab (edit dialog); the title ‘Description’ has been added.](assets/chlimage_1-250.png)
...
![Image button with the Alt Text set in the Title field (edit dialog).](assets/chlimage_1-251.png) 
...
![Adding items to the radio group. The group title is 'Contact me by' - defined in the Title field.](assets/chlimage_1-252.png)
...
![Adding additional information (the word required) for screen reader users in the ‘Title’ field.](assets/chlimage_1-253.png)
