...
If your launch is based upon a [live copy](/help/sites/administering/using/msm.md) then you will:
...
See [Changing Live Copy Content](/help/sites/administering/using/msm-livecopy.md#changing-live-copy-content) for further information.
...
1. In the **Sites** console, [navigate to the source page of your launch and select it](/help/sites/authoring/using/basic-handling.md#viewing-and-selecting-resources).
1. Open the ** [References](/help/sites/authoring/using/basic-handling.md#references)** panel and select **Launches**.
...
1. Access and select the launch from either:
    ...
    * [References (Sites console)](/help/sites/authoring/using/launches.md#launches-in-references-sites-console) to show the available actions:
...
1. Make your required changes, then confirm with **Save**.
   ...
   See [Launches - the Order of Events](/help/sites/authoring/using/launches.md#launches-the-order-of-events) for information about the purpose and interaction of the **Launch Date** and **Production Ready** fields.

## Discovering the Launch Status of a Page {#discovering-the-launch-status-of-a-page}

The status is shown when you select a specific launch from the references tab (see [Launches in References (Sites Console)](/help/sites/authoring/using/launches.md#launches-in-references-sites-console)).
