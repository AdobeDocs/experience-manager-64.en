...
uuid: 0f26d121-8999-4639-9cd9-a484fb7db908
acrolinxdate: 2019-01-12T17 11 39.266-0500
acrolinxlastcheckedby: asgupta
acrolinxpagestatus: yellow
acrolinxreporturl: http //acrolinx.corp.adobe.com 8031/output/en/asset_templates_krs_workflow_f3c2f2ccebf6138e_87_report.xml
...
discoiquuid: ed955e2a-44fd-4a12-b518-d896fbbe8d0e
disttype: dist5
gnavtheme: light
...
1. To open the collateral for editing, do one of the following:
    ...
    * Open the collateral (brochure in this case) you created in step 7 of [Creating a Collateral](../../assets/using/asset-templates.md#main-pars-title).
