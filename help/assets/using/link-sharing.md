...
uuid: 9941df26-424c-414e-ba84-3e72e6c18809
acrolinxdate: 2019-01-12T17 31 07.024-0500
acrolinxlastcheckedby: asgupta
acrolinxpagestatus: yellow
acrolinxreporturl: http //acrolinx.corp.adobe.com 8031/output/en/link_sharing_krs_workflow_f3c2f2ccebf6138e_149_report.xml
...
discoiquuid: 92796ad2-f351-4cde-a3c2-9c6374e212a0
...
>[!NOTE]
>
>Before you share a link with users, ensure that Day CQ Mail Service is configured. An error occurs if you attempt to share a link without first [configuring Day CQ Mail Service](../../assets/using/link-sharing.md#main-pars-title).
...
1. From the toolbar, click/tap the **[!UICONTROL Share Link]** ![](assets/assets_share.png)
   ...
   ![Dialog with the Link Share](assets/chlimage_1-507.png)
...
1. In the email address box of the **[!UICONTROL Link Sharing]** dialog, type the email ID of the user you want to share the link with. You can also share the link with multiple users.
   ...
   To enable emails to be sent out to users, configure the SMTP server details in [Day CQ Mail Service](../../assets/using/link-sharing.md#main-pars-title).

   ![Share links to assets directly from the Link Sharing dialog](assets/chlimage_1-508.png)
