...
uuid: d6fa9fd8-722a-48d4-a69c-c2a7cf2bbac3
contentOwner: Chiradeep Majumdar
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
topic-tags: administering
content-type: reference
discoiquuid: f2c40f07-9e66-4a0d-a32d-d80c8001c10e
index: y
internal: n
snippet: y
---
...
1. From the toolbar, click/tap the **[!UICONTROL Share Link]** ![](assets/assets_share.png).
   ...
   ![Dialog with the Link Share](assets/chlimage_1-495.png)
...
1. In the email address box of the **[!UICONTROL Link Sharing]** dialog, type the email ID of the user you want to share the link with. You can also share the link with multiple users.
   ...
   ![Share links to assets directly from the Link Sharing dialog](assets/chlimage_1-496.png)
