...
uuid: d3721cd1-c176-436a-8609-b77b47fac840
acrolinxdate: 2019-01-12T17 34 46.016-0500
acrolinxlastcheckedby: asgupta
acrolinxpagestatus: yellow
acrolinxreporturl: http //acrolinx.corp.adobe.com 8031/output/en/performance_tuning_guidelines_krs_workflow_f3c2f2ccebf6138e_189_report.xml
...
discoiquuid: 6c305a50-e00f-4e6f-ac81-afd12a0c7227
...
From AEM 6.1 SP1, if you're using a `sling:osgiConfig` node for configuring this property, make sure to set the data type to Long. For more details, see [CQBufferedImageCache consumes heap during Asset uploads](/content/help/en/experience-manager/kb/cqbufferedimagecache-consumes-heap-during-asset-uploads).
...
s3EndPoint= [s3.amazonaws.com](http://s3.amazonaws.com/)  
...
[](assets/disable_indexingbinarytextextraction-10.zip)
