...
Best practices white paper [Sharpening images in Adobe Scene7 Publishing System and on Image Server](https://microsite.omniture.com/t2/help/en_US/s7/sharpening/s7_sharpening_images.pdf) applies to AEM as well.
...
* Unsharp masking ( `&op_USM`) - Unsharp masking is an industry standard sharpening filter. The best practice is to sharpen images with unsharp masking following the guidelines below. Unsharp masking lets you control the following three parameters:
    ...
    * `&op_sharpen=`amount,radius,threshold
      ...
      Best practices white paper [Sharpening images in Adobe Scene7 Publishing System and on Image Server](https://microsite.omniture.com/t2/help/en_US/s7/sharpening/s7_sharpening_images.pdf).
