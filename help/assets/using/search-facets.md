...
uuid: c1267b02-1ae6-4764-b9e0-d9a65e7d9651
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
topic-tags: administering
content-type: reference
discoiquuid: 20d2f0ad-09e8-45f9-b195-e35aecfd39ba
index: y
internal: n
snippet: y
---
...
![Value property of a file type, as seen in CRXDE, is used for search queries to work](assets/chlimage_1-419.png)
...
1. Specify tags based on which you want to search assets or select from the list of suggestions.
   ...
   ![AEM-provided suggestion when typing name of tag](assets/chlimage_1-420.png)
