...
uuid: 088361fc-fb06-4fb3-8161-7adb6eb51d23
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
topic-tags: administering
content-type: reference
discoiquuid: 15338294-bf09-46fe-b030-e2714f538bea
index: y
internal: n
snippet: y
---
...
![Value property of a file type, as seen in CRXDE, is used for search queries to work](assets/chlimage_1-424.png)
...
1. Specify tags based on which you want to search assets or select from the list of suggestions.
   ...
   ![AEM-provided suggestion when typing name of tag](assets/chlimage_1-425.png)
