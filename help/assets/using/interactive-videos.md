...
uuid: bfafd059-5425-4be2-8305-850e63030af7
acrolinxdate: 2019-01-12T17 30 57.903-0500
acrolinxlastcheckedby: asgupta
acrolinxpagestatus: yellow
acrolinxreporturl: http //acrolinx.corp.adobe.com 8031/output/en/interactive_videos_krs_workflow_f3c2f2ccebf6138e_146_report.xml
acrolinxsentences: 448
acrolinxwords: 6699
contentOwner: Rick Brough
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
topic-tags: dynamic-media
content-type: reference
discoiquuid: 2c956f90-b5d4-408e-9bee-1f92846685ed
    ...
    <table border="1" cellpadding="1" cellspacing="0" height="263" width="541"> 
     <tbody> 
      <tr> 
       ...
       <td valign="top" width="82.96422487223168%"><span class="code">s7interactivevideoviewer.setHandlers({<br /> "quickViewActivate": function(inData) {<br /> var quickViewUrl = "http://server/json?productId=" + inData.sku + "&amp;source=100";<br /> },<br /> });</span></td> 
      </tr> 
      <tr> 
       <td valign="top" width="17.035775127768314%">Single SKU, found in the URL path</td> 
       <td valign="top" width="82.96422487223168%"><span class="code">s7interactivevideoviewer.setHandlers({<br /> "quickViewActivate": function(inData) {<br /> var quickViewUrl = "http://server/product/" + inData.sku;<br /> },<br /> });</span></td> 
      </tr> 
      <tr> 
       <td valign="top" width="17.035775127768314%"><p>SKU and category ID in the query string</p> </td> 
       <td valign="top" width="82.96422487223168%"><span class="code">s7interactivevideoviewer.setHandlers({<br /> "quickViewActivate": function(inData) {<br /> var quickViewUrl = "http://server/quickView/product/?category=" + inData.categoryId + "&amp;prodId=" + inData.sku;<br /> },<br /> });</span></td> 
      </tr> 
     </tbody> 
    </table> </td> 
  </tr> 
