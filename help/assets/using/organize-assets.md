...
You can use folders or tags or both to organize assets. Adding tags to assets makes them more easy to retrieve during a search. See [Tagging](/help/sites/authoring/using/tags.md) for more information on tagging.
