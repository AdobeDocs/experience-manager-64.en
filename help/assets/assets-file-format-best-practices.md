...
description: Best practices for file support in [!DNL Experience Manager] Assets.
contentOwner: AG
...
For more information, see [Camera Raw support](camera-raw.md) in [!DNL Assets].
...
Adobe recommends that you use Adobe InDesign server to extract Adobe InDesign-specific renditions, such as IDML and HTML. For more information, see [Adding [!DNL Experience Manager] assets as references in Adobe InDesign](managing-linked-subassets.md#add-aem-assets-as-references-in-adobe-indesign).
...
To know how to set up the ImageMagic library in [!DNL Experience Manager], see [Using ImageMagick](media-handlers.md#an-example-using-imagemagick). For optimum usage, see [Best Practices for Configuring ImageMagick](best-practices-for-imagemagick.md).
