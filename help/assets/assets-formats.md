...
| Asset <br> Management <br> Features | | | | | | | |Dynamic<br> Media<br> Features | | | | |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
|| Storage | Metadata<br> management |Metadata <br> extraction | Thumbnail<br> generation |Interactive <br>editing | Metadata<br> writeback | Insights | Upload<br> (Input format) | Create<br> image<br> preset<br> (Output format) | Preview<br> dynamic<br> rendition | Deliver<br> dynamic<br> rendition | Download<br> dynamic<br> rendition |
| **Format** |||||||||||||
