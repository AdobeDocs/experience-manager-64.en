...
| Feature   |Description  | [!DNL Workfront] and [!DNL Assets Essentials] | [!DNL Workfront for Experience Manager enhanced connector] |
|----|----|----|-----|
...
| Automatically Create Linked AEM Folders in Workfront    | Automatically create linked AEM folders in Workfront using object statuses. Automatically, organize AEM folders based on Workfront Portfolios, Programs, and Projects.   | No  | &#10003;  |
...
| Automatically Create Document Custom Forms in Workfront | Attach custom forms to Workfront documents, tasks, and issues using AEM workflows.| No  | &#10003;  |
...
| AEM Metadata Updates with New Versions| A configuration in AEM can be made to determine whether a newly versioned asset in Workfront also pushes with any changes made to its metadata.  | No  | &#10003;  |
...
| Set Status on Workfront Objects  | Set Workfront object statuses based configurable conditions using AEM workflows| No  | &#10003;  |
| Publish Assets to AEM Publish Environment or Brand Portal| Give Workfront users the option to automatically publish linked assets to an AEM Publish environment or Brand Portal. | No  | &#10003;  |
