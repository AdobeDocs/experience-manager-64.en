...
3. In the **Create Configurations** dialog:
...
5. Click **Connect to Adobe Analytics**. When the message that indicates that the connection was successful appears, click **OK**.
