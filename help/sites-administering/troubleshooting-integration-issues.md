...
Firstly, analyzing the ` [error.log](/sites-deploying/configure-logging.htm)` might give you some insight about the amount of active or registered PollingImporters. For example:
