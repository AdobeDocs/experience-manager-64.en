...
uuid: 1ea367f8-95c8-4660-84e5-4ec10abad32e
...
discoiquuid: 0242b4ed-e9eb-467c-8928-06824b6da8a3
...
sha1: e55feaf0cd9eb2f0e3396d46f2ef7b794a807f4b
...
For further information see [AEM Logging](configure-logging.md) and [Sling Logging](http://sling.apache.org/site/logging.html).
...
For further information see [AEM Logging](configure-logging.md#GlobalLogging) and [Sling Logging](http://sling.apache.org/site/logging.html).
...
See the [Security Checklist - Issues with Cross-Site Request Forgery](/content/help/en/experience-manager/6-4/sites/administering/using/security-checklist#main-pars_title_1046104842) for further details.
...
When using [closed user groups](/content/help/en/experience-manager/6-4/sites/administering/using/cug) you can configure (amongst others):
...
There are [two UIs](/content/help/en/experience-manager/6-4/sites/authoring/using/author-environment) available in AEM:
...
See [Version Purging](version-purging.md) for more information.
...
See also [Enabling HTTP Over SSL](config-ssl.md) for details on the SSL-related options and a complete description on how to enable HTTPS for CQSE.
