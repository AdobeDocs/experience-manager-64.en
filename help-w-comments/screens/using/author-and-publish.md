...
uuid: 16b52e8f-5a3e-4115-a5c1-88f7f8a9fc80
contentOwner: jsyal
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/SCREENS
topic-tags: authoring
discoiquuid: 4c77c84d-1908-41b8-832b-4c7784261653
index: y
internal: n
snippet: y
---
...
<!--
Comment Type: annotation
Last Modified By: rpapani
Last Modified Date: 2019-02-07T17:01:23.659-0500
Could you please update this section to use 'Edit Server Url' action from the device management console?
-->
...
1. Click **Publish **from the** Manage **Publication wizard.** **
   ...
   Comment Type: annotation
   Last Modified By: rpapani
   Last Modified Date: 2019-02-07T17:05:29.576-0500
   we don't have to select the channel, we can simply publish could you please move the update offline content to step 5 to make it look explicit?
   -->
