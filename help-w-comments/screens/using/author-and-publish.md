...
Last Modified By: rachan
Last Modified Date: 2019-02-25T19:12:34.800-0500
Should be "6.4" FP2 instead of "6.3" FP2.
-->
...
Comment Type: annotation
Last Modified By: rachan
Last Modified Date: 2019-02-25T19:18:06.699-0500
Publish instance can use any available port number (so, not necessary using 4505 for pub2). I prefer here to use 4503 and 4504. But this document need to update/ replace the port number wherever mentioned 4505. Publish (pub1) --> localhost:4503 Publish (pub2) --> localhost:4504
-->
...
1. Navigate to the **Transport** tab and enter the **URI**, **User** and **Password**.
   ...
   Comment Type: annotation
   Last Modified By: rachan
   Last Modified Date: 2019-02-25T19:22:54.380-0500
   @Ray, should I add what is URI? Can you please provide some brief description, if we need to? @Jyotika, Yes, I have an instance with the basic 1-1 Author-Publish setup. Please copy the values of "Settings" and "Transport" tabs from my instance. http://scr-author1.corp.adobe.com:4502/etc/replication/agents.author/6.4.2FP4_default.html
   -->
...
Last Modified Date: 2019-03-01T13:02:46.231-0500
Not sure if we should also give example for the transport URI field. For pub1: http://
<hostname>
:4503/bin/receive?sling:authRequestLogin=1 For pub2: http://
<hostname>
:4504/bin/receive?sling:authRequestLogin=1 update the screenshot
</hostname>
</hostname>
-->
