...
uuid: 4ab50af7-f013-4439-a169-2d3a41276ab1
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.4/COMMUNITIES
topic-tags: developing
content-type: reference
discoiquuid: 16654b5e-f5af-40fa-b59d-69d0551d8c6f
index: y
internal: n
snippet: y
---
...
One of the more noticeable changes in the new framework is the use of the [Handlebars JS templating language (HBS)](http://www.handlebarsjs.com/), a popular open-source technology for server-client rendering.
...
**When using JSP**, a resource is included using the tag [cq:include](../../sites/developing/using/taglib.md#main-pars-title-6) :
