...
uuid: 2f1df4ec-81d6-4699-a8c5-da95249c378c
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4
topic-tags: release-notes
content-type: reference
discoiquuid: fac2fe35-33f1-4b81-a929-d85ca7a6b19d
...
<note type="note">
<p>The best way to monitor the installation process is to tail the error.log. Proceed to <a href="../release-notes/sp-release-notes.md#validate-installation">Validate installation</a> after the error.log goes quiet with "BundleEvent STARTED" messages</p>
</note>
-->
