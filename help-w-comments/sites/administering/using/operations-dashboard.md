...
uuid: 03364f41-a67a-4692-9e57-c431e01d37de
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: fe0bb771-96e3-4b3c-8bc5-d9f4141ff379
index: y
internal: n
snippet: y
---
...
<img imageRotate="0" src="assets/chlimage_1-433.png" />
-->
...
<li>Automatically adjusts settings for the OSGi services that might leak internal information if not configured correctly on publish instances. For more info, see <a href="../../../sites/administering/using/security-checklist.md#osgi-settings">this section</a> of the Security Checklist.</li>
</ul>
...
<p>Offline Revision Cleanup is the recommended and supported way of performing revision cleanup. For more details, see <a href="../../../sites/deploying/using/storage-elements-in-aem-6.md#performing-offline-revision-cleanup" target="_blank">Performing Offline Revision Cleanup</a>.</p>
-->
...
<li><p>Next, verify that the value for <strong>PausedCompaction</strong> is set to <span class="code">false</span>. This confirms that online revision cleanup is set to run:</p> <img imageRotate="0" src="assets/chlimage_1-444.png" /><p>Online revision cleanup is now scheduled to run as part of the tasks performed in the Daily Maintenance Window. For more info, see <a href="#automated-maintenance-tasks">Automated Maintenance Tasks</a>.</p> </li>
...
<img doNotLocalize="true" imageRotate="0" src="do-not-localize/chlimage_1-33.png" />
-->
...
<note type="note">
<p>The revision cleanup can also be triggered via the JMX Console or run from an external tool. For more info, please see <a href="../../../sites/deploying/using/storage-elements-in-aem-6.md#invoking-revision-garbage-collection-via-the-jmx-console" target="_blank">this page</a>.</p>
</note>
-->
