...
<note type="note">
<p>Instead of stopping CRX, you can also use calls to JMX MBeans to prevent CRX from writing to the disk, which reduces the time CRX is unavailable to seconds. This is described under <a href="../../../sites/administering/using/backup-and-restore.md#filesystem-snapshot-backup">Filesystem Snapshot Backup</a> below.</p>
</note>
-->
