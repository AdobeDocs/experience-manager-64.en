...
uuid: 46ad37c9-e774-4c59-9836-193ef2072cf3
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: Security
content-type: reference
discoiquuid: b7de7e9a-041d-4a80-9c78-2413a5fc0a52
index: y
internal: n
snippet: y
---
...
<p>To change the password for the other AEM user accounts you can use the <a href="../../../sites/administering/using/security.md#changing-a-user-password">User Management</a> console.<br /> </p>
</note>
-->
...
<p>Adobe also recommends that you either remove the example user <span class="code">author</span>, or (at minimum) disable it by changing the password; see the <a href="../../../sites/administering/using/security.md#changing-a-user-password">User Management documentation</a> for details on changing a user password.</p>
-->
