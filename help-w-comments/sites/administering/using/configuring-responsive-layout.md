...
uuid: 4eb303a3-44a9-4ec2-a8cf-67b5260e40bb
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: 1bb5679b-9a61-4d70-a2d1-3055f28be1a5
...
1. You can configure the number of columns available for each specific instance of layout container.
...
1. Definitions for the responsive grid are specified in:
