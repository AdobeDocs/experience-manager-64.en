...
uuid: a2d2e87e-c0d8-49a5-968e-a74e20337754
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: a1d68cdd-7a29-4b0d-82ce-4cc80821bbca
index: y
internal: n
snippet: y
---
...
* The **Text** component in the touch-optimized UI:
  ...
  ![Text component (RTE) in full-screen-mode in the touch-optimized UI.](assets/chlimage_1-259.png)

* The **Text** component in the classic UI:

  ![Edit dialog (RTE) of the text component in the classic UI.](assets/chlimage_1-260.png)
...
![CRXDE Lite showing an example rtePlugin.](assets/chlimage_1-261.png) 
...
1. The paragraph formats are then available to the content author from the selection fields in the RTE. They can be accessed:
   ...
   ![Paragraph (pilcrow) icon.](assets/chlimage_1-262.png)
