...
uuid: a104533a-1460-4a90-b114-3b1514696664
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: 6f18bd5b-de95-4034-8169-eaba71be9ffb
index: y
internal: n
snippet: y
---
...
* The **Text** component in the touch-optimized UI:
  ...
  ![Text component (RTE) in full-screen-mode in the touch-optimized UI.](assets/chlimage_1-217.png)

* The **Text** component in the classic UI:

  ![Edit dialog (RTE) of the text component in the classic UI.](assets/chlimage_1-218.png)
...
![CRXDE Lite showing an example rtePlugin.](assets/chlimage_1-219.png) 
