...
uuid: aad66c60-c499-419d-b905-9b3f3122169a
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: 002753e9-8d9e-4807-be78-e3e993fa1311
index: y
internal: n
snippet: y
---
...
* The **Text** component in the touch-optimized UI:
  ...
  ![Text component (RTE) in full-screen-mode in the touch-optimized UI.](assets/chlimage_1-251.png)

* The **Text** component in the classic UI:

  ![Edit dialog (RTE) of the text component in the classic UI.](assets/chlimage_1-252.png)
...
![CRXDE Lite showing an example rtePlugin.](assets/chlimage_1-253.png) 
...
1. The paragraph formats are then available to the content author from the selection fields in the RTE. They can be accessed:
   ...
   ![Paragraph (pilcrow) icon.](do-not-localize/chlimage_1-8.png)
