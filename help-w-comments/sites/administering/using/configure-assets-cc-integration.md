...
uuid: 32782570-6f4a-4934-99f0-5cc1849a768f
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: integration
content-type: reference
discoiquuid: 41032fa5-3134-4de3-ac9d-85f062e7a2a8
index: y
internal: n
snippet: y
---
...
![Flow of data when AEM Assets and Creative Cloud are integrated](assets/chlimage_1-299.png)
...
1. Click **[!UICONTROL Create]**. A message notifies that the application is created.
   ...
   ![Notification of successful creation of the application to integrate AEM Assets with Adobe CC](assets/chlimage_1-301.png)
...
1. In the **[!UICONTROL Create Configuration]** dialog, specify a title and name for the new configuration and click **[!UICONTROL Create]**.
   ...
   ![Name a new configuration to integrate AEM Assets and CC](assets/chlimage_1-302.png)
...
1. In the **[!UICONTROL Client ID]** field, paste the application ID you copied at the end of the procedure [Create an application](../../../sites/administering/using/configure-assets-cc-integration.md#create-an-application).
   ...
   ![Provide the application ID values required to integrate AEM Assets and CC](assets/chlimage_1-303.png)
...
1. In the dialog, click **[!UICONTROL Test Connection]**.
   ...
   ![Test connection and set the default replication profile for your organization](assets/chlimage_1-306.png)
