...
uuid: 57573b5f-8da4-4c56-8bc3-7dcb16621510
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: integration
content-type: reference
discoiquuid: 775dc490-b167-4f15-bcab-7437b182eb74
index: y
internal: n
snippet: y
---
...
![Flow of data when AEM Assets and Creative Cloud are integrated](assets/chlimage_1-352.png)
...
1. Click **[!UICONTROL Create]**. A message notifies that the application is created.
   ...
   ![Notification of successful creation of the application to integrate AEM Assets with Adobe CC](assets/chlimage_1-354.png)
...
1. In the **[!UICONTROL Create Configuration]** dialog, specify a title and name for the new configuration and click **[!UICONTROL Create]**.
   ...
   ![Name a new configuration to integrate AEM Assets and CC](assets/chlimage_1-355.png)
...
1. In the **[!UICONTROL Client ID]** field, paste the application ID you copied at the end of the procedure [Create an application](../../../sites/administering/using/configure-assets-cc-integration.md#main-pars-title).
   ...
   ![Provide the application ID values required to integrate AEM Assets and CC](assets/chlimage_1-356.png)
...
1. In the dialog, click **[!UICONTROL Test Connection]**.
   ...
   ![Test connection and set the default replication profile for your organization](assets/chlimage_1-359.png)
