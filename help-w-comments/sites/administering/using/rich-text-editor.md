...
uuid: 37108f42-b979-442a-bef8-16528666bb2e
contentOwner: asgupta
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: b0677190-be20-49a5-9a82-862bba2f99c1
index: y
internal: n
snippet: y
---
...
![Rich Text Editor toolbar in Touch-enabled UI](assets/chlimage_1-421.png)
...
![Inline editing with basic toolbar in Touch-enabled UI](assets/chlimage_1-422.png)
...
![The detailed RTE toolbar when editing in full screen mode in Touch-enabled UI](assets/chlimage_1-423.png)
...
![Dialog box in Classic UI that contains detailed toolbar for editing](assets/chlimage_1-424.png)
