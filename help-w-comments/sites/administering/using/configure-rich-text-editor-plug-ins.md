...
uuid: 73997de9-080d-49a1-8ec5-1a190cfad0ad
contentOwner: asgupta
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: 4091811a-5c9b-4e98-9fa4-ba4249b7d004
noindex: true
index: y
internal: n
snippet: y
...
1. Save the changes.
   ...
   ![In CRXDE, add a single character to be made available in the RTE toolbar](assets/chlimage_1-166.png)
...
1. Save the changes.
   ...
   ![In CRXDE, define a range of characters to be made available in RTE](assets/chlimage_1-167.png)
