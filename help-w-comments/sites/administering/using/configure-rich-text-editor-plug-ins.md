...
uuid: 1fb231c0-3b63-4641-b267-2d00ccce2372
contentOwner: asgupta
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: b39bfb0b-f7cb-42c8-87dd-914f657f07ff
noindex: true
index: y
internal: n
snippet: y
...
1. Save the changes.
   ...
   ![In CRXDE, add a single character to be made available in the RTE toolbar](assets/chlimage_1-465.png)
...
1. Save the changes.
   ...
   ![In CRXDE, define a range of characters to be made available in RTE](assets/chlimage_1-466.png)
