...
uuid: 3b6b3e16-bb8a-4a15-ac24-e237c0ae6938
contentOwner: asgupta
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: b5ba2624-20d4-48b8-b293-317bccddba4b
noindex: true
index: y
internal: n
snippet: y
...
1. Save the changes.
   ...
   ![In CRXDE, add a single character to be made available in the RTE toolbar](assets/chlimage_1-429.png)
...
1. Save the changes.
   ...
   ![In CRXDE, define a range of characters to be made available in RTE](assets/chlimage_1-430.png)
