...
uuid: 4b1800d8-9a48-41b7-9d2e-8813a93095ef
contentOwner: asgupta
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: operations
content-type: reference
discoiquuid: 304ae6f9-6215-45e7-83a0-82841c4e1e75
noindex: true
index: y
internal: n
snippet: y
...
1. Save the changes.
   ...
   ![In CRXDE, add a single character to be made available in the RTE toolbar](assets/chlimage_1-158.png)
...
1. Save the changes.
   ...
   ![In CRXDE, define a range of characters to be made available in RTE](assets/chlimage_1-159.png)
