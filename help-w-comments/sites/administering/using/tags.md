...
uuid: 8851209b-569e-4b40-9767-152d727eb7c2
contentOwner: Chiradeep Majumdar
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: content
content-type: reference
discoiquuid: 9567e007-787d-4ca1-b557-5db1a8c13712
index: y
internal: n
snippet: y
---
...
![](assets/chlimage_1-194.png) ![](assets/creating_tags_andnamespaces.png)
...
![](assets/chlimage_1-197.png) ![](assets/chlimage_1-198.png) 
...
<p>By default. the <span class="code">titles </span>of tags added as page properties are displayed in the page language. When using the Classic UI, the tag dialog in the page properties has a language field that enables the display of tag <span class="code">titles </span>in a different language. For instructions, see <a href="../../../sites/administering/using/classic-console.md#displaying-tag-titles-in-page-properties-in-a-specified-language">Classic UI Tagging Console.</a></p>
-->
