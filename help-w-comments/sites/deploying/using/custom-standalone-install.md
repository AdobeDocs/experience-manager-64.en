...
uuid: ee346ecd-abf7-4ccd-953c-97b8bddd4ba3
contentOwner: Tyler Rushton
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: deploying
discoiquuid: d10495d0-f69e-4bc0-adf6-87fc90b0aa71
index: y
internal: n
snippet: y
---
...
<ol>
<li><p>Create the new directory (<span class="code">&lt;<i>new-location</i>&gt;</span>) for the repository files.</p> <p>For example:</p>  </li>
...
<li><p>Start the installation procedure; files needed for the repository will be saved in the new location; for this example they will be under:</p>  </li>
</ol>
-->
