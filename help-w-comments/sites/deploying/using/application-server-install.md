...
uuid: 15e39bf0-ed9e-4db2-965e-04aa7e56350d
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: deploying
discoiquuid: a39a5d3a-bd4b-43e9-9b88-cb9054d3fd66
index: y
internal: n
snippet: y
---
...
<p>Before an upgrade read the <a href="#general-description">General Description</a> above.<br /> </p>
-->
...
<p><a href="/content/docs/en/aem/6-3/deploy/upgrade/upgrading-to-5-6-1.md#application server upgrade">Upgrading to AEM 5.6 with Application Servers</a></p>
-->
