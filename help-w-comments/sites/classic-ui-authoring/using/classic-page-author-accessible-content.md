...
uuid: 91e48996-ccdc-486b-b99f-02716b4428ed
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 9e14cb51-e884-454a-b8da-ebbdb43ef11d
index: y
internal: n
snippet: y
---
...
![Edit dialog of the Image component in the classic UI; shows the Alt Text field.](assets/chlimage_1-20.png)
...
![An example of the Paragraph element shown in source edit mode (classic UI).](assets/chlimage_1-21.png) 
...
* **Using headings:**
  ...
  ![Headings H1 through to H3 shown in the drop down selector (classic UI).](assets/chlimage_1-22.png)
...
* **Use tables**:
  ...
  ![Table properties dialog.](assets/chlimage_1-23.png) 

  <!--
  Comment Type: draft

  <img alt="Table properties dialog; setting the first row as a header row." imageRotate="0" src="assets/chlimage_1-24.png" />
  -->
  ...
  ![Call properties dialog; setting a row (usually the first one) as a header row.](assets/chlimage_1-25.png) 

  <!--
  Comment Type: draft

  <img alt="Call properties dialog; setting a row (usually the first one) as a header row." imageRotate="0" src="assets/chlimage_1-26.png" />
  -->
...
![Title and Text tab (edit dialog); the title ‘Description’ has been added.](assets/chlimage_1-27.png) 
...
![Image button with the Alt Text set in the Title field (edit dialog).](assets/chlimage_1-28.png) 
...
![Adding items to the radio group. The group title is 'Contact me by' - defined in the Title field.](assets/chlimage_1-29.png) 
...
![Adding additional information (the word required) for screen reader users in the ‘Title’ field.](assets/chlimage_1-30.png)
