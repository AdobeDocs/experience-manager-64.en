...
uuid: 69dadf7a-bce5-4d7f-aa1a-c535f9d16155
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: 7ec9111b-e94e-4113-993f-3db9aae8514c
index: y
internal: n
snippet: y
---
...
1. When the editor opens you can:
    ...
    * [Delete](../../../sites/authoring/using/editing-content.md#edit-configure-copy-cut-delete-paste) a component:
...
* Unpublishing a page from the console can only be done via the **Manage Publication** option, which is only available on the toolbar (not via the quick actions).
  ...
  See [Publishing Pages](../../../sites/authoring/using/publishing-pages.md#unpublishing-pages) for more information.
...
1. To open the Timeline rail, select ** [Timeline](../../../sites/authoring/using/basic-handling.md#timeline)** using the toolbar icon (either before or after [selecting your page](#selectingyourpageforfurtheraction)):
...
1. Select ** [Timeline](../../../sites/authoring/using/basic-handling.md#timeline)** using the toolbar icon (either before or after [selecting your page](#selectingyourpageforfurtheraction)):
