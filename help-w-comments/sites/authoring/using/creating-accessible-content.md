...
uuid: 98cdfe8d-af1d-464e-bee8-e2170a4ccaab
contentOwner: Chris Bohnert
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: page-authoring
content-type: reference
discoiquuid: b8841b04-57a4-4dbe-9e22-3ad48def481d
index: y
internal: n
snippet: y
---
...
* **Use tables**:
  ...
  ![Table properties dialog.](assets/chlimage_1-210.png) 

  <!--
  Comment Type: draft

  <img alt="Table properties dialog; setting the first row as a header row." imageRotate="0" src="assets/chlimage_1-211.png" />
  -->
  ...
  ![Call properties dialog; setting a row (usually the first one) as a header row.](assets/chlimage_1-212.png) 

  <!--
  Comment Type: draft

  <img alt="Call properties dialog; setting a row (usually the first one) as a header row." imageRotate="0" src="assets/chlimage_1-213.png" />
  -->
...
![Title and Text tab (edit dialog); the title ‘Description’ has been added.](assets/chlimage_1-214.png) 
...
![Image button with the Alt Text set in the Title field (edit dialog).](assets/chlimage_1-215.png) 
...
![Adding items to the radio group. The group title is 'Contact me by' - defined in the Title field.](assets/chlimage_1-216.png) 
...
![Adding additional information (the word required) for screen reader users in the ‘Title’ field.](assets/chlimage_1-217.png)
