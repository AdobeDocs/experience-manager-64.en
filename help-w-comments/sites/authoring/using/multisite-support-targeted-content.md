...
uuid: a625b55d-6b39-4dea-98dc-ef3c3ad8ea08
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: personalization
discoiquuid: 04e7938a-7f5e-4f81-ac50-e93ea291e4b7
index: y
internal: n
snippet: y
---
...
<img imageRotate="0" src="assets/chlimage_1-356.png" />
-->
...
1. If your page is linked to an area that is a live copy, you see the inheritance status. Tap or click **Start Targeting**.
   ...
   <img imageRotate="0" src="assets/chlimage_1-357.png" />
   -->
