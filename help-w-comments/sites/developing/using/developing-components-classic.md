...
uuid: 63bc2bf3-43f6-42c7-a5f2-550d4fef0390
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: components
content-type: reference
discoiquuid: 6444b1d2-a364-421c-bb23-7da7a70afb9f
...
1. Using CRXDE Lite, create a new component folder in:
   ...
   Last Modified Date: 2018-01-18T11:19:11.617-0500
   <p>to check - does the entire definition need to be copied, or only the bits to be overlaid<br /> </p>
   -->
   ...
   <note type="note">
   <p>It is recommended that you save your tree before copying the new component. You can do this by pressing the "Save All" button in the upper left corner of the CRXDE Lite console.<br /> </p>
   </note>
   -->
   ...
   Last Modified Date: 2018-01-18T11:19:11.685-0500
   <p>This step implies that the existing component needs to be copied into the app folder of a new project (from the /apps/&lt;myProject&gt;/ format). Naturally, a new project folder will be created in the apps dir to test the procedure.</p>
   <p> </p>
   <p>If the tree is not saved after creating the new folder, copying an existing component will result in a 404.<br /> </p>
   -->
...
1. Open the new component folder and make the changes you require. Also, delete any extraneous information in the folder.
   ...
   Comment Type: remark
   Last Modified By: Alison Heimoz (aheimoz)
   Last Modified Date: 2018-01-18T11:19:11.976-0500
   <p>to check, are there best practices for new components; eg is a dialog for the classic UI needed?<br /> </p>
   -->
...
1. Extend the component script, `textimage.jsp`, with extra handling of the new parameter:
   ...
   <p> </p>
   <p>1. Open the <span class="code">/apps/geometrixx/components/textimage/textimage.jsp</span> script for editing.</p>
   <p>2. We are going to manipulate the style of the <span class="code">div</span> tag, generated by the component, to float the image to the right. It is located in the following area of the code:</p>
   <p> </p>
   -->
   ...
   <p>3. Copy the following code fragment, and replace the <i>%&gt;&lt;div class="image" </i>section of the line with it:</p>
   -->
   ...
   <p>Make sure that you leave the rest of the tag intact, otherwise the script will not function.</p>
   <p>For simplicity, we are hard-coding the style to the HTML tag. The proper way to do it would be to add a new CSS class to the application styles and just add the class to the tag in the code in the case of a right-aligned image.</p>
   -->

   <!--
   Comment Type: remark
   Last Modified By: unknown unknown (sarchiz@adobe.com)
   Last Modified Date: 2018-01-18T11:19:14.017-0500
   <p>Updated code example to reflect what's in 5.6.1.20130606. Also, moved step 4 as a simple text footnote for the procedure.<br /> </p>
   <p> </p>
   <p> </p>
   -->
...
<p>The code fragment, after the change, should look like this:</p>
-->
...
&nbsp;String&nbsp;ddClassName&nbsp;=&nbsp;DropTarget.CSS_CLASS_PREFIX&nbsp;+&nbsp;"image";!!discoiqbr!!!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(image.hasContent()&nbsp;||&nbsp;WCMMode.fromRequest(request)&nbsp;==&nbsp;WCMMode.EDIT)&nbsp;{!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;image.loadStyleData(currentStyle);!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;add&nbsp;design&nbsp;information&nbsp;if&nbsp;not&nbsp;default&nbsp;(i.e.&nbsp;for&nbsp;reference&nbsp;paras)!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(!currentDesign.equals(resourceDesign))&nbsp;{!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;image.setSuffix(currentDesign.getId());!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;image.addCssClass(ddClassName);!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;image.setSelector(".img");!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;image.setDoctype(Doctype.fromRequest(request));!!discoiqbr!!!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;String&nbsp;divId&nbsp;=&nbsp;"cq-textimage-jsp-"&nbsp;+&nbsp;resource.getPath();!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;String&nbsp;imageHeight&nbsp;=&nbsp;image.get(image.getItemName(Image.PN_HEIGHT));!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;div&nbsp;around&nbsp;image&nbsp;for&nbsp;additional&nbsp;formatting!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%><div&nbsp;String&nbsp;style="";!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(properties.get("imagePosition",&nbsp;"left").equals("right"))&nbsp;{!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;style&nbsp;=&nbsp;"style=\"float:right\"";!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}&nbsp;&nbsp;id="<%=&nbsp;divId&nbsp;%>"><%!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%><%&nbsp;image.draw(out);&nbsp;%><br><%!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%><cq:text&nbsp;property="image/jcr:description"&nbsp;placeholder=""&nbsp;tagName="small"&nbsp;escapeXml="true"/><%!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%></div>!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%@include&nbsp;file="/libs/foundation/components/image/tracking-js.jsp"%>!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;}!!discoiqbr!!!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;String&nbsp;placeholder&nbsp;=&nbsp;(isAuthoringUIModeTouch&nbsp;&&&nbsp;!image.hasContent())!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;?&nbsp;Placeholder.getDefaultPlaceholder(slingRequest,&nbsp;component,&nbsp;"",&nbsp;ddClassName)!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;"";!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;%><cq:text&nbsp;property="text"&nbsp;tagClass="text"&nbsp;escapeXml="true"&nbsp;placeholder="<%=&nbsp;placeholder&nbsp;%>"/><div!!discoiqbr!!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;class="clear"></div>
</codeblock>
-->
