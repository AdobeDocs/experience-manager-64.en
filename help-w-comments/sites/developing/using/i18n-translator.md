...
uuid: d81d65f8-7fa4-4e96-96a9-9ca1a8d2e6c8
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
content-type: reference
topic-tags: components
discoiquuid: 594621e4-df60-4d45-8fa9-52e5afe53f55
index: y
internal: n
snippet: y
---
...
1. Fill the fields as required and click OK. ![](assets/chlimage_1-226.png)
...
Note that [the code that requests the translated string](../../../sites/developing/using/i18n-dev.md#main-pars-title-13) provides values for the indexed variables according to the context.
...
After you add the English string to a dictionary, you can add translations of the string. You can also [export the dictionary](../../../sites/developing/using/i18n-translator.md#main-pars-title-8) to have it translated by a third party.
