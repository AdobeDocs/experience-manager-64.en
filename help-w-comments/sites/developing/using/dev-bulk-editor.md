...
uuid: 8e149312-97d7-4f62-9bb4-7420599d3bbc
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: 8c9f49bf-2427-4bac-807f-d1cf58cd6a1c
index: y
internal: n
snippet: y
---
  ...
  <tr> 
   ...
   <td>Column metadata config. Possible properties are (applied to all cells of the column): <br /> 
    <ul> 
     ...
     <li>forcedPosition: integer value to specify where column must be placed in grid (between 0 and number of colums-1) </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
