...
uuid: a1ae6ed7-b58c-4f4e-b9c4-bf592f1c6665
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: 62d97fe5-947d-4f5c-8a25-35231f3b277a
index: y
internal: n
snippet: y
---
...
1. You can create a custom console with related actions; for example, Launches at the top level (below Sites):
   ...
   <img imageRotate="0" src="assets/chlimage_1-243.png" />
   -->
...
1. You can add a navigation entry in the rail (for example, a [custom console](#createacustomconsole) such as Launches).
   ...
   <img imageRotate="0" src="assets/chlimage_1-246.png" />
   -->
