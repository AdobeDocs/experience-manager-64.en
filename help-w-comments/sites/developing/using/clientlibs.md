...
uuid: 57afca31-bdbd-4c63-b70b-34e4d79f1f79
contentOwner: msm-service
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: introduction
content-type: reference
discoiquuid: f1918b1b-6b3d-46da-8753-cd3351bac417
index: y
internal: n
snippet: y
---
...
* `allowProxy`: If a client library is located under `/apps`, this property allows acces to it via proxy servlet. See [Locating a Client Library Folder and Using the Proxy Client Libraries Servlet](../../../sites/developing/using/clientlibs.md#main-pars-title-8ced) below.
...
For complete information, including attributes for filtering JS, CSS, or theme libraries, see [ui:includeClientLib](../../../sites/developing/using/taglib.md#main-pars-title-1565813984).

>[!CAUTION]
>
>`<cq:includeClientLib>`, which in the past was commonly used to include client libraries, has been deprecated since AEM 5.6. [ `<ui:includeClientLib>`](../../../sites/developing/using/taglib.md#main-pars-title-1565813984) should be used instead as detailed above.
