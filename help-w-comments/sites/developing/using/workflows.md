...
uuid: 711b8c8d-fdce-4a66-8987-15bb612dc0d4
contentOwner: User
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: extending-aem
content-type: reference
discoiquuid: bd33d60e-7cd6-4b97-a124-64203db7d4fd
index: y
internal: n
snippet: y
---
...
Typically, workflows are used to process form submissions in AEM. This can be with the [core components form components](/content/help/en/experience-manager/core-components/using/form-container) available in a standard AEM instance, or with the [AEM Forms solution](../../../forms/using/aem-forms-workflow.md).
