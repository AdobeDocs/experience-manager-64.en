...
uuid: fa386973-3d19-4206-a3a5-ecdc21a7e86d
contentOwner: Guillaume Carlino
products: SG_EXPERIENCEMANAGER/6.4/SITES
topic-tags: introduction
content-type: reference
discoiquuid: f5659193-3f86-4a80-bf86-e9a1950bf3c2
index: y
internal: n
snippet: y
---
...
<ul>
<li>Needs information about flat node hierarchies, their affects on performance, and some approaches for proper structuring (for example <a href="/content/ddc/blog/2011/05/efficient_management.md">Efficient JCR node management with BTreeManager</a> )</li>
