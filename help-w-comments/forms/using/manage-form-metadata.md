...
uuid: 88b9628a-3976-434d-8153-610d90a1a203
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: forms-manager
discoiquuid: 23c6cc49-7d73-48cc-850c-c2ab15e42af1
index: y
internal: n
snippet: y
---
...
1. Click a component that you just dragged. In the Settings tab that opens in the right panel, fill in information for the following fields:
    ...
    1. To delete a field you added, select the field and then click the delete ![](assets/delete.png) icon.
