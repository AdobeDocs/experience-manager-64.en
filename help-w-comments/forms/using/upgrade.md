...
uuid: 0a05494f-554c-4088-be73-15f77a2d4a34
content-type: reference
products: SG_EXPERIENCEMANAGER/6.3/FORMS
topic-tags: installing
geptopics: SG_AEMFORMS/categories/jee
discoiquuid: 7536663e-54bd-4f9d-8927-dcb942128a27
index: y
internal: n
snippet: y
---
...
1. Perform the upgrade:
    ...
    1. (Not required for AEM Forms document security module) Import content to the Content Repository (CRX-Repository) to AEM 6.4 Forms server.
       ...
       <li><p>(MongoMK or RDBMK only) Import LiveCycle ES4 SP1 correspondence management and forms assets to the AEM 6.4 Forms on JEE server. For detailed instructions, see the documents listed at the end of the procedure.</p> </li>    
       -->
