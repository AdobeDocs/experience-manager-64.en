...
uuid: 6ad2330a-f639-454e-86e2-00f76c72b257
discoiquuid: 2d64e42a-c08b-4257-b7fa-49e76378b00c
index: y
internal: n
snippet: y
---
...
|  Error  |com.adobe.barcodedforms.decoder.processors.DataProcessorException.FlateDecompressor |
|---|---|
...
|  Error  |com.adobe.barcodedforms.security.SecurityException.RC4Key |
|---|---|
...
|  Error  |com.adobe.barcodedforms.explorers.DataExplorerException.DataTokenizer |
|---|---|
...
|---|---|
| Description |Unexpected method type {} |

|  Error  |AEM-FDM-001-031 |
|---|---|
| Description |Missing default read operation for property {}. |

|  Error  |AEM-FDM-001-032 |
|---|---|
| Description |Repository contains updated version of this FormDataModel. Please reload this FormDataModel. |

|  Error  |AEM-FDM-001-033 |
|---|---|
| Description |Missing association operation for property {}. |

|  Error  |AEM-AUT-001-001 |
|---|---|
| Description |Missing configuration details. |

|  Error  |AEM-AUT-001-002 |
|---|---|
| Description |Provided parameter - {} is invalid. |

|  Error  |AEM-AUT-001-003 |
|---|---|
| Description |Failed to authenticate for configuration {}. |

|  Error  |AEM-AUT-001-004 |
|---|---|
| Description |Failed to fetch access token for oAuth. |

|  Error  |AEM-AUT-001-005 |
|---|---|
| Description |Invalid service user mapping. |

|  Error  |AEM-AUT-001-006 |
|---|---|
| Description |Missing authentication type. |

|  Error  |AEM-AUT-001-007 |
|---|---|
| Description |Invalid authentication type. |

|  Error  |AEM-AUT-001-008 |
|---|---|
| Description |Invalid configuration path specified -{}. |

|  Error  |AEM-AUT-001-009 |
|---|---|
| Description |Failed to create Basic authentication configuration. |

## DCT {#dct}

|  Error  |ALC-DCT-002-001 |
|---|---|
| Description |Data dictionary object is null. Please pass a valid data dictionary object. |

|  Error  |ALC-DCT-002-002 |
|---|---|
| Description |Data dictionary name is null. Please pass a valid data dictionary name. |

|  Error  |ALC-DCT-002-003 |
|---|---|
| Description |Data dictionary with name: {0} already exists. |

|  Error  |ALC-DCT-002-004 |
|---|---|
| Description |Data dictionary creation unsuccessful. |

|  Error  |ALC-DCT-002-005 |
|---|---|
| Description |Data dictionary id is null. Please pass a valid data dictionary id.  |

|  Error  |ALC-DCT-002-006 |
|---|---|
| Description |Data dictionary update unsuccessful. |

|  Error  |ALC-DCT-002-007 |
|---|---|
| Description |Data dictionary fetch unsuccessful. Please check the values of the passed-in parameters. |

|  Error  |ALC-DCT-002-008 |
|---|---|
| Description |Data dictionary delete unsuccessful. Please check the value of the passed-in data dictionary id. |

|  Error  |ALC-DCT-002-009 |
|---|---|
| Description |Name field of Data Dictionary Element is null or blank. Please check the values of the passed-in parameters. |

|  Error  |ALC-DCT-002-010 |
|---|---|
| Description |Supplied Fiber Model for the Data Dictionary is not valid. |

|  Error  |ALC-DCT-002-011 |
|---|---|
| Description |This API only supports fiber models containing data dictionary annotations. Use getDataDictionaryFromFML2() API to create data dictionary from this fiber model. |

|  Error  |ALC-DCT-002-012 |
|---|---|
| Description |Unable to create data dictionary. The input XML schema is not valid. |

|  Error  |ALC-DCT-002-013 |
|---|---|
| Description |Error in parsing passed-in XML.  |

|  Error  |ALC-DCT-002-014 |
|---|---|
| Description |Fiber Model Generation error while trying to export data dictionary with name: {0}.  |

|  Error  |ALC-DCT-002-015 |
|---|---|
| Description |Null or empty element name was provided. Invalid parameter passed to the function. |

|  Error  |ALC-DCT-002-016 |
|---|---|
| Description |The element name was not found. Invalid parameter passed to the function.  |

|  Error  |ALC-DCT-002-017 |
|---|---|
| Description |Value of required data dictionary element: {0} not found. |

|  Error  |ALC-DCT-002-018 |
|---|---|
| Description |Generation of SWF for data dictionary expression set: {0} unsuccessful. |

|  Error  |ALC-DCT-002-019 |
|---|---|
| Description |Data type for value of Data Dictionary Element: {0} is not compatible in passed XML. |

|  Error  |ALC-DCT-002-020 |
|---|---|
| Description |Data dictionary cannot be created. Only composite data dictionary element type is allowed for top-level element in data dictionary. |

|  Error  |ALC-DCT-002-021 |
|---|---|
| Description |Input data dictionary instance is null or invalid. |

|  Error  |ALC-DCT-002-022 |
|---|---|
| Description |The name of top-level Data Dictionary Element is empty. |

|  Error  |ALC-DCT-002-023 |
|---|---|
| Description |Data dictionary tree does not have a top-level Data Dictionary Element as root. |

|  Error  |ALC-DCT-002-024 |
|---|---|
| Description |Data dictionary name contains invalid characters. Only alphanumeric characters are allowed. |

|  Error  |ALC-DCT-002-025 |
|---|---|
| Description |Element type field of Data Dictionary Element with name "{0}" at path "{1}" is null.  |

|  Error  |ALC-DCT-002-026 |
|---|---|
| Description |Display name field of Data Dictionary Element with name "{0}" is null or empty. |

|  Error  |ALC-DCT-002-027 |
|---|---|
| Description |Data dictionary element with name "{0}" at path "{1}" is both Computed and Required. A data dictionary element cannot be both computed and required at the same time. |

|  Error  |ALC-DCT-002-028 |
|---|---|
| Description |Display Name field of Data Dictionary Element with name "{0}" at path "{1}" is not unique within the Data Dictionary. |

|  Error  |ALC-DCT-002-029 |
|---|---|
| Description |Data dictionary element with name "{0}" at path "{1}" contains an invalid Sub Type "ENUM". It is only supported for data dictionary elements of Type String and Number.  |

|  Error  |ALC-DCT-002-030 |
|---|---|
| Description |Data dictionary element with name "{0}" at path "{1}" is Computed but contains a null or empty Expression. All computed data dictionary elements must contain a valid expression.  |

|  Error  |ALC-DCT-002-031 |
|---|---|
| Description |Data dictionary element with name "{0}" at path "{1}" is Computed. Data Dictionary Elements of type Composite and Collection cannot be marked Computed.  |

|  Error  |ALC-DCT-002-032 |
|---|---|
| Description |Invalid/Incomplete data dictionary structure. Data Dictionary Element with name "{0}" at path "{1}" cannot occur at leaf level as it is a collection or composite element. |

|  Error  |ALC-DCT-002-033 |
|---|---|
| Description |Data dictionary element with name "{0}" at path "{1}" contains empty or null XMLBinding. XMLBinding is required for all non computed Simple and collection type elements.  |

|  Error  |ALC-DCT-002-034 |
|---|---|
| Description |Display name field of data dictionary element with name "{0}" at path "{1}" contains invalid characters. Only underscore and alphanumeric characters are allowed. |

|  Error  |ALC-DCT-002-035 |
|---|---|
| Description |Data dictionary is not valid as it contains no child elements. |

|  Error  |ALC-DCT-002-036 |
|---|---|
| Description |Data dictionary is not valid as it contains more than one top level Data Dictionary Elements. |

|  Error  |ALC-DCT-002-037 |
|---|---|
| Description |Name field of Data Dictionary Element with name "{0}" at path "{1}" contains invalid characters. Only underscore and alphanumeric characters are allowed. |

|  Error  |ALC-DCT-002-038 |
|---|---|
| Description |Data dictionary element denoting Type of Collection Element with name "{0}" cannot be Computed or Required.  |

|  Error  |ALC-DCT-002-039 |
|---|---|
| Description |Data dictionary element with name "{0}" at path "{1}" contains empty or null value set. All elements with sub type ENUM should have not null value set. |

|  Error  |ALC-DCT-002-040 |
|---|---|
| Description |Data dictionary element with name "{0}" at path "{1}" contains XML Binding and is Computed. Computed elements should not have XML binding. |

|  Error  |ALC-DCT-002-041 |
|---|---|
| Description |Data dictionary element with name "{0}" at path "{1}" contains two children with the same name "{2}" |

|  Error  |ALC-DCT-002-043 |
|---|---|
| Description |Invalid input parameter "{0}". Please ensure that the input to the API should not be null. |

|  Error  |ALC-DCT-002-044 |
|---|---|
| Description |Invalid path "{0}". Root element with the name "{1}" was not found. |

|  Error  |ALC-DCT-002-045 |
|---|---|
| Description |Invalid XML binding for: "{0}". Attributes can not be mapped to Collection DDE. |

|  Error  |ALC-DCT-002-046 |
|---|---|
| Description |Invalid XML binding for: "{0}". Wrong Value "@" for element name. |

|  Error  |ALC-DCT-002-047 |
|---|---|
| Description |Error creating XML for Data Dictionary: "{0}". Cause: {1}. |

|  Error  |ALC-DCT-002-048 |
|---|---|
| Description |Invalid XML binding for: "{0}". The Binding of this Data Dictionary Element cannot map to the root node of XML. |

|  Error  |ALC-DCT-002-049 |
|---|---|
| Description |Could not invoke LCDS remoting service as the "{0}" is not specified in the data dictionary. |

|  Error  |ALC-DCT-002-050 |
|---|---|
| Description |Service with name "{0}" is not found in the input FML file. |

|  Error  |ALC-DCT-002-051 |
|---|---|
| Description |Operation with name "{0}" is not found in Service "{1}". |

|  Error  |ALC-DCT-002-052 |
|---|---|
| Description |LCDS Remoting Invocation failed: {0} |

|  Error  |ALC-DCT-002-053 |
|---|---|
| Description |Top Level Entity with name "{0}" is not found in Fiber Model. |

|  Error  |ALC-DCT-002-054 |
|---|---|
| Description |Reference name field of data dictionary element with name "{0}" at path "{1}" is null or empty. |

|  Error  |ALC-DCT-002-055 |
|---|---|
| Description |Reference name field of data dictionary element with name "{0}" at path "{1}" is not unique within the data dictionary. |

|  Error  |ALC-DCT-002-056 |
|---|---|
| Description |Reference name field of data dictionary element with name "{0}" at path "{1}" contains invalid characters. Only underscore and alphanumeric characters are allowed. |

|  Error  |ALC-DCT-002-057 |
|---|---|
| Description |Data dictionary instance contains null or invalid data dictionary object. |

|  Error  |ALC-DCT-002-058 |
|---|---|
| Description |Invalid reference name "{0}". No DDE exists with this reference name. |

|  Error  |ALC-DCT-002-059 |
|---|---|
| Description |Reference name to path map is null in the input data dictionary Object. |

|  Error  |ALC-DCT-002-060 |
|---|---|
| Description |Extended Properties field of data dictionary with name "{0}" contains null or empty key(s). |

|  Error  |ALC-DCT-002-061 |
|---|---|
| Description |Extended Properties field of data dictionary Element with name "{0}" at path "{1}" contains null or empty key(s). |

|  Error  |ALC-DCT-002-062 |
|---|---|
| Description |Failed to publish data dictionary with name "{0}" |

|  Error  |ALC-DCT-002-063 |
|---|---|
| Description |Failed to revert data dictionary with name "{0}" |

|  Error  |ALC-DCT-002-064 |
|---|---|
| Description |Binding of data dictionary element with name "{0}" at path "{1}" contains invalid character "{2}". |

|  Error  |ALC-DCT-002-065 |
|---|---|
| Description |Binding of data dictionary element with name "{0}" at path "{1}" starts with the invalid root element. |

|  Error  |ALC-DCT-002-066 |
|---|---|
| Description |Binding of data dictionary element with name "{0}" at path "{1}" contains invalid value - "{2}". |

|  Error  |ALC-DCT-002-067 |
|---|---|
| Description |The values in value set of data dictionary element with name "{0}" at path "{1}" are not compatible with it's data type. |

|  Error  |ALC-DCT-002-068 |
|---|---|
| Description |Data dictionary {0} has never been published, so can not be deactivated. |

|  Error  |ALC-DCT-002-069 |
|---|---|
| Description |Failed to deactivate data dictionary with name "{0}". |

|  Error  |ALC-DCT-002-070 |
|---|---|
| Description |{0} has dependencies and cannot be deleted. |

|  Error  |ALC-DCT-002-071 |
|---|---|
| Description |Data Dictionary at {0} does not exist. |

|  Error  |ALC-DCT-002-072 |
|---|---|
| Description |Data dictionary {0} has never been published, so can not be reverted. |

|  Error  |ALC-DCT-002-073 |
|---|---|
| Description |Error in retrieving version for DataDictionary : {0}. |

|  Error  |ALC-DCT-002-074 |
|---|---|
| Description |Please provide valid folder id |

|  Error  |ALC-DCT-002-075 |
|---|---|
| Description |Folder at {0} does not exist |

|  Error  |ALC-DCT-002-076 |
|---|---|
| Description |Unable to get session or resource resolver |

|  Error  |ALC-DCT-003-001 |
|---|---|
| Description |Data Dictionary -id: {0} is ignored in createDataDictionary api call. |

|  Error  |ALC-DCT-003-002 |
|---|---|
| Description |Updating data dictionary with data dictionary -id: {0}. |

|  Error  |ALC-DCT-003-003 |
|---|---|
| Description |Fetching data dictionaries based on passed-in DataDictionarySearchFilter. |

|  Error  |ALC-DCT-003-004 |
|---|---|
| Description |Fetching Complete Data Dictionary object graph. |

|  Error  |ALC-DCT-003-005 |
|---|---|
| Description |Data dictionary not found. |

|  Error  |ALC-DCT-003-006 |
|---|---|
| Description |Deleting data dictionary with -id: {0}. |

|  Error  |ALC-DCT-003-007 |
|---|---|
| Description |None of the filters in the passed-in DataDictionarySearchFilter were set. Returning all data dictionaries present in the System. |

|  Error  |ALC-DCT-003-008 |
|---|---|
| Description |Validation error- Value for ENUM does not exist in input data. |

|  Error  |ALC-DCT-003-009 |
|---|---|
| Description |Validation error- Simple top-level data dictionary element encountered. |

|  Error  |ALC-DCT-003-010 |
|---|---|
| Description |Entity name auto-generated -name: {0}. |

|  Error  |ALC-DCT-003-011 |
|---|---|
| Description |The passed-in Fiber Model has more than one root. Please check the passed-in parameters |

|  Error  |ALC-DCT-003-012 |
|---|---|
| Description |Failed to set Data Dictionary property: {0}. |

|  Error  |ALC-DCT-003-013 |
|---|---|
| Description |Marking data dictionary with id: {0} as Ready to Publish. |

|  Error  |ALC-DCT-003-014 |
|---|---|
| Description |Cannot mark the Data Dictionary Ready to Publish which is not in Modified state. |

|  Error  |ALC-DCT-003-015 |
|---|---|
| Description |Data dictionary with name: {0} is already published. |

|  Error  |ALC-DCT-003-016 |
|---|---|
| Description |Data dictionary with name: {0} is already on the last published version. |

|  Error  |ALC-DCT-003-017 |
|---|---|
| Description |Error while parsing expression: {0}.  |

|  Error  |ALC-DCT-003-018 |
|---|---|
| Description |Error while evaluating expression: {0}.  |

|  Error  |ALC-DCT-003-019 |
|---|---|
| Description |Unresolved VARIABLE: {0} in the expression. |

|  Error  |ALC-DCT-003-020 |
|---|---|
| Description |Data Dictionary Element passed to the API is non computed. |

|  Error  |ALC-DCT-003-023 |
|---|---|
| Description |Data dictionary checksum generation failed during Fiber Model import. |

|  Error  |ALC-DCT-003-024 |
|---|---|
| Description |Data dictionary with name "{0}" created successfully. |

|  Error  |ALC-DCT-003-025 |
|---|---|
| Description |Data dictionary with name "{0}" updated successfully. |

|  Error  |ALC-DCT-003-026 |
|---|---|
| Description |Data dictionary with id "{0}" deleted successfully. |

|  Error  |ALC-DCT-003-027 |
|---|---|
| Description |Data dictionary with name "{0}" published successfully. |

|  Error  |ALC-DCT-003-028 |
|---|---|
| Description |Data dictionary with name: "{0}" reverted successfully. |

|  Error  |ALC-DCT-003-029 |
|---|---|
| Description |Publishing Data Dictionary with name "{0}". |

|  Error  |ALC-DCT-003-030 |
|---|---|
| Description |This data dictionary is in Modified state, so can not be published. Please mark this data dictionary as ready to publish before publishing. |

|  Error  |ALC-DCT-003-031 |
|---|---|
| Description |Deleted DDE "{0}" is being used inside expression of computed DDE "{1}". |

|  Error  |ALC-DCT-003-032 |
|---|---|
| Description |Deactivating Data Dictionary with name "{0}". |

|  Error  |ALC-DCT-003-033 |
|---|---|
| Description |Data dictionary with name "{0}" deactivated successfully. |

|  Error  |ALC-DCT-004-001 |
|---|---|
| Description |No data dictionaries found. |

|  Error  |ALC-DCT-004-002 |
|---|---|
| Description |Data dictionary Migration started. |

|  Error  |ALC-DCT-004-003 |
|---|---|
| Description |Data dictionary Migration failed. Cause: {0}. |

|  Error  |ALC-DCT-004-004 |
|---|---|
| Description |Data dictionary Migration completed. |

|  Error  |ALC-DCT-004-005 |
|---|---|
| Description |Migrating data dictionary with name: "{0}". |

|  Error  |ALC-DCT-004-006 |
|---|---|
| Description |Migration failed for data dictionary with name: "{0}". |

|  Error  |ALC-DCT-005-001 |
|---|---|
| Description |Error in reading localized data stream for Data Dictionary |

|  Error  |ALC-DCT-005-002 |
|---|---|
| Description |Error in writing localized data stream for Data Dictionary |

|  Error  |ALC-DCT-005-003 |
|---|---|
| Description |Error in exporting Localization Information |

|  Error  |ALC-DCT-005-004 |
|---|---|
| Description |Error in importing Localization Information |

|  Error  |ALC-DCT-006-001 |
|---|---|
| Description |Unexpected Error. |

|  Error  |ALC-DCT-006-002 |
|---|---|
| Description |Asset name is null. |

|  Error  |ALC-DCT-006-003 |
|---|---|
| Description |Asset type is null. |

|  Error  |ALC-DCT-006-004 |
|---|---|
| Description |Folder id is null. Please pass a valid Folder id. |

## EXM {#exm}

|  Error  |ALC-EXP-001-001 |
|---|---|
| Description |Evaluating expression: {0} for key {1}. |

|  Error  |ALC-EXP-001-002 |
|---|---|
| Description |Evaluating expression: {0} |

|  Error  |ALC-EXP-001-003 |
|---|---|
| Description |ERROR in evaluating expression: {0} . Error Message: {1}.  |

|  Error  |ALC-EXP-001-004 |
|---|---|
| Description |Unresolved VARIABLE: {0} in the expression. |

|  Error  |ALC-EXP-001-005 |
|---|---|
| Description |FUNCTION: {0} not found. |

|  Error  |ALC-EXP-001-007 |
|---|---|
| Description |Return type of expression {0} is not serializable. |

|  Error  |ALC-EXP-001-008 |
|---|---|
| Description |Invalid Expression: {0}. Error Message: {1}. |

|  Error  |ALC-EXP-001-009 |
|---|---|
| Description |Null Expression. Please provide a valid expression. |

|  Error  |ALC-EXP-001-010 |
|---|---|
| Description |Expression map is null or empty. |

|  Error  |ALC-EXP-001-011 |
|---|---|
| Description |Input data provided for expression evaluation is inconsistent. |

|  Error  |ALC-EXP-001-012 |
|---|---|
| Description |Repeating variables used in expression {0}, are not in valid hierarchy. |

|  Error  |ALC-EXP-001-013 |
|---|---|
| Description |Expression contains repeating variables. To evaluate this type of expressions, VariableResolver must implement VariableValidator interface. |

|  Error  |ALC-EXP-001-014 |
|---|---|
| Description |Input variables are not serializable. |

## Forms {#forms}

|  Error  |AEM_FRM_001_001 |
|---|---|
| Description |Invalid value {} for parameter {} |

|  Error  |AEM_FRM_001_002 |
|---|---|
| Description |NULL found for parameter: {} |

|  Error  |AEM_FRM_001_003 |
|---|---|
| Description |Unsupported File Format: {} |

|  Error  |AEM_FRM_001_004 |
|---|---|
| Description |Unexpected Exception: {} |

|  Error  |AEM_FRM_001_005 |
|---|---|
| Description |Failed to merge data description tags due to following exception {}. Some web service connections might not get invoked. |

|  Error  |AEM_FRM_001_006 |
|---|---|
| Description |{} is NULL |

|  Error  |AEM_FRM_001_007 |
|---|---|
| Description |Resource not found {} |

|  Error  |AEM_FRM_001_008 |
|---|---|
| Description |"Unspported Content Type {}" |

|  Error  |AEM_FRM_001_009 |
|---|---|
| Description |"Invalid input document." |

|  Error  |AEM_FRM_001_010 |
|---|---|
| Description |"Input passed is not a PDF form." |

|  Error  |AEM_FRM_001_011 |
|---|---|
| Description |"Unable to import data to the input PDF document as it either has a certifying signature that does not permit any changes or it does not allow filling of form fields." |

## Forms Manager {#forms-manager}

|  Error  |ALC-FMG-500-001  |
|---|---|
| Description | Faulty shadowNodesRoot : {0}. Check FormsManagerConfiguration. |

|  Error  |ALC-FMG-500-002  |
|---|---|
| Description | Invalid parameter {0} : {1} |

|  Error  |ALC-FMG-500-003  |
|---|---|
| Description | No valid {0} object exists at path : {1}. |

|  Error  |ALC-FMG-500-004  |
|---|---|
| Description | No resource path specified for deletion. |

|  Error  |ALC-FMG-500-005  |
|---|---|
| Description | Error retrieving administrator context : {0} |

|  Error  |ALC-FMG-500-006  |
|---|---|
| Description | Failed to deploy resource. No application exists by name : {0} |

|  Error  |ALC-FMG-500-007  |
|---|---|
| Description | Error uploading. An asset already exists at the path. |

|  Error  |ALC-FMG-500-008  |
|---|---|
| Description | No node exists at path : {0} |

|  Error  |ALC-FMG-500-009  |
|---|---|
| Description | The data type {0} is not supported by {1}. |

|  Error  |ALC-FMG-500-010  |
|---|---|
| Description | Invalid statement. Property name can be null or empty only for FULLTEXT operation. |

|  Error  |ALC-FMG-500-011  |
|---|---|
| Description | The file you are trying to upload is not supported. Supported file types are zip, xdp, pdf, xsd and image (jpeg, jpg, png, bmp, gif, tif, tiff, ico). |

|  Error  |ALC-FMG-500-012  |
|---|---|
| Description | Unable to read the archive. |

|  Error  |ALC-FMG-500-013  |
|---|---|
| Description | Empty Zip folder or no supported form or resource files to Upload. |

|  Error  |ALC-FMG-500-014  |
|---|---|
| Description | An error occurred while processing the request. |

|  Error  |ALC-FMG-500-015  |
|---|---|
| Description | There is no XDP content in form object. |

|  Error  |ALC-FMG-500-016  |
|---|---|
| Description | Unable to get XMP instance : {0}. |

|  Error  |ALC-FMG-500-017  |
|---|---|
| Description | No form or resource is available in the selected assets to download. |

|  Error  |ALC-FMG-500-018  |
|---|---|
| Description | Error creating resources. Verify livecycle path structure. |

|  Error  |ALC-FMG-500-019  |
|---|---|
| Description | Sample data can be uploaded for interactive forms only. |

|  Error  |ALC-FMG-500-020  |
|---|---|
| Description | Invalid value "{0}" for property "{1}". |

|  Error  |ALC-FMG-500-021  |
|---|---|
| Description | Invalid value for allowedRenderFormat property. Only "PDF", "HTML" and "BOTH" are valid values. |

|  Error  |ALC-FMG-500-022  |
|---|---|
| Description | Submit URL can not be set for AcroForms. |

|  Error  |ALC-FMG-500-023  |
|---|---|
| Description | Metadata of this form is not editable. Unable to edit property "{0}". |

|  Error  |ALC-FMG-500-024  |
|---|---|
| Description | Unexpected Error: {0} |

|  Error  |ALC-FMG-500-025  |
|---|---|
| Description | Node not found at path {0} or {1} |

|  Error  |ALC-FMG-500-026  |
|---|---|
| Description | Error creating relationship between form template {0} and the deployed form {1} |

|  Error  |ALC-FMG-500-027  |
|---|---|
| Description | Error reading resource {0} |

|  Error  |ALC-FMG-500-028  |
|---|---|
| Description | Synchronization Initiated. Kindly refer to server logs for further details. |

|  Error  |ALC-FMG-500-029  |
|---|---|
| Description | Synchronization not required. |

|  Error  |ALC-FMG-500-030  |
|---|---|
| Description | You do not have sufficient permissions. Please log in to AEM Forms as Administrator to invoke this operation. |

|  Error  |ALC-FMG-500-031  |
|---|---|
| Description | One or more asset in the uploaded package replaces a folder in this setup. You are not allowed to replace folders. |

|  Error  |ALC-FMG-500-032  |
|---|---|
| Description | Document of Record is not configured for the selected adaptive form. |

|  Error  |ALC-FMG-500-033  |
|---|---|
| Description | An asset exists in repository with same path as folder in uploading package. |

|  Error  |ALC-FMG-500-034  |
|---|---|
| Description | The zip you are trying to upload is not a valid CRX package. |

|  Error  |ALC-FMG-600-001  |
|---|---|
| Description | Unable to get a JCR session. |

|  Error  |ALC-FMG-600-002  |
|---|---|
| Description | The path {1}, does not point to a valid {0} node. |

|  Error  |ALC-FMG-600-003  |
|---|---|
| Description | There is no XDP content in form object. |

|  Error  |ALC-FMG-600-004  |
|---|---|
| Description | A {0} node already exists at path : {1}. |

|  Error  |ALC-FMG-600-005  |
|---|---|
| Description | Error reading {0} node at path {1} : {2} |

|  Error  |ALC-FMG-600-006  |
|---|---|
| Description | Unable to detect the asset type. |

|  Error  |ALC-FMG-600-007  |
|---|---|
| Description | Invalid parameter {0} : {1} |

|  Error  |ALC-FMG-600-008  |
|---|---|
| Description | Not able to access details through current context. |

|  Error  |ALC-FMG-600-009  |
|---|---|
| Description | No node exists at path : {0} |

|  Error  |ALC-FMG-600-010  |
|---|---|
| Description | Error getting service config : {0} |

|  Error  |ALC-FMG-600-011  |
|---|---|
| Description | Unable to get user context through the current request. |

|  Error  |ALC-FMG-600-012  |
|---|---|
| Description | Error getting service operation : {0} |

|  Error  |ALC-FMG-600-013  |
|---|---|
| Description | Error invoking service : {0} |

|  Error  |ALC-FMG-600-014  |
|---|---|
| Description | Missing Shadow Node Root. Please refresh Forms Manager Core bundle. |

|  Error  |ALC-FMG-600-015  |
|---|---|
| Description | You can only upload applications at this level of hierarchy. |

|  Error  |ALC-FMG-600-016  |
|---|---|
| Description | Unable to get XMP instance : {0}. |

|  Error  |ALC-FMG-700-001  |
|---|---|
| Description | Exception encountered in repository access. |

|  Error  |ALC-FMG-700-002  |
|---|---|
| Description | Old Shadow Nodes root :{0} does not exists. |

|  Error  |ALC-FMG-700-003  |
|---|---|
| Description | You are not allowed to upload this asset at {0} location. |

|  Error  |ALC-FMG-700-004  |
|---|---|
| Description | The name of the file contains invalid characters. The name of the file or folder can only include alphanumeric characters, hyphens and underscores. The name of the folder can also include periods (.). |
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> Error </td> 
   <td>ALC-FMG-700-005 </td> 
  </tr> 
  <tr> 
   <td>Description</td> 
   <td> You do not have the permission to perform this operation on adaptive forms and fragments that use scripts, XFA form templates and style-sheets, and HTML5 form sets.<br /><br />Contact your administrator to request for the permission.</td> 
  </tr> 
 </tbody> 
</table>
...
|  Error  |AEM-FMG-700-001  |
|---|---|
| Description | Invalid parameter {0} : {1} |

|  Error  |AEM-FMG-700-002  |
|---|---|
| Description | Node does not exist at {0}. |

|  Error  |AEM-FMG-700-003  |
|---|---|
| Description | Asset {0} is already under review. Start another review after completing the existing review. |

|  Error  |AEM-FMG-700-004  |
|---|---|
| Description | Error creating a review. |

|  Error  |AEM-FMG-700-005  |
|---|---|
| Description | Error retrieving bundle context : {0} |

|  Error  |AEM-FMG-700-006  |
|---|---|
| Description | Task creation failed. |

|  Error  |AEM-FMG-700-007  |
|---|---|
| Description | Task termination failed. |

|  Error  |AEM-FMG-700-008  |
|---|---|
| Description | Undefined review state |

|  Error  |AEM-FMG-700-009  |
|---|---|
| Description | Failed to create review node for asset : {0}. |

|  Error  |AEM-FMG-700-010  |
|---|---|
| Description | Failed to set review state for asset {0}. |

|  Error  |AEM-FMG-700-011  |
|---|---|
| Description | Failed to clear asset review state for asset {0}. |

|  Error  |AEM-FMG-700-012  |
|---|---|
| Description | Error ending review on asset {0}. |

|  Error  |AEM-FMG-700-013  |
|---|---|
| Description | Error updating review on asset {0}. |

|  Error  |AEM-FMG-700-014  |
|---|---|
| Description | Failed to update review state for asset {0}. |

|  Error  |AEM-FMG-700-015  |
|---|---|
| Description | Failed to add permissions on comments node for asset : {0}. |

|  Error  |AEM-FMG-700-016  |
|---|---|
| Description | Failed to remove permissions on comments node for asset : {0}. |

|  Error  |AEM-FMG-700-017  |
|---|---|
| Description | Failed to retrieve information for group : {0}. |

|  Error  |AEM-FMG-700-018  |
|---|---|
| Description | Invalid action {0}. |

|  Error  |AEM-FMG-700-019  |
|---|---|
| Description | Asset {0} is not a part of any review. |

|  Error  |AEM-FMG-700-020  |
|---|---|
| Description | Current user {0} is not the initiator of the review on asset {1}. Only an initiator can end a review. |

|  Error  |AEM-FMG-700-021  |
|---|---|
| Description | User {0} does not exist, so cannot be made a reviewer. |

|  Error  |AEM-FMG-700-022  |
|---|---|
| Description | Failed to create review container for asset : {0}. |

|  Error  |AEM-FMG-700-023  |
|---|---|
| Description | Review {0} for asset {1} does not exist. |

|  Error  |AEM-FMG-700-024  |
|---|---|
| Description | Review deadline should be beyond the current date. |

|  Error  |AEM-FMG-700-025  |
|---|---|
| Description | Error while removing stale {0} data from the asset : {1}. |

|  Error  |AEM-FMG-700-026  |
|---|---|
| Description | Unable to add mixin types |

|  Error  |AEM-FMG-700-027  |
|---|---|
| Description | Error in ending A/B testing on form : {0} |

|  Error  |AEM-FMG-800-001  |
|---|---|
| Description | Invalid XFA Adaptive Form at path:{0}. Guide container node was not found. |

|  Error  |AEM-FMG-800-002  |
|---|---|
| Description | Error finding dependency of adaptive form : {0}. Invalid XDP path : {1} |

|  Error  |AEM-FMG-800-003  |
|---|---|
| Description | Invalid XFA Adaptive Form at path:{0}. xdpRef property was not found. |

|  Error  |AEM-FMG-800-004  |
|---|---|
| Description | Unpublish operation failed because of insufficient permissions on asset: {0}. |

|  Error  |AEM-FMG-800-005  |
|---|---|
| Description | Improper Asset JSON |

|  Error  |AEM-FMG-800-006  |
|---|---|
| Description | Error while saving Form Set. |

|  Error  |AEM-FMG-800-007  |
|---|---|
| Description | Error while Creating Adaptive Form Fragment. |

|  Error  |AEM-FMG-800-008  |
|---|---|
| Description | Error while Creating Adaptive Form. |

|  Error  |AEM-FMG-800-009  |
|---|---|
| Description | Error while Creating Theme. |

|  Error  |AEM-FMG-800-010  |
|---|---|
| Description | Error while Creating Form Set. |

|  Error  |AEM-FMG-800-011  |
|---|---|
| Description | Invalid JSON Adaptive Form at path:{0}. Guide container node was not found. |

|  Error  |AEM-FMG-800-012  |
|---|---|
| Description | Invalid JSON Adaptive Form at path:{0}. schemaRef property was not found. |

|  Error  |AEM-FMG-800-013  |
|---|---|
| Description | Error while Creating Form Data Model. |

|  Error  |AEM-FMG-800-014  |
|---|---|
| Description | Clientlib with category name {0} already exists in system. |

|  Error  |AEM-FMG-900-001  |
|---|---|
| Description | Invalid AdaptiveForm Template : {0}. |

|  Error  |AEM-FMG-900-002  |
|---|---|
| Description | Asset Node with name: {0} already exists at {1}. |

|  Error  |AEM-FMG-900-003  |
|---|---|
| Description | Invalid Session. |

|  Error  |AEM-FMG-900-004  |
|---|---|
| Description | Invalid Form Model has been specified. |

|  Error  |AEM-FMG-900-005  |
|---|---|
| Description | Form Node Creation Failed: {0}. |

|  Error  |AEM-FMG-900-006  |
|---|---|
| Description | Error while processing FormTemplate : {0}. |

|  Error  |AEM-FMG-900-007  |
|---|---|
| Description | Error while processing FormTemplate Fragments. |

|  Error  |AEM-FMG-900-008  |
|---|---|
| Description | No Subform marked as Fragment in FormTemplate: {0}. |

|  Error  |AEM-FMG-900-009  |
|---|---|
| Description | Fragment Subform: {0} not found in FormTemplate: {1}. |

|  Error  |AEM-FMG-900-010  |
|---|---|
| Description | Error while processing Form Options. |

|  Error  |AEM-FMG-900-011  |
|---|---|
| Description | Asset name is null. |

|  Error  |AEM-FMG-900-012  |
|---|---|
| Description | Asset path is null. |

|  Error  |AEM-FMG-900-013  |
|---|---|
| Description | No Root Element found in xsd file : {0}. |
...
|  Error  |AEM-FMG-900-015  |
|---|---|
| Description | No destination location provided for {0} creation. |

|  Error  |AEM-FMG-900-016  |
|---|---|
| Description | There was an unknown error while scheduling publication. Please retry. |

## Forms Portal {#forms-portal}

|  Error  |ALC-FMP-001-001 |
|---|---|
| Description |Exception occurred during server side processing. |

|  Error  |ALC-FMP-001-002 |
|---|---|
| Description |Error in writing server response. |

|  Error  |ALC-FMP-001-003 |
|---|---|
| Description |Error in json creation. |

|  Error  |ALC-FMP-001-004 |
|---|---|
| Description |Error in getting response from remote server. |

|  Error  |ALC-FMP-001-005 |
|---|---|
| Description |Error in establishing connection to remote server. |

|  Error  |ALC-FMP-001-006 |
|---|---|
| Description |Url Encoding not supported. |

|  Error  |ALC-FMP-001-007 |
|---|---|
| Description |AllowedRenderFormat property not set on a form. |

|  Error  |ALC-FMP-001-008 |
|---|---|
| Description |Download action not allowed for Adaptive Form. |

|  Error  |ALC-FMP-001-009 |
|---|---|
| Description |Unsupported Adaptive Form Error. |

|  Error  |ALC-FMP-001-010 |
|---|---|
| Description |Invalid parameters for saving the draft. |

|  Error  |ALC-FMP-001-011 |
|---|---|
| Description |Unable to delete the non-existing Draft. |

|  Error  |ALC-FMP-001-012 |
|---|---|
| Description |Unable to save the draft. |

|  Error  |ALC-FMP-001-013 |
|---|---|
| Description |Unable to delete the non-existing Submission. |

|  Error  |ALC-FMP-001-014 |
|---|---|
| Description |Invalid parameters for submitting the Adaptive Form. |

|  Error  |ALC-FMP-001-015 |
|---|---|
| Description |Unable to delete. Inconsistent Draft. |

|  Error  |ALC-FMP-001-016 |
|---|---|
| Description |Invalid ID provided. |

|  Error  |ALC-FMP-001-017 |
|---|---|
| Description |Invalid Session. |

|  Error  |ALC-FMP-001-018 |
|---|---|
| Description |Unable to delete the draft. |

|  Error  |ALC-FMP-001-019 |
|---|---|
| Description |Unable to delete Submission. |

|  Error  |ALC-FMP-001-020 |
|---|---|
| Description |Unable to delete inconsistent Submission. |

|  Error  |ALC-FMP-001-021 |
|---|---|
| Description |Unable to get the data. |

|  Error  |ALC-FMP-001-022 |
|---|---|
| Description |Anonymous user can not save drafts. |

|  Error  |ALC-FMP-001-023 |
|---|---|
| Description |Unable to delete attachment. |

|  Error  |ALC-FMP-001-024 |
|---|---|
| Description |Form does not exists. |

|  Error  |ALC-FMP-001-025 |
|---|---|
| Description |Profile property does not exist metadata node of form. |

|  Error  |ALC-FMP-001-026 |
|---|---|
| Description |Unable to determine user name for asynchronous save. |

|  Error  |ALC-FMP-001-027 |
|---|---|
| Description |DOR not associated with Adaptive Form and hence, cannot create Agreement. |

|  Error  |ALC-FMP-001-028 |
|---|---|
| Description |DOR id is absent in metadata of pending sign instance. |

|  Error  |ALC-FMP-001-029 |
|---|---|
| Description |Unable to delete metadata. |

|  Error  |ALC-FMP-001-030 |
|---|---|
| Description |Unable to add comment. |

|  Error  |ALC-FMP-001-031 |
|---|---|
| Description |Error in deleting pending sign instance. |

|  Error  |ALC-FMP-001-032 |
|---|---|
| Description |Unable to delete metadata property. |

|  Error  |ALC-FMP-001-033 |
|---|---|
| Description |Unable to get comments on submission with ID  |

|  Error  |ALC-FMP-001-034 |
|---|---|
| Description |Unable to get list of drafts. |

|  Error  |ALC-FMP-001-035 |
|---|---|
| Description |Unable to list all eligible forms. |

|  Error  |ALC-FMP-001-036 |
|---|---|
| Description |Error occured while getting item information for rendering |

|  Error  |ALC-FMP-001-037 |
|---|---|
| Description |Unable to get property {0} in draft with id {1} |

|  Error  |ALC-FMP-001-038 |
|---|---|
| Description |Unable to get property {0} in submission with id {1} |

|  Error  |ALC-FMP-001-039 |
|---|---|
| Description |Unable to get list of {0} instances. |

|  Error  |ALC-FMP-001-040 |
|---|---|
| Description |Error in generation of unique id. |

|  Error  |ALC-FMP-001-041 |
|---|---|
| Description |Unable to read {0} instance. |

|  Error  |ALC-FMP-001-042 |
|---|---|
| Description |Draft id is null or empty |

|  Error  |ALC-FMP-001-043 |
|---|---|
| Description |Submit Id must be specified for updating e sign properties. |

|  Error  |ALC-FMP-001-044 |
|---|---|
| Description |Unable to obtain resource resolver. |

|  Error  |ALC-FMP-001-045 |
|---|---|
| Description |Unable to save sign metadata. |

|  Error  |ALC-FMP-001-046 |
|---|---|
| Description |Unable to create agreement. |

|  Error  |ALC-FMP-001-047 |
|---|---|
| Description |Could not post data at {0} |

|  Error  |ALC-FMP-001-048 |
|---|---|
| Description |Invalid inputs. |

|  Error  |ALC-FMP-001-049 |
|---|---|
| Description |Unknown data type for form data. |

|  Error  |ALC-FMP-001-050 |
|---|---|
| Description |Content type should not not be null or empty. |

|  Error  |ALC-FMP-001-051 |
|---|---|
| Description |Unable to delete {0} with id {1}. |

|  Error  |ALC-FMP-001-052 |
|---|---|
| Description |Error occurred while deleting value of {0} at {1} with ID {2} |

|  Error  |ALC-FMP-001-053 |
|---|---|
| Description |Either form add-on package is not installed or signing is not configured. |

|  Error  |ALC-FMP-001-054 |
|---|---|
| Description |Agreement id is null. Hence, cannot save pending sign instance. |

|  Error  |ALC-FMP-002-001 |
|---|---|
| Description |Failed to get request parameters from remote server. |

|  Error  |ALC-FMP-TEST-001 |
|---|---|
| Description |This message was fetched on {0}. |

## Forms Workflow {#forms-workflow}

|  Error  |AEM-FD-000-001 |
|---|---|
| Description |Startpoint not found - {0} |

|  Error  |AEM-FD-000-002 |
|---|---|
| Description |Startpoints location either don't exist or is inaccessible! |

|  Error  |AEM-FD-000-003 |
|---|---|
| Description |Invalid user - {0} |

|  Error  |AEM-FD-000-004 |
|---|---|
| Description |Invalid startpoint - {0} |

|  Error  |AEM-FD-001-001 |
|---|---|
| Description |Email template is not defined |

|  Error  |AEM-FD-001-002 |
|---|---|
| Description |Email service is not defined |

|  Error  |AEM-FD-002-001 |
|---|---|
| Description |Unable to retrieve file attachment for file - {1} and workItem - {0} |

|  Error  |AEM-FD-002-002 |
|---|---|
| Description |Unable to save file attachment for workItem - {0} |

|  Error  |AEM-FD-002-003 |
|---|---|
| Description |No CRX Node found for file attachment, node path - {1} and workItemId - {0} |

|  Error  |AEM-FD-002-004 |
|---|---|
| Description |File attachment {0} not found under draft {1} |

|  Error  |AEM-FD-002-005 |
|---|---|
| Description |Unable to parse file attachment map {0} |

|  Error  |AEM-FD-002-006 |
|---|---|
| Description |Unable to delete draft node for workitem {0} at path {1} |

|  Error  |AEM-FD-002-007 |
|---|---|
| Description |Unable to read file attachment map for workitem - {0} |

|  Error  |AEM-FD-002-008 |
|---|---|
| Description |Unable to save file attachment for form application - {0} |

|  Error  |AEM-FD-002-009 |
|---|---|
| Description |Unable to save file attachment. |

|  Error  |AEM-FD-003-001 |
|---|---|
| Description |Unable to create draft node for workItem - {0} |

|  Error  |AEM-FD-003-002 |
|---|---|
| Description |Unable to save form data under drafts for workitem - {0} |

|  Error  |AEM-FD-004-001 |
|---|---|
| Description |Invalid workitem - {0} |

|  Error  |AEM-FD-004-002 |
|---|---|
| Description |Not a complete workitem - {0} |

|  Error  |AEM-FD-005-001 |
|---|---|
| Description |Unable to generate Document of Record |

|  Error  |AEM-FD-005-002 |
|---|---|
| Description |Unable to save Document of Record under the payload. |

|  Error  |AEM-FD-006-001 |
|---|---|
| Description |Unable to check if DoR is associated with AF {0} |

|  Error  |AEM-FD-007-001 |
|---|---|
| Description |Unable to submit the form. The form contains field attachments but no output attachment path specific in submit configurations. |

|  Error  |AEM-FD-007-002 |
|---|---|
| Description |Unable to save data under payload. Information provided is either incomplete or incorrect. |

|  Error  |AEM-FD-007-003 |
|---|---|
| Description |Unable to complete the workitem - {0} |

|  Error  |AEM-FD-007-004 |
|---|---|
| Description |Unable to submit the form. Submission information does not contain a valid form path. |

|  Error  |AEM-FD-007-005 |
|---|---|
| Description |Unable to submit the form. No form data found for the submitted form. |

|  Error  |AEM-FD-007-006 |
|---|---|
| Description |Unable to submit the form. Could not find any AEM workflow associated with the form. |

|  Error  |AEM-FD-007-007 |
|---|---|
| Description |Unable to submit the form. No output path relative to payload, configured to store the form data. |

|  Error  |AEM-FD-008-001 |
|---|---|
| Description |Failed to post data at {0} |

|  Error  |AEM-FD-008-002 |
|---|---|
| Description |An error occurred while validating the user. |

|  Error  |AEM-FD-008-003 |
|---|---|
| Description |Failed to create a folder at {0} |

|  Error  |AEM-FD-008-004 |
|---|---|
| Description |Resource does not exist at {0} |

|  Error  |AEM-FD-008-005 |
|---|---|
| Description |Not a valid file {0} |

|  Error  |AEM-FD-008-006 |
|---|---|
| Description |Not a valid file path {0} |

|  Error  |AEM-FD-008-007 |
|---|---|
| Description |Unable to update metadata for workitem - {0} |

|  Error  |AEM-FD-008-008 |
|---|---|
| Description |Unable to get data xml for workitem - {0} |

|  Error  |AEM-FD-008-009 |
|---|---|
| Description |Unable to validate user |

|  Error  |AEM-FD-008-010 |
|---|---|
| Description |Unable to fetch form data for completed workitem - {0} |

|  Error  |AEM-FD-008-011 |
|---|---|
| Description |Unable to fetch form data for completed workitem - {0} - historyitem - {1} |

|  Error  |AEM-FD-008-012 |
|---|---|
| Description |Unable to fetch form data for workitem - {0} |

|  Error  |AEM-FD-009-001 |
|---|---|
| Description |Unable to save history data for workItem {0} |

|  Error  |AEM-FD-009-002 |
|---|---|
| Description |Unable to find dashboard history path in workItem {0} |

|  Error  |AEM-FD-009-003 |
|---|---|
| Description |Unable to fetch history for workItem - {0} |

|  Error  |AEM-FD-009-004 |
|---|---|
| Description |Unable to fetch history for workItem - {0} and historyItem - {1} |

|  Error  |AEM-FD-009-005 |
|---|---|
| Description |Unable to save history data for workflow instance {0} |

|  Error  |AEM-FD-009-006 |
|---|---|
| Description |Unable to fetch form data for previous step for workItem {0} |

|  Error  |AEM-FD-010-001 |
|---|---|
| Description |Unable to create system metadata |

|  Error  |AEM-FD-011-001 |
|---|---|
| Description |Invalid Operation - {0} |

|  Error  |AEM-FD-011-002 |
|---|---|
| Description |No Operation Specified |

|  Error  |AEM-FD-011-003 |
|---|---|
| Description |Couldn't Trigger Workflow |

|  Error  |AEM-FD-011-004 |
|---|---|
| Description |Submission failed |

|  Error  |AEM-FD-012-001 |
|---|---|
| Description |Unable to save XDP Document under the payload. |

## Reader Extensions {#reader-extensions}

|  Error  |AEM-REX-001-002  |
|---|---|
| Description | No credential found with alias [{0}]. |

|  Error  |AEM-REX-001-004  |
|---|---|
| Description | The format of the credential specified with alias [{0}] is not supported. |

|  Error  |AEM-REX-001-005  |
|---|---|
| Description | Unable to create a local instance of a Document Service Factory. |

|  Error  |AEM-REX-001-006  |
|---|---|
| Description | Unable to create or access the Credential Service. |

|  Error  |AEM-REX-001-007  |
|---|---|
| Description | The Credential Service did not find the requested credential, [{0}]. |

|  Error  |AEM-REX-001-008  |
|---|---|
| Description | Unable to apply the requested usage rights to the given document. |

|  Error  |AEM-REX-001-009  |
|---|---|
| Description | An error occurred while trying to access the usage rights of the document. |

|  Error  |AEM-REX-001-010  |
|---|---|
| Description | An error occurred while trying to remove the usage rights of the document. |

|  Error  |AEM-REX-001-011  |
|---|---|
| Description | An error occurred while trying to access a shared PDF document. |

|  Error  |AEM-REX-001-014  |
|---|---|
| Description | An error occurred while trying to access the usage rights of the document. |

|  Error  |AEM-REX-001-015  |
|---|---|
| Description | The requested usage right, [{0}], is not allowed by the credential, [{1}]. |

|  Error  |AEM-REX-001-017  |
|---|---|
| Description | The permissions of the document do not allow usage rights to be applied. |

|  Error  |AEM-REX-001-018  |
|---|---|
| Description | An error occurred while trying to access the permissions allowed by the document. |

|  Error  |AEM-REX-001-019  |
|---|---|
| Description | The input document is not a valid document type for this operation. |

|  Error  |AEM-REX-001-020  |
|---|---|
| Description | The ReaderExtensionsOptions is not correctly specified. |

|  Error  |AEM-REX-001-021  |
|---|---|
| Description | The UsageRights are not specified. |

|  Error  |AEM-REX-001-022  |
|---|---|
| Description | The input PDF document is encrypted and needs to be unlocked for this operation. |

|  Error  |AEM-REX-001-023  |
|---|---|
| Description | The credential alias is not specified. |

|  Error  |AEM-REX-001-024  |
|---|---|
| Description | The input PDF document is not specified. |

|  Error  |AEM-REX-001-025  |
|---|---|
| Description | The credential specified is not a valid Reader Extensions credential. |

|  Error  |AEM-REX-001-026  |
|---|---|
| Description | The Reader Extensions credential specified caused an exception while accessing it. |

|  Error  |AEM-REX-001-027  |
|---|---|
| Description | Unable to apply the requested usage rights because the credential specified, [{0}], expired on [{1}]. |

|  Error  |AEM-REX-001-028  |
|---|---|
| Description | Unable to access the use count of the credential specified, [{0}]. |

|  Error  |AEM-REX-001-029  |
|---|---|
| Description | Usage for credential {0} could not be incremented. |

|  Error  |AEM-REX-001-030  |
|---|---|
| Description | Unable to access the usage rights credential specified, [{0}]. |

|  Error  |AEM-REX-001-031  |
|---|---|
| Description | Resource Resolver is null. |

|  Error  |AEM-REX-001-032  |
|---|---|
| Description | Byte Writer is null. |

<!--
<related-links>
<a href="../../../forms/using/wip/error-code-reference-aem-forms-jee.md" target="_blank">AEM Forms Error Code Reference (JEE Only)</a>
</related-links>
-->
