...
uuid: e7555d0f-3906-4250-945c-90a9ad1dfcce
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: customization
discoiquuid: aa2707ae-889d-439c-820f-c32b2a7cfa51
index: y
internal: n
snippet: y
---
...
1. Add the following properties in the store_and_email node:
...
1. Add the post.POST.jsp script to your action. (/apps/custom_submit_action/store_and_mail/).
...
>* [Configuring AEM to submit form data to LiveCycle processes](../../forms/using/submit-form-data-livecycle-process.md)
>* [Submitting and storing content in JCR repository](/forms/using/submit-store-data-crx-repository)
