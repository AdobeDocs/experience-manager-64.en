...
<a href="/forms/using/enabling-eSign-your-adaptive-forms.md" target="_blank">Enabling eSign services signatures in adaptive forms</a>
<a href="/forms/using/localizing-adaptive-forms.md" target="_blank">Localizing adaptive forms</a>
<a href="/forms/using/create-custom-templates-adaptive-forms-documents.md" target="_blank"> Creating a custom adaptive form template</a>
</related-links>
-->
