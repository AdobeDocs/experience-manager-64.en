...
uuid: 76aea695-110a-4561-bc8f-ca30f83b11fa
products: SG_EXPERIENCEMANAGER/6.4/FORMS
topic-tags: author
discoiquuid: 7d131df2-d476-49c1-8f08-f8ca7b124c79
index: y
internal: n
snippet: y
---
...
1. The parent of the panel, which is to be repeated, should contain add and delete buttons to manage instances of the repeatable panels. Perform the following steps to insert buttons to the parent and enable scripts on the buttons:
    ...
    1. From the sidebar, drag-and-drop a button component to the parent of the panel**. **Select the component and tap ![](assets/edit-rules.png). The rules of the button open in the rule editor.
...
<!--
<related-links>
<a href="../../forms/using/creating-adaptive-form.md" target="_blank">Creating adaptive forms</a>
...
<a href="/forms/using/enabling-eSign-your-adaptive-forms" target="_blank">Enabling eSign services signatures in adaptive forms</a>
<a href="/forms/using/localizing-adaptive-forms" target="_blank">Localizing adaptive forms</a>
<a href="/forms/using/create-custom-templates-adaptive-forms-documents" target="_blank"> Creating a custom adaptive form template</a>
</related-links>
-->
