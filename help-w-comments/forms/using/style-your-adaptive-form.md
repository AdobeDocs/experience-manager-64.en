...
uuid: b6c3686f-d2e1-4eca-b434-305d8e1ac874
topic-tags: introduction
discoiquuid: 00f56197-68d0-40a9-adf0-c9d52148f632
index: y
internal: n
snippet: y
---
...
1. Change the existing logo and text of the header. To remove the logo:
    ...
    1. Tap upload, select the logo.png, and tap ![](https://chl-author-preview.corp.adobe.com/content/dam/help/en/aem-forms/icons/AEM_6_3_Forms_save.PNG) to save the changes. The image was downloaded in the [Before you start](../../forms/using/style-your-adaptive-form.md#main-pars-header-306050920) section.  
...
1. Configure your theme to use the TypeKit configuration. On the author instance, open **Global Theme** in the theme editor. In the theme editor, navigate to Theme Options ![](https://helpx.adobe.com/content/dam/help/en/aem-forms/6-2/theme-options.png) &gt; Configure. In **Typekit Configuration** field, select the kit, and click **Save**.
   ...
   <li><p>Change the font family of all the components in Text accordion to Myriad Pro. </p> </li>
   -->
