...
uuid: 05d910e5-3771-49f0-b662-2822cf841a91
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
topic-tags: administering
content-type: reference
discoiquuid: e8b2ef13-2762-4252-b328-0ecf534714e3
index: y
internal: n
snippet: y
---
...
![Value property of a file type, as seen in CRXDE, is used for search queries to work](assets/chlimage_1-427.png)
...
1. Specify tags based on which you want to search assets or select from the list of suggestions.
   ...
   ![AEM-provided suggestion when typing name of tag](assets/chlimage_1-428.png)
