...
uuid: 38e29818-cbf3-4d45-985c-d6f4fafa06a8
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
topic-tags: administering
content-type: reference
discoiquuid: 3140dbe4-4d8f-4c88-8ec8-3332cfcddd85
index: y
internal: n
snippet: y
---
...
1. Review the layout of the predicate in the Preview mode.
   ...
   ![Preview the search form before submitting the changes](assets/Preview.png)
...
![Value property of a file type, as seen in CRXDE, is used for search queries to work](assets/chlimage_1-378.png)
...
1. Specify tags based on which you want to search assets or select from the list of suggestions.
   ...
   ![AEM-provided suggestion when typing name of tag](assets/chlimage_1-379.png)
