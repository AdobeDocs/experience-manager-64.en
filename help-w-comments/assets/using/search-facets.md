...
uuid: 9cfc6e12-e06a-4add-b3a1-275dcd1c33af
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
topic-tags: administering
content-type: reference
discoiquuid: 5ac64fca-11de-4c97-aa9c-7d3d2787a638
index: y
internal: n
snippet: y
---
...
![Value property of a file type, as seen in CRXDE, is used for search queries to work](assets/chlimage_1-432.png)
...
1. Specify tags based on which you want to search assets or select from the list of suggestions.
   ...
   ![AEM-provided suggestion when typing name of tag](assets/chlimage_1-433.png)
