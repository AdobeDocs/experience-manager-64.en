...
uuid: 15db2bcd-2df5-4762-83a6-226e6947a606
topic-tags: brand-portal
content-type: reference
products: SG_EXPERIENCEMANAGER/6.4/ASSETS
discoiquuid: 46afd5a2-977d-408b-b2a3-56a716e19399
index: y
internal: n
snippet: y
---
...
1. Select **Add Application **to create an application.
   ...
   <li><p>From the <strong>Client Credentials</strong> list, select <strong>Service Account (JWT Assertion)</strong>, which is a server-to-server communication service for server authentication.</p> </li>
   -->
...
1. To publish the selected assets to Brand Portal, do either of the following:
